		...
		if ($operation=='doublon') {
				...
				// alor rows
					while ($tab3 = mysql_fetch_array($res3)) {
								...
								categorie ='".$tab3['categorie']."' && forme ='".$tab3['forme']."' && tableau ='".$tab3['tableau']."'
								&& prixSession ='".$tab3['prixSession']."' && prixPublic ='".$tab3['prixPublic']."' &&
								codeBarreDesignation ='".$tab3['codeBarreDesignation']."' && id !=".$tab3['id']."";
