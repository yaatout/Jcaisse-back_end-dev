...
require('../declarationVariables.php');
    ...
    if($operation == 'EditProduit_B'){
        ...
        $res1=mysql_query($sql1);
		if(mysql_num_rows($res1)){
            $sql="UPDATE `".$catalogueTypeCateg."` SET designation='".mysql_real_escape_string($designation)."',categorie='".mysql_real_escape_string($categorie)."'
            ...
            ,prixuniteStock='".$prixUS."' WHERE id=".$idDesignation;
    ...
    if($operation == 'EditProduit_PH'){
        ...
        $res1=mysql_query($sql1);
            ...
            prixSession='".$prixSession."',prixPublic='".$prixPublic."' WHERE id=".$idDesignation;
            $res=@mysql_query($sql)or die ("modification impossible1 ".mysql_error());
			         $result="1";
        }
       exit($result);
