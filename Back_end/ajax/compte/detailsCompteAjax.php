                  ...
                  <div class="panel-heading">
                    <h4 style="padding-bottom: 18px;" data-toggle="collapse" data-parent="#accordion" href="#mouvement'.$mouvement['idMouvement'].'" class="panel-title expand">
                      ...
                      <a href="#" onclick="'.$cols_details.'(.$bon[idBl])"> 
                        <span class=" col-lg-3"><span class="mot_Total">DATE:</span> : '.date_format($date , 'd-m-y').' </span>
                        <span class="col-xs-3 col-sm-3 col-md-3 col-lg-4"> <span class="mot_Total">Montant:</span> : <span id="spn_ajouter_Bon_Total1" >'.number_format($mouvement['montant'], 0, ',', ' ')." FCFA".'</span></span>
