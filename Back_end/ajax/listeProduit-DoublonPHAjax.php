		 ...
		 $res0=mysql_query($sql0);
			...
			while (  $distinct = mysql_fetch_assoc($res2)) {
		      			...
		      			$sql3="SELECT * FROM `".$catalogueTypeCateg."`
		    					WHERE designation ='".$distinct['designation']."' && categorie ='".$distinct['categorie']."' && forme ='".$distinct['forme']."'
		    					&& tableau ='".$distinct['tableau']."' && prixSession ='".$distinct['prixSession']."' && prixPublic ='".$distinct['prixPublic']."'
