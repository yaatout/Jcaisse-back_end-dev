...
--
-- Serveur: localhost
-- Généré le : Jeu 04 Août 2016 à 17:52
...
(7, 'SalamServicesSolutions', 'Santhiaba', 'multiservices', '04-08-2016'),
(6, 'Salam Services Solutions', 'Santhiaba', 'multiservices', '04-08-2016');
...
(41, 'Ardoise', 10, 'article', 20, 200, '02-08-2016', 200, '', ''),
...
--
-- Structure de la table `salam services solutions-designation`
--

CREATE TABLE IF NOT EXISTS `salam services solutions-designation` (
  `idDesignation` int(11) NOT NULL AUTO_INCREMENT,
  `designation` varchar(155) NOT NULL,
  `uniteStock` varchar(155) NOT NULL,
  `prixuniteStock` double NOT NULL,
...
--
-- Contenu de la table `salam services solutions-designation`
--
...
--
-- Structure de la table `salam services solutions-journal`
--

CREATE TABLE IF NOT EXISTS `salam services solutions-journal` (
  `idjournal` int(11) NOT NULL AUTO_INCREMENT,
  `mois` int(11) NOT NULL,
  `annee` int(11) NOT NULL,
  `tentrees` double NOT NULL,
...
--
-- Contenu de la table `salam services solutions-journal`
--
...
--
-- Structure de la table `salam services solutions-lignepj`
--

CREATE TABLE IF NOT EXISTS `salam services solutions-lignepj` (
  `numligne` int(11) NOT NULL AUTO_INCREMENT,
  `datepage` varchar(100) NOT NULL,
  `designation` varchar(155) NOT NULL,
...
--
-- Contenu de la table `salam services solutions-lignepj`
--
...
--
-- Structure de la table `salam services solutions-pagej`
--

CREATE TABLE IF NOT EXISTS `salam services solutions-pagej` (
  `numpage` int(11) NOT NULL AUTO_INCREMENT,
  `datepage` varchar(100) NOT NULL,
  `tentreesp` double NOT NULL,
  `tsortiesp` double NOT NULL,
...
--
-- Contenu de la table `salam services solutions-pagej`
--
...
--
-- Structure de la table `salam services solutions-pagnet`
--

CREATE TABLE IF NOT EXISTS `salam services solutions-pagnet` (
  `idjournal` int(11) NOT NULL AUTO_INCREMENT,
  `mois` int(11) NOT NULL,
  `annee` int(11) NOT NULL,
  `tentrees` double NOT NULL,
...
--
-- Contenu de la table `salam services solutions-pagnet`
--
...
(2, 'DIOP', 'Ibrahima', 'Poste thiaroye', 'ibadopfr@hotmail.com', 'jaimepro', 'Admin', '20-04-2016'),
(5, 'Goudiaby', 'Mouhamadou Samsidy', 'Escale', 'msgoudiaby@univ-zig.sn', 'nasra', 'Admin', '04-08-2016');
