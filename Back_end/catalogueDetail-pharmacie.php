											...
											/* $sql1="insert IGNORE into `".$catalogueTypeCateg."`
													 ...
													 .$des['prixuniteStock']."','".$des['codeBarreDesignation']."','".$des['codeBarreuniteStock']."')";*/
														 ...
														 $sql1="insert into `".$catalogueTypeCateg."`
																(`designation` ,idDesignation,idBoutique ,`idFusion` ,`categorie` ,categorieParent,`forme` ,`tableau`,`prixSession` ,`prixPublic` ,`codeBarreDesignation` ,`codeBarreuniteStock` ) values
																...
																.$des['codeBarreDesignation']."','".$des['codeBarreuniteStock']."')";
																$forme[] =$des['forme'];
																$tableau[] =$des['tableau'];
														//var_dump($sql1);
													 $res1=@mysql_query($sql1) or die ("insertion impossible1 ".mysql_error());
...
if (isset($_POST['btnAjouterCategorie'])) {
	$categorie         =@$_POST["categorie"];
	$categorieParent         =@$_POST["categorieParent"];
	$sql3='INSERT INTO `'.$categorieTypeCateg.'`(nomCategorie,categorieParent) VALUES ("'.$categorie.'","'.$categorieParent.'")';
	//var_dump($sql3);
			...
			if(is_array($_FILES)) {
					...
					switch ($uploadImageType) {
							case IMAGETYPE_JPEG:
									...
									imagedestroy($imageLayer);
									imagedestroy($resourceType);
									$sql="update `".$categorieTypeCateg."` set image='".mysql_real_escape_string($fileNameNew)."' where id='".$idCategorie."'";
									//var_dump($sql);
									$res=@mysql_query($sql) or die ("upload impossible1 ".mysql_error());
									break;
							case IMAGETYPE_PNG:
									...
									$sql="update `".$categorieTypeCateg."` set image='".mysql_real_escape_string($fileNameNew)."' where id='".$idCategorie."'";
									//var_dump($sql);
									$res=@mysql_query($sql) or die ("upload impossible2 ".mysql_error());
									break;
							default:
									$imageProcess = 0;
									break;
...
if(isset($_POST["btnSupImgCategorie"])) {
		 if(unlink("uploads/categorie/".$_POST['image'])) {
					$idCategorie         =@$_POST["idCategorie"];
					$fileNameNew='';
					$sql="update `".$categorieTypeCateg."` set image='".$fileNameNew."' where id='".$idCategorie."'";
					//var_dump($sql);
					$res=@mysql_query($sql) or die ("upload impossible1 ".mysql_error());
			 }else {
							...
							<?php 
								if ( ($_SESSION['profil']=="SuperAdmin") || ($_SESSION['profil']=="Admin") ) { ?>
									<li class="active"><a data-toggle="tab" href="#STOCKPRODUITDETAIL" >REFERENCE</a></li>
										...
										<li><a data-toggle="tab" href="#DOUBLON" onclick="newTabDoubClickPH(<?php echo $_GET['i'] ?>)">DOUBLON</a></li>
										<!-- <li><a data-toggle="tab" href="#DOUBLON" onclick="tabDoubClick(<?php echo $_GET['i'] ?>)">DOUBLON</a></li> -->
										<li><a  class="" data-toggle="tab" href="#FUSION" onclick="newTabFusClickPH(<?php echo $_GET['i'] ?>)">FUSION</a></li>
									<!-- <li><a data-toggle="tab" href="#FUSION" onclick="tabFusClick(<?php echo $_GET['i'] ?>)">FUSION</a></li> -->
									
									<li><a data-toggle="tab" href="#FUSION2" onclick="newTabFusClickPH2(<?php echo $_GET['i'] ?>)">FUSION2</a></li>
							<?php	} else  {?>
								<li><a  class="active" data-toggle="tab" href="#FUSION" onclick="newTabFusClickPH(<?php echo $_GET['i'] ?>)">FUSION</a></li>
							<?php }  ?>		
				        </ul>
								<?php
										/**************************************************************************/
				...
				<div class="tab-content">
				    <div <?php 
								...
								<div class="table-responsive">                
									<label class="pull-left" for="nbEntreePhD">Nombre entrées </label>
										<select class="pull-left" id="nbEntreePhD">
										<optgroup>
										...
										<input class="pull-right" type="text" name="" id="searchInputPhD" placeholder="Rechercher...">
										<input type="hidden" id="idCDPH" value="<?php echo $tab0['id']; ?>">
										<div id="resultsProductsP"><!-- content will be loaded here --></div>
								</div>                            							
					...
					<div class="tab-pane fade " id="CATEGORIE">
							...
							<div class="table-responsive">                
								<label class="pull-left" for="nbEntreeCatPh">Nombre entrées </label>
									<select class="pull-left" id="nbEntreeCatPh">
									<optgroup>
										<option value="10">10</option>
										<option value="20">20</option>
										<option value="50">50</option>  
									...
									<input class="pull-right" type="text" name="" id="searchInputCatPh" placeholder="Rechercher...">
									<input type="hidden" id="idCDCatPH" value="<?php echo $tab0['id']; ?>">
								<div id="resultsProductsCatPh"><!-- content will be loaded here --></div>
							</div>
					...
					<div class="tab-pane fade " id="FORME">
										...
										<div id="supprimerForme"  class="modal fade " role="dialog">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header" style="padding:35px 50px;">
															<button type="button" class="close" data-dismiss="modal">&times;</button>
														...
														<div class="modal-body" style="padding:40px 50px;">
															<form role="form" action="#">
																<input type="hidden" id="id_SpmFormtyp" />
																<input type="hidden" id="idForme_Spm" />
																<input type="hidden" id="ordre_SpmForme" />
																<input type="hidden" id="nomForme_Spme" />
																
																<div class="form-group">
																	<label for="categorie"> FORME : </label>
																	<span id="forme_SpmPh"></span>
																</div>
																<div class="form-group">
																	<label for="uniteStock"> NOM FORME DES PRODUITS CONCERNES : </label>
																	<?php
																		$selC='<td><span style="color:blue;" >
																			<select class="form-control"  name="formeRemplacant" id="formeRempl">
																				<option   value= "SANS FORME" >SANS FORME</option>';
																				$sql111="SELECT * FROM `". $formeTypeCategPharmacie."` ORDER BY `nomForme` ASC ";
																				$res111=mysql_query($sql111);
																				while($op=mysql_fetch_array($res111)){
																					$selC=$selC."<option  value='".$op["nomForme"]."' > ".$op["nomForme"].'</option>';
																				}
																			$selC=$selC.'</select></span></td>';
																			echo $selC;
																		?>
																...
																<div class="form-group" align="right">
																	<input type="button" class="boutonbasic"  id="btnSupprimerForme" value="SUPPRIMER  >>"/>
																</div>
															</form>
														</div>
													</div>
									...
									<div class="table-responsive"> 
										<label class="pull-left" for="nbEntreeFoPh">Nombre entrées </label>
										<select class="pull-left" id="nbEntreeFoPh">
										<optgroup>
											<option value="10">10</option>
											<option value="20">20</option>
											<option value="50">50</option>  
										...
										<input class="pull-right" type="text" name="" id="searchInputFoPhD" placeholder="Rechercher...">
										<input type="hidden" id="idCFoPH" value="<?php echo $tab0['id']; ?>">
										<div id="resultsProductsFoPh"><!-- content will be loaded here --></div>
									</div>
					</div>
                           ...
                           <!-- Fin Popup pour eliminer tout doublon -->
	                                           ...
	                                           <form name="formulaireInitialStock" method="post" >
	                                             ...
	                                             /*  $(document).ready(function() {
	                                               ...
	                                               <div class="form-group" align="right">
	                                                  ...
	                                                  <?php echo  '<button type="button" id="btnElTabDo" onclick="eli_Doub_PH()">Eliminer</button>  '; ?>
	                                               </div>
	                                           </form><br />
	                                        </div>
	                                   </div>
						    ...
						    <div class="table-responsive">                
								<label class="pull-left" for="nbEntreePhD">Nombre entrées </label>
									...
									<div id="resultsProductsPD"><!-- content will be loaded here --></div>
							</div> 
					</div>
                    <div <?php 
								if ( ($_SESSION['profil']=="SuperAdmin") || ($_SESSION['profil']=="Admin") ) {
                                                      ...
                                                      <input type="hidden" class="form-control" id="codeBarreDesignationPH" aria-describedby="inputGroupPrepend" name="codeBarreDesignation"  >
                                                           <table  id="tableFu" class="display " border="1">
															...
															<div class="form-group" align="left">
                                                               <input type="submit" class="btn btn-primary btn-sm" id="btnFusion" onclick="fusioner_PH()" name="btnFusion" value="Fusionner>>"/>
                                                           </div>
                                                   </div>
							 ...
							 <div class="table-responsive">                
								<label class="pull-left" for="nbEntreePhF">Nombre entrées </label>
									<select class="pull-left" id="nbEntreePhF">
									<optgroup>
										<option value="10">10</option>
										<option value="20">20</option>
										<option value="50">50</option>  
									...
									<input class="pull-right" type="text" name="" id="searchInputPhF" placeholder="Rechercher...">
									<input type="hidden" id="idCDF" value="<?php echo $tab0['id']; ?>">
									<div id="resultsProductsPF"><!-- content will be loaded here --></div>
							</div>
					</div>
					<div class="tab-pane fade " id="FUSION2">
                             <div id="fu2"  class="modal fade bd-example-modal-xl" tabindex="-1"   role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                           <div class="modal-dialog modal-lg">
                                               <div class="modal-content">
                                                   <div class="modal-header" style="padding:35px 50px;">
                                                       <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                   ...
                                                   <div class="modal-body" >
                                                     <form id="commentForm" method="post" >
														<input type="hidden" name="id" id="idF2"/>
														<input type="hidden" name="idCT" id="idCTF2"/>
														<input type="hidden" id="designationPH2" name="designation"/>
														<input type="hidden" class="form-control" id="categoriePH2" name="categorie" >
														<input type="hidden" class="form-control" id="formPH2" name="forme"  >
														<input type="hidden" class="form-control" id="tableauPH2" name="tableau" aria-describedby="inputGroupPrepend" >
														<input type="hidden" class="form-control" id="prixSessionPH2" aria-describedby="inputGroupPrepend" name="prixSession"  required>
														<input type="hidden" class="form-control" id="prixPublicPH2" aria-describedby="inputGroupPrepend" name="prixPublic"  required>
														<input type="hidden" class="form-control" id="codeBarreDesignationPH2" aria-describedby="inputGroupPrepend" name="codeBarreDesignation"  >
															<table  id="tableFu2" class="display " border="1">
																<thead >
																	<tr> 
																		<th>CODE BARRE</th> 
																		<th>REFERENCE</th>
															...
															<div class="form-group" align="left">
                                                               <input type="submit" class="btn btn-primary btn-sm" id="btnFusion2" onclick="fusioner_PH2()" name="btnFusion2" value="Fusionner>>"/>
                                                           </div>
                                                   </div>
                                              </div>
                                            </div>
							...
							<div class="table-responsive">                
								<label class="pull-left" for="nbEntreePhF2">Nombre entrées </label>
									<select class="pull-left" id="nbEntreePhF2">
									<optgroup>
										<option value="10">10</option>
										<option value="20">20</option>
										<option value="50">50</option>  
									...
									<input class="pull-right" type="text" name="" id="searchInputPhF2" placeholder="Rechercher...">
									<input type="hidden" id="idCDF2" value="<?php echo $tab0['id']; ?>">
									<div id="resultsProductsPF2"><!-- content will be loaded here --></div>
							</div>
					</div>
