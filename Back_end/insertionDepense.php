...
if(!$modifier and !$supprimer){
  if($nomTransaction) {
      ...
      if(empty($nomTransaction)) {
          ...
          echo'<html>';
          echo'<head>';
          echo'<script>alert("Le nom de la dépense ne peut pas être vide.");</script>';
      ...
      if(strlen($nomTransaction) < 2) {
          ...
          echo'<html>';
          echo'<head>';
          echo'<script>alert("Le nom de la dépense doit contenir au moins 2 caractères.");</script>';
          echo'<script language="JavaScript">document.location="insertionDepense.php"</script>';
          echo'</head>';
          echo'</html>';
          exit;
      ...
      if(strlen($nomTransaction) > 100) {
          ...
          echo'<html>';
          echo'<head>';
          echo'<script>alert("Le nom de la dépense ne peut pas dépasser 100 caractères.");</script>';
          echo'<script language="JavaScript">document.location="insertionDepense.php"</script>';
          echo'</head>';
          echo'</html>';
          exit;
      ...
      // Vérification si la transaction existe déjà
		...
		echo'<html>';
		echo'<head>';
		echo'<script>alert("Cette dépense existe déjà.");</script>';
		echo'<script language="JavaScript">document.location="insertionDepense.php"</script>';
		echo'</head>';
		echo'</html>';
		}
...
elseif($modifier){
      ...
      if($req11->rowCount() > 0){
       ...
       try {
           ...
           die("Erreur lors de la modification de la dépense : " . $e->getMessage());
       }
}
else if ($supprimer) {
    try {
...
<div class="container">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form role="form" class=" formulaire2" name="formulaire2" method="post" action="insertionDepense.php" onsubmit="return validerDepense();">
    ...
    function validerDepense() {
        ...
        if(nom === '') {
            erreurNom.innerHTML = 'Le nom de la dépense ne peut pas être vide.';
        ...
        if(nom.length < 2) {
            erreurNom.innerHTML = 'Le nom de la dépense doit contenir au moins 2 caractères.';
            erreurNom.style.display = 'block';
            document.getElementById('nomTransaction').focus();
            return false;
        }
        ...
        if(nom.length > 100) {
            erreurNom.innerHTML = 'Le nom de la dépense ne peut pas dépasser 100 caractères.';
            erreurNom.style.display = 'block';
            document.getElementById('nomTransaction').focus();
            return false;
        }
        ...
        if(!regex.test(nom)) {
            erreurNom.innerHTML = 'Le nom de la dépense ne peut contenir que des lettres, chiffres, espaces et tirets.';
            erreurNom.style.display = 'block';
            document.getElementById('nomTransaction').focus();
            return false;
        }
