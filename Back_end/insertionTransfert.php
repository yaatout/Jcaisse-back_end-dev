...
if(!$modifier and !$supprimer){
  if($nomTransaction) {
      ...
      if(empty($nomTransaction)) {
          ...
          echo'<html>';
          echo'<head>';
          echo'<script>alert("Le nom du transfert ne peut pas être vide.");</script>';
      ...
      if(strlen($nomTransaction) < 2) {
          ...
          echo'<html>';
          echo'<head>';
          echo'<script>alert("Le nom du transfert doit contenir au moins 2 caractères.");</script>';
          echo'<script language="JavaScript">document.location="insertionTransfert.php"</script>';
          echo'</head>';
          echo'</html>';
          exit;
      ...
      if(strlen($nomTransaction) > 100) {
          ...
          echo'<html>';
          echo'<head>';
          echo'<script>alert("Le nom du transfert ne peut pas dépasser 100 caractères.");</script>';
          echo'<script language="JavaScript">document.location="insertionTransfert.php"</script>';
          echo'</head>';
          echo'</html>';
          exit;
      ...
      // Vérification si la transaction existe déjà
		...
		echo'<html>';
		echo'<head>';
		echo'<script>alert("Ce transfert existe déjà.");</script>';
		echo'<script language="JavaScript">document.location="insertionTransfert.php"</script>';
		echo'</head>';
		echo'</html>';
		}
...
elseif($modifier){
       try {
           ...
           die("Erreur lors de la modification du transfert : " . $e->getMessage());
       }
}
else if ($supprimer) {
    try {
        ...
        die("Erreur lors de la suppression du transfert : " . $e->getMessage());
    }
}
...
<div class="container">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form role="form" class=" formulaire2" name="formulaire2" method="post" action="insertionTransfert.php" onsubmit="return validerTransfert();">
    ...
    function validerTransfert() {
        var nomTransfert = document.getElementById('nomTransaction').value.trim();
        var aliasTransfert = document.getElementById('aliasTransaction').value.trim();
        ...
        // Vérifier le nom du transfert
        if(nomTransfert === '') {
            erreurNom.innerHTML = 'Le nom du transfert ne peut pas être vide.';
            erreurNom.style.display = 'block';
            document.getElementById('nomTransaction').focus();
            return false;
        }
        
        if(nomTransfert.length < 2) {
            erreurNom.innerHTML = 'Le nom du transfert doit contenir au moins 2 caractères.';
            erreurNom.style.display = 'block';
            document.getElementById('nomTransaction').focus();
            return false;
        }
        
        if(nomTransfert.length > 100) {
            erreurNom.innerHTML = 'Le nom du transfert ne peut pas dépasser 100 caractères.';
            erreurNom.style.display = 'block';
            document.getElementById('nomTransaction').focus();
            return false;
        }
