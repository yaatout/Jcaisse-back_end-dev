...
<body>
    ...
    <div class="container" >
        <div class="row" align="center"><h2><span id="" style="margin-top: -20px;margin-right: -15px;border-radius: 50%;background: red;color: white;"
          ...
          ll  <button type="button" name="referenceTransfert" class="btn btn-warning" data-toggle="modal" data-target="#addMat"> Ajout un materiel </button> 
            <button type="button" name="referenceTransfert" class="btn btn-success" data-toggle="modal" data-target="#addCat"> Ajouter Categorie </button>
            ...
            <br><br><br>  
                ...
                <div class="modal fade" id="addCat" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <div class="modal-body">
                                        <form name="formulaireVersement" method="post" >
                                                ...
                                                <div class="form-group">
                                                    <label for="montantTransfert"> Code</label>
                                                    <input type="text" class="form-control" id="codeCategorie" required/>
                                                </div>                      
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                                                <button type="button" class="btn btn-primary"   id="addCategorie"> Ajouter </button>
                                            </div>
                                        </form>
                                    </div>
                ...
                <div id="modCat" class="modal fade" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding:40px 50px;">
                                <form class="form" onsubmit="return false" >
                                    <input type="hidden"  name="designation" id="idCatMod" />
                                    <div class="form-group">
                                        <label for="dateTransfert"> Nom Categorie</label>
                                        <input type="text" class="form-control" id="nomCategorieMod" required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="montantTransfert"> Code categorie</label>
                                        <input type="text" class="form-control" id="codeCategorieMod" required/>
                                    </div>                     
                                    <div class="modal-footer row"> 
                                        <div class="col-sm-3 "> <input type="submit" id="btn_mdf_categorie" class="btn_CodeDesign boutonbasic"  value=" Modifier >>" /></div>
                ...
                <div id="supCatModal" class="modal fade" role="dialog">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h1>Verifier si y'a pas un materiels qui possede ce categorie</h1>
                            <h4 class="modal-title">Suppresion categorie</h4>
                            ...
                            <div class="modal-body" style="padding:40px 50px;">
                                <form class="form" onsubmit="return false" >
                                    ...
                                    <div class="modal-footer row"> 
                                        <div class="col-sm-3 "> <input type="button" id="" class="btn_CodeDesign boutonbasic"  value=" Modifier >>" /></div>
                                        <div class="col-sm-3 "> <input type="button" class="boutonbasic" data-dismiss="modal" name="annule" value="<<  ANNULER" /></div>
                                    </div>
                                </form>
                            </div>
            ...
            <ul class="nav nav-tabs">
                  ...
                  <li class=""><a data-toggle="tab" href="#CATEGORIES" onClick="categorieOnglet()">CATEGORIES</a></li>
            ...
            <div class="tab-content">
                    ...
                    <div class="tab-pane " id="CATEGORIES" > 
                        <div class="table-responsive"> 
                            <label class="pull-left" for="nbEntreeCat">Nombre entrées </label>

                            <select class="pull-left" id="nbEntreeCat">
                                <optgroup>
                            ...
                            <input class="pull-right" type="text"  id="searchInputCat" placeholder="Rechercher...">

                            <div id="resultsProductsCat"> </div> 
                        </div> 
					</div>
