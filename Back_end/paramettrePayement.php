				  ...
				  <div class="card-header text-white bg-success">Liste du personnel</div>-->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="LISTEPERSONNEL">
                                <table id="exemple2" border="1" class="table table-bordered table-striped" >
                                    <thead>
                                        <tr>
                                            <th>Nom Variable</th>
                                            <th>Type Caisse</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($variable['activerMontant']==0) { ?>
                                                                <button type="button" class="btn btn-success"  data-toggle="modal" <?php echo  "data-target='#Activer".$variable['idvariable']."'" ; ?> >
                                                                Activer</button>
                                                                <?php
                                                            } else { ?>
                                                            <button type="button" class="btn btn-danger"  data-toggle="modal" <?php echo  "data-target='#Desactiver".$variable['idvariable']."'" ; ?> >
                                                            Desactiver</button>
                                                        <?php }?>
                                                    </td>
                                                    <td> <?php echo  $variable['pourcentage']; ?>% 
	                                                    <?php
	                                                    	if ($variable['activerPourcentage']==0) { ?>
	                                                         <button type="button"  class="btn btn-success" data-toggle="modal" <?php echo  "data-target='#Activer2".$variable['idvariable']."'" ; ?> >
	                                                            Activer</button>
	                                                            <?php
	                                                        } else { ?>
	                                                            <button type="button"  class="btn btn-success" data-toggle="modal" <?php echo  "data-target='#Desactiver2".$variable['idvariable']."'" ; ?> >
	                                                            Desactiver</button>
	                                                        <?php }
	                                                    ?>
                                                    </td>
                                                    <td> <?php echo  $variable['prixLigne'];   ?>
	                                                    ...
	                                                    if ($variable['activerPrix']==0) { ?>
	                                                            <button type="button" class="btn btn-success" data-toggle="modal" <?php echo  "data-target='#Activer3".$variable['idvariable']."'" ; ?> >
	                                                            Activer</button>
	                                                            <?php
	                                                        } else { ?>
	                                                            <button type="button" class="btn btn-success" data-toggle="modal" <?php echo  "data-target='#Desactiver3".$variable['idvariable']."'" ; ?> >
	                                                            Desactiver</button>
	                                                        <?php }
	                                                         ?>
	                                                </td>
                                                    <td>
	                                                    <?php echo'<a href="#"><img src="images/edit.png" data-target="#imgmodifierPer'.$variable['idvariable'].'" align="middle" alt="modifier"  data-toggle="modal" /></a>';
	                                                        ?>
	                                                            <a   href="#" >
	                                                                <img src="images/drop.png" align="middle" alt="supprimer" data-toggle="modal" <?php echo  "data-target='#imgsuprimerPer".$variable['idvariable']."'" ; ?> /></a>
							                                ...
							                                <div class="modal fade" <?php echo  "id='Desactiver".$variable['idvariable']."'" ; ?> tabindex="-1" role="dialog" 		aria-labelledby="myModalLabel">
							                                    <div class="modal-dialog" role="document">
							                                        <div class="modal-content">
							                                            ...
							                                            <div class="modal-body">
							                                                <form  method="post" action="paramettrePayement.php">
							                                                  <div class="form-group">
							                                ...
							                                <!----------------------------------------------------------->
							                                <div <?php echo  "id='imgmodifierPer".$variable['idvariable']."'" ; ?>   class="ko modal fade" role="dialog">
							                                    <div class="modal-dialog">
							                                        <div class="modal-content">
							                                            ...
							                                            <div class="modal-body">
							                                              ...
							                                              <div class="form-group">
							                                                  <label   class="control-label">NOM VARIABLE DE PAYEMENT <font color="red">*</font></label>
							                                                  <input type="text" class="form-control"   name="nomV" <?php echo  "value=".$variable['nomvariable']."" ; ?> >
							                                            ...
							                                            <div class="form-group">
							                                                  ...
							                                                  <input type="number" class="form-control"   name="moyenneVolumeMin" <?php echo  "value=".$variable["moyenneVolumeMin"]."" ; ?> />
							                                            ...
							                                            <div class="form-group">
							                                                  ...
							                                                  <input type="number" class="form-control"   name="moyenneVolumeMax" <?php echo  "value=".$variable["moyenneVolumeMax"]."" ; ?> />
							                                              ...
							                                              <div class="form-group">
							                                                  <label   class="control-label">MONTANT PAYEMENT FIXE <font color="red">*</font></label>
							                                                  <input type="number" class="form-control"   name="montantFixe" <?php echo  "value=".$variable['montant']."" ; ?> />
							                                             ...
							                                             <div class="form-group">
							                                                <label   class="control-label">POURCENTAGE SUR VENTES<font color="red">*</font></label>
							                                                <input type="number" class="form-control"   name="pourcentage" <?php echo  "value=".$variable['pourcentage']."" ; ?> />
							                                            ...
							                                            <div class="form-group">
							                                                <label   class="control-label">PRIX INSERTION D'UNE LIGNE <font color="red">*</font></label>
							                                                <input type="number" class="form-control"   name="prixInsertion" <?php echo  "value=".$variable['prixLigne']."" ; ?> />
							                                              ...
							                                              <div class="form-group">
							                                                <label  class="control-label">MONTANT PAYEMENT MIN <font color="red">*</font></label>
							                                                <input type="number" class="form-control"   name="montantMin" <?php echo  "value=".$variable['minmontant']."" ; ?> />
							                                              ...
							                                              <div class="form-group">
							                                                <label   class="control-label">MONTANT PAYEMENT MAX <font color="red">*</font></label>
							                                                <input type="number" class="form-control"   name="montantMax" <?php echo  "value=".$variable['maxmontant']."" ; ?> />
							                                    ...
							                                    <div class="modal-dialog">
							                                        <div class="modal-content">
							                                            ...
							                                            <div class="modal-body">
							                                              ...
							                                              <div class="form-group">
							                                                  <label   class="control-label">NOM VARIABLE DE PAYEMENT <font color="red">*</font></label>
							                                                  <input type="text" class="form-control"   name="nomV" <?php echo  "value=".$variable['nomvariable']."" ; ?> disabled="">
							                                                <input type="hidden" name="nomVInitial" <?php echo  "value=".$variable['nomvariable']."" ; ?> />
							                                                  <span class="text-danger" ></span>
							                                              </div>
							                                              ...
							                                              <div class="form-group">
							                                                  ...
							                                                  <input type="text" class="form-control"   name="type" <?php echo  "value=".$variable["typecaisse"]."" ; ?> disabled="">
							                                              ...
							                                              <div class="form-group">
							                                                  <label for="type" class="control-label">TYPE DE CAISSE<font color="red">*</font></label>
							                                                  <input type="text" class="form-control"   name="categorie" <?php echo  "value=".$variable["categoriecaisse"]."" ; ?> disabled="">
							                                              ...
							                                              <div class="form-group">
							                                                  <label   class="control-label">MONTANT PAYEMENT FIXE <font color="red">*</font></label>
							                                                  <input type="number" class="form-control"   name="montantFixe" <?php echo  "value=".$variable['montant']."" ; ?> disabled="" />
							                                                <input type="hidden" name="montantFixeInitial" <?php echo  "value=".$variable['montant']."" ; ?> />
							                                                  <span class="text-danger" ></span>
							                                              </div>
							                                             ...
							                                             <div class="form-group">
							                                                <label   class="control-label">POURCENTAGE SUR VENTES<font color="red">*</font></label>
							                                                <input type="number" class="form-control"   name="pourcentage" <?php echo  "value=".$variable['pourcentage']."" ; ?> disabled="" />
							                                                <input type="hidden" name="pourcentageInitial" <?php echo  "value=".$variable['pourcentage']."" ; ?> />
							                                                <span class="text-danger" ></span>
							                                              </div>
							                                            ...
							                                            <div class="form-group">
							                                                <label   class="control-label">PRIX INSERTION D'UNE LIGNE <font color="red">*</font></label>
							                                                <input type="number" class="form-control"  name="prixInsertion" <?php echo  "value=".$variable['prixLigne']."" ; ?> disabled="" />
							                                                <input type="hidden" name="prixInsertionInitial" <?php echo  "value=".$variable['prixLigne']."" ; ?> />
							                                                <span class="text-danger" ></span>
							                                              </div>
							                                              ...
							                                              <div class="form-group">
							                                                <label   class="control-label">MONTANT PAYEMENT MIN <font color="red">*</font></label>
							                                                <input type="number" class="form-control"   name="montantMin" <?php echo  "value=".$variable['minmontant']."" ; ?> disabled="" />
							                                                <input type="hidden" name="montantMinInitial" <?php echo  "value=".$variable['minmontant']."" ; ?> />
							                                                <span class="text-danger" ></span>
							                                              </div>
							                                              ...
							                                              <div class="form-group">
							                                                <label  class="control-label">MONTANT PAYEMENT MAX <font color="red">*</font></label>
							                                                <input type="number" class="form-control"   name="montantMax" <?php echo  "value=".$variable['maxmontant']."" ; ?> disabled="" />
							                                                <input type="hidden" name="montantMaxInitial" <?php echo  "value=".$variable['maxmontant']."" ; ?> />
							                                                <span class="text-danger" ></span>
							                                              </div>
