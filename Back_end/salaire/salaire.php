...
if (isset($_POST['payementSalaire'])) {
        ...
        while ($contrat=$req1->fetch()) { 	       
            ...
            if ($salaire) {
                    ...
                    $req3 = $bdd->prepare("INSERT INTO `aaa-salaire-personnel` (etape,idContrat,salaireDeBase,aPayer) 
                                                                    values (:et,:idC,:sb,:aP) ");
                    $req3->execute(array(
                            'et'=>$etape,
...
if (isset($_POST['btnVirerIngXXXX'])) {
       ...
       $nouveauAvance=$montant;
        ...
        /********************************TABLE COMPTE **************************************/   
}if (isset($_POST['btnVirerAvanceXXX'])) {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form  method="post" >
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label">Date <font color="red">*</font></label>
                                    <input type="date" name="datePaiement" <?php echo  "value=". $dateString."" ; ?>  id="dateV_Pers"  >
                                    <span class="text-danger" ></span>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label">Paiement par :<font color="red">*</font></label>
                                        ...
                                        <span class="text-danger" id="montantNoDisp"></span>
                                </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                                    <button type="button" name="btnVirerIng" id="btnVirerIng" class="btn btn-primary" 
                                                   onclick="virementPerSPop()" >Effectuer le virement
                                        </button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form  method="post" >
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label">Date <font color="red">*</font></label>
                                    <input type="date" name="datePaiement" <?php echo  "value=". $dateString."" ; ?> id="date_Pers_Virem" >
                                    <span class="text-danger" ></span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                                    <button type="button" name="btnVirerAvance" id="btnVirerAvancePers" class="btn btn-primary"
                                                    onclick="virerAvancePers()" >Effectuer le virement</button>
                                </div>
                            </form>
                        </div>
                    </div>
