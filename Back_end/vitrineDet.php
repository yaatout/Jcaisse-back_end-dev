      ...
      <?php require('header.php'); ?>
        ...
        <div class="container">
            ...
            <?php
              ...
              ?>
              <h2>Catalogue : <?php echo $_SESSION['boutV']; echo'<div class="row" align="center"><span id="" style="margin-top: -20px;margin-right: -15px;border-radius: 50%;background: red;color: white;"
