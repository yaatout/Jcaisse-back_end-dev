    ...
    if(!@$_GET["jour"]){
                ...
                if (isset($_POST['btnSavePagnetTransfert'])) {
                    ...
                    if(mysql_num_rows($res0)){
                        ...
                        if($jour > 4){
                            ...
                            $sql6="insert into `".$nomtablePagnet."` (datepagej,heurePagnet,iduser,type,totalp,remise,apayerPagnet,restourne,versement,verrouiller,idClient) values('".$datehier."','".$heureString."',".$_SESSION['iduser'].",3,0,0,0,0,0,0,0)";

                            $res6=mysql_query($sql6) or die ("insertion pagnier impossible =>".mysql_error());

                            if($res6){

                                $reqA="SELECT * from `".$nomtablePagnet."` where iduser='".$_SESSION['iduser']."' && type=3 && idClient=0 && datepagej ='".$datehier."' && verrouiller=0 order by idPagnet desc limit 1";
        ...
        <section> <div class="container">';
                    ...
                    $sqlTD="SELECT DISTINCT p.idPagnet
                        ...
                        WHERE l.classe=3 && l.unitevente ='Depot' && p.idClient=0  && p.verrouiller=1 && p.datepagej ='".$datehier."' && p.type=0   ORDER BY p.idPagnet DESC";
                    ...
                    $sqlTR="SELECT DISTINCT p.idPagnet
                        ...
                        WHERE l.classe=3 && l.unitevente ='Retrait'  && p.idClient=0  && p.verrouiller=1 && p.datepagej ='".$datehier."' &&type=0  ORDER BY p.idPagnet DESC";
                    ...
                    $sqlTF="SELECT DISTINCT p.idPagnet
                        ...
                        WHERE l.classe=3 && l.unitevente ='Facture'   && p.idClient=0  && p.verrouiller=1 && p.datepagej ='".$datehier."' && p.type=0  ORDER BY p.idPagnet DESC";
        ...
        ?>
            ...
            <div class="jumbotron">
                ...
                <div class="col-sm-2 pull-right" >
                    ...
                    <input type="date" class="form-control" id="jour_date"  onchange="date_jour_Vente('jour_date');"  <?php echo '  max="'.date('Y-m-d', strtotime('-1 days')).'" ';?> value="<?php echo date('Y-m-d', strtotime($datehier));?>" name="dateInventaire" required  />
            ...
            <?php
                ...
                if (($_SESSION['type']=="Multi-service") && ($_SESSION['categorie']=="Detaillant")) {
                    ...
                    <form name="btnSavePagnetTransfert" method="post" id="addTransfert" class="pull-right" >
                        ...
                        <button type="submit" class="btn btn-warning noImpr" name="btnSavePagnetTransfert">
            ...
            <!-- Debut de l'Accordion pour Tout les Paniers -->
                ...
                <div class="panel-group" id="accordion">
                    ...
                    /**Debut requete pour Lister les Paniers en cours d'Aujourd'hui (2 aux maximum) **/
                        ...
                        $sqlP0="SELECT * FROM `".$nomtablePagnet."` where idClient=0 && datepagej ='".$datehier."' && verrouiller=0 ORDER BY idPagnet DESC";
                    ...
                    /**Debut requete pour Lister tout les Paniers d'Aujourd'hui  **/
                        ...
                        $sql2="SELECT * FROM `".$nomtablePagnet."` where idClient=0 && datepagej ='".$datehier."' ORDER BY idPagnet DESC";
                    ...
                    /**Debut requete pour Rechercher le dernier Panier Ajouter  **/
                        ...
                        $reqA="SELECT idPagnet from `".$nomtablePagnet."` where idClient=0 order by idPagnet desc limit 1";
                                        ...
                                        <div class="panel-body" >
                                            ...
                                            <!--*******************************Debut Ajouter Ligne****************************************-->
                                                ...
                                                <form  class="form-inline pull-left noImpr ajouterProdForm" id="ajouterProdFormB" onsubmit="return false" >
                                                    ...
                                                    <input type="text" size="50" class="inputbasic form-control" name="codeBarre" id="codeBarreLigneVt" autofocus="" autocomplete="off"  required />
                                            ...
                                            <!--*******************************Debut Terminer Pagnet****************************************-->
                                                ...
                                                <form class="form-inline pull-right noImpr" style="margin-right:20px;" target="_blank" method="post" action="pdfCodeBarre.php">
                                                    ...
                                                    <button type="submit" style="margin-left:15px;" name="btnImprimerCodeBarre" <?php echo  "id=btnImprimerCodebarre".$pagnet['idPagnet']."" ; ?> class="btn btn-success pull-right" data-toggle="modal" onclick='remiseB("<?php echo  $pagnet['idPagnet'] ; ?>");' ><span class="glyphicon glyphicon-lock"></span>Terminer</button>
                        ...
                        <?php	$idmax=mysql_result($resA,0); ?>
                                            ...
                                            <div <?php echo  "id=pagnet".$pagnet['idPagnet']."" ; ?>
                                                ...
                                                <div class="panel-body" >
                                                    ...
                                                    <?php if ($_SESSION['proprietaire']==1 && $_SESSION['editionPanier']==1){ ?>
                                                        ...
                                                        <button type="button" class="btn btn-primary pull-left modeEditionBtn" id="edit-<?= $pagnet['idPagnet'] ; ?>">
                                                        ...
                                                        <?php if($_SESSION['Pays']=='Canada'){   ?> 
                                                            ...
                                                            <div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <?php echo  'Total panier : '.$pagnet['totalp'].'<br/>'; ?>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <?php echo  'Sous-total : '.$pagnet['apayerPagnet'].'<br/>'; ?>

                                                                </div>

                                                                <div>

                                                                    <?php echo  'TPS à 5% : '.(($pagnet['apayerPagnet'] * 5)/100).'<br/>'; ?>

                                                                </div>

                                                                <div>

                                                                    <?php echo  'TVQ à 9.975% : '.(($pagnet['apayerPagnet'] * 9.975)/100).'<br/>'; ?>

                                                                </div>

                                                                <div>

                                                                    <?php echo  '<b>Total : '.( $pagnet['apayerPagnet'] + (($pagnet['apayerPagnet'] * 5)/100) + (($pagnet['apayerPagnet'] * 9.975)/100) ) .'</b><br/>'; ?>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <?php if($pagnet['versement']!=0): ?>
                                                                        ...
                                                                        <?php  echo 'Rendu : '.($pagnet['versement'] - ( $pagnet['apayerPagnet'] + (($pagnet['apayerPagnet'] * 5)/100) + (($pagnet['apayerPagnet'] * 9.975)/100) )) .'<br/>';?>
                            ...
                            <ul class="pagination pull-right">
                                ...
                                <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                                    ...
                                    <a href="actualiserVente.php?jour=<?= $datehier; ?>&&page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                                ...
                                <?php for($page = 1; $page <= $pages; $page++): ?>
                                    ...
                                    <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                        ...
                                        <a href="actualiserVente.php?jour=<?= $datehier; ?>&&page=<?= $page ?>" class="page-link"><?= $page ?></a>
                                ...
                                <?php endfor ?>
                                    ...
                                    <a href="actualiserVente.php?jour=<?= $datehier; ?>&&page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                                        ...
                                        while ($transaction = mysql_fetch_array($resT)){
                                            ...
                                            if(mysql_num_rows($res0)){
                                                ...
                                                if($trans['seuil']==1){
                                                    ...
                                                    $sql1="SELECT * FROM `".$nomtableTransfert."` where  dateTransfert='".$datehier_Y."' AND idTransaction='".$transaction['idTransaction']."' ORDER BY idTransfert DESC";
        ...
        $dateDetails=explode("-", $datejour);

        $datejourA=$dateDetails[2].'-'.$dateDetails[1].'-'.$dateDetails[0];
                ...
                if (isset($_POST['btnSavePagnetTransfert'])) {
                    ...
                    if(mysql_num_rows($res0)){
                        ...
                        if($jour > 4){
                            ...
                            $sql6="insert into `".$nomtablePagnet."` (datepagej,heurePagnet,iduser,type,totalp,remise,apayerPagnet,restourne,versement,verrouiller,idClient) values('".$datejour."','".$heureString."',".$_SESSION['iduser'].",3,0,0,0,0,0,0,0)";

                            $res6=mysql_query($sql6) or die ("insertion pagnier impossible =>".mysql_error());

                            if($res6){

                                $reqA="SELECT * from `".$nomtablePagnet."` where iduser='".$_SESSION['iduser']."' && type=3 && idClient=0 && datepagej ='".$datejour."' && verrouiller=0 order by idPagnet desc limit 1";
        ...
        <section> <div class="container">';
                ...
                $sqlTD="SELECT DISTINCT p.idPagnet
                    ...
                    WHERE l.classe=3 && l.unitevente ='Depot' && p.idClient=0  && p.verrouiller=1 && p.datepagej ='".$datejour."' && p.type=0   ORDER BY p.idPagnet DESC";
                ...
                $sqlTR="SELECT DISTINCT p.idPagnet
                    ...
                    WHERE l.classe=3 && l.unitevente ='Retrait'  && p.idClient=0  && p.verrouiller=1 && p.datepagej ='".$datejour."' &&type=0  ORDER BY p.idPagnet DESC";
                ...
                $sqlTF="SELECT DISTINCT p.idPagnet
                    ...
                    WHERE l.classe=3 && l.unitevente ='Facture'   && p.idClient=0  && p.verrouiller=1 && p.datepagej ='".$datejour."' && p.type=0  ORDER BY p.idPagnet DESC";
        ...
        ?>
                ...
                <div class="jumbotron">
                    ...
                    <div class="col-sm-2 pull-right" >
                        ...
                        <input type="date" class="form-control" id="jour_date"  onchange="date_jour_Vente('jour_date');"  <?php echo '  max="'.date('Y-m-d', strtotime('-1 days')).'" ';?> value="<?php echo date('Y-m-d', strtotime($datejour));?>"  required  />
                ...
                <!-- Debut de l'Accordion pour Tout les Paniers -->
                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        /**Debut requete pour Lister les Paniers en cours d'Aujourd'hui (2 aux maximum) **/
                            ...
                            $sqlP0="SELECT * FROM `".$nomtablePagnet."` where idClient=0 && datepagej ='".$datejour."' && verrouiller=0 ORDER BY idPagnet DESC";
                        ...
                        /**Debut requete pour Lister tout les Paniers d'Aujourd'hui  **/
                            ...
                            $sql2="SELECT * FROM `".$nomtablePagnet."` where idClient=0 && datepagej ='".$datejour."' ORDER BY idPagnet DESC";
                        ...
                        <?php if($_SESSION['proprietaire']==1){ ?> 
                            ...
                            <ul class="pagination pull-right">
                                ...
                                <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                                    ...
                                    <a href="actualiserVente.php?jour=<?= $datejour; ?>&&page=<?= $currentPage - 1 ?>" class="page-link">Précédente</a>
                                ...
                                <?php for($page = 1; $page <= $pages; $page++): ?>
                                    ...
                                    <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                                        ...
                                        <a href="actualiserVente.php?jour=<?= $datejour; ?>&&page=<?= $page ?>" class="page-link"><?= $page ?></a>
                                ...
                                <?php endfor ?>
                                    ...
                                    <a href="actualiserVente.php?jour=<?= $datejour; ?>&&page=<?= $currentPage + 1 ?>" class="page-link">Suivante</a>
                                        ...
                                        while ($transaction = mysql_fetch_array($resT)){
                                            ...
                                            if(mysql_num_rows($res0)){
                                                ...
                                                if($trans['seuil']==1){
                                                    ...
                                                    $sql1="SELECT * FROM `".$nomtableTransfert."` where   dateTransfert='".$datejourA."' AND idTransaction='".$transaction['idTransaction']."' ORDER BY idTransfert DESC";
