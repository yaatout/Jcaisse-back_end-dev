...
if ($operation=="1" || $operation=="3" || $operation=="4") {
  ...
  if ($query =="") {
    ...
    # code...
      ...
      $sqlGetStock = $bdd->prepare("SELECT DISTINCT idDesignation, SUM(quantiteStockCourant) as s_stock FROM `".$nomtableEntrepotStock."`
  ...
  foreach ($produits as $stock) {
    ...
    $design=mysql_fetch_array($res1);
      ...
      echo  '<tr>';    
        ...
        // if($S_produit==0){
            echo  '<td><span style="color:#020846;">'.$S_produit.'</span></td>';
