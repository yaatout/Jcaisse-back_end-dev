...
require('../declarationVariables.php');
    ...
    if($operation == 'EditForme_PH'){
        ...
        $nomForme_old=@htmlspecialchars($_POST["forme_oldD"]);
        $result="1";
        $che="8";
    ...
    if($operation == 'DeleteForme_PH'){
          ...
          $formeRempl=@htmlspecialchars($_POST["formeRempl"]);
          $result='1';
            ...
            if ($res0=mysql_query($sql0)) {
              ...
              $sql1="SELECT * from  `".$formeTypeCategPharmacie."` WHERE forme ='".$forme."' ";

              if ($res1=mysql_query($sql1)) {
                while($catalogue =mysql_fetch_array($res1)){
                  $sql2="update `".$formeTypeCategPharmacie."` set
