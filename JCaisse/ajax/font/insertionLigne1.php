                              ...
                              <?php /**/ $sql8="SELECT * FROM `".$nomtableLigne."` where idPagnet=".$pagnet['idPagnet']." ORDER BY numligne DESC";
                                              ...
                                              while ($ligne = mysql_fetch_array($res8)) {?>
                                                  <tr>
                                                    ...
                                                    <td>
																									<form class="form-inline pull-right" id="factForm" 	method="post"  <?php echo  "action=insertionLigne1.php" ; ?> >
						    ...
						    <div>
									...
									<div>
										<?php if ($pagnet['verrouiller']==0): ?>
											...
											<input class="noImpr" size="7" type="text" placeholder="Espéce" name="versement" <?php echo  "id=versement".$pagnet['idPagnet'].""; ?>>
											<?php else: ?>
