...
if ($operation=="1" || $operation=="3" || $operation=="4") {
  ...
  $nbEntreeASEt = @$_POST["nbEntreeASEt"];
  $query = @$_POST["query"];
  $cb = @$_POST["cb"];
  $item_per_page = ($nbEntreeASEt!=0) ? $nbEntreeASEt : 10; //item to display per page
  ...
  while($design=mysql_fetch_array($res)){
    ...
    // else{
      ...
      echo '<tr>';
        ...
        echo  '<td><input type="number" class="form-control" id="prixuniteStock-'.$design['idDesignation'].'" value="'.$design["prixuniteStock"].'" /></td>';
        echo  '<td><input type="number" class="form-control" id="prixunitaire-'.$design['idDesignation'].'" value="'.$design["prix"].'" /></td>';
        echo  '<td><input type="number" class="form-control" id="prixachat-'.$design['idDesignation'].'" value="'.$design["prixachat"].'" /></td>';
        echo  '<td><input type="text" class="form-control dateInputControl" size="10" maxlength="10" name="dateExpiration-'.$design['idDesignation'].'" id="dateExpiration-'.$design['idDesignation'].'" value="" placeholder="01-01-2020"/></td>';
        echo  '<td><select class="form-control depotChoix" id="depotChoix-'.$design['idDesignation'].'">
                </select>
              </td>';
        echo  '<td><button type="button" onclick="ajt_Stock_ET('.$design["idDesignation"].')" id="btn_AjtStock-'.$design['idDesignation'].'" class="btn btn-success btn-sm">
  ...
  while($design=mysql_fetch_array($res)){
    ...
    // else{
      ...
      echo '<tr>';
        ...
        echo  '<td><input type="number" class="form-control" id="prixunitaire-'.$design['idDesignation'].'" value="'.$design["prix"].'" /></td>';
        echo  '<td><input type="number" class="form-control" id="prixachat-'.$design['idDesignation'].'" value="'.$design["prixachat"].'" /></td>';
        echo  '<td><input type="text" class="form-control dateInputControl" size="10" maxlength="10" name="dateExpiration-'.$design['idDesignation'].'" id="dateExpiration-'.$design['idDesignation'].'" value="" placeholder="01-01-2000"/></td>';
        echo  '<td><select class="form-control depotChoix" id="depotChoix-'.$design['idDesignation'].'">
                </select>
              </td>';
        echo  '<td><button type="button" onclick="ajt_Stock_ET('.$design["idDesignation"].')" id="btn_AjtStock-'.$design['idDesignation'].'" class="btn btn-success btn-sm">
