...
if ($operation=="1" || $operation=="3" || $operation=="4") {
  ...
  $nbEntreeDepot = @$_POST["nbEntreeDepot"];
  $query = @$_POST["query"];
  $cb = @$_POST["cb"];
  $item_per_page = ($nbEntreeDepot!=0) ? $nbEntreeDepot : 10; //item to display per page
    ...
    echo '<br/><div class="container row">
          <a class="col-lg-6 alert alert-info" href="#">LISTE DES CLIENTS ';
            ...
            if ($_SESSION['proprietaire']==1) { 
              ...
              echo  ' => Valeur Montant depot =  '.number_format(($T_depots * $_SESSION['devise']), 2, ',', ' ').' '.$_SESSION['symbole'];
            }
  ...
  echo '<thead>
              <tr>
                  ...
                  <th style="width: 18%;">Montant dépôt</th>
  ...
  foreach ($clients as $cli) {
    ...
    echo '<tr>';
      ...
      if ($cli['activer']==0 && ($TotalB[0]==0 &&  $cli['solde']==0 )){
          ...
          <a hidden><img src="images/edit.png" align="middle" alt="modifier" onclick="mdf_Client('.$cli["idClient"].','.$i.')" data-toggle="modal"    /></a>&nbsp;
          <a hidden><img src="images/drop.png" align="middle" alt="supprimer" onclick="spm_Client('.$cli["idClient"].','.$i.')" data-toggle="modal"    /></a>&nbsp';
          }
          else{
          ...
          if ($cli['activer']==0){
          echo  '<td><button disabled="true" type="button" onclick="activer_Client('.$cli["idClient"].')" id="btn_Client-'.$cli['idClient'].'" class="btn btn-success btn-xs" > Activer</button>&nbsp
          <a hidden><img src="images/edit.png" align="middle" alt="modifier" onclick="mdf_Client('.$cli["idClient"].','.$i.')" data-toggle="modal"    /></a>&nbsp;</td>';
          }
          else{
                    ...
                    table: {
                      ...
                      body: [
                        [
                          ...
                          { text: "Montant dépôt", style: "tableHeader",alignment: "center" },
                        ],
                        ...lignes,
                      ]
                    },
