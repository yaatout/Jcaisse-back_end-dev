...
if ($operation=="1") {
  $sqlA="SELECT * from `".$nomtableClient."` where archiver=0 and idClientVitrine!=0 order by idClient desc";
  ...
  */
  if (($_SESSION['type']=="Pharmacie") && ($_SESSION['categorie']=="Detaillant")) {
    ...
    $T_venteEnLigne=$T_venteEnLigne+$T_solde;
...
if ($operation=="1" || $operation=="3" || $operation=="4") {
  ...
  $nbEntreeClient = @$_POST["nbEntreeEnLigne"];
  $query = @$_POST["query"];
  ...
  if ($query =="") {
    ...
    //get total number of records from database
      ...
      $sql="SELECT * from `".$nomtableClient."` where archiver=0 and idClientVitrine!=0 and (nom LIKE '%".$query."%' or prenom LIKE '%".$query."%') order by idClient desc";
      $res=mysql_query($sql);
      # code...
  }
    ...
    echo '<br/><div class="container row">
          <a class="col-lg-6 alert alert-info" href="#">LISTE DES CLIENTS ';
            ...
            if ($_SESSION['proprietaire']==1) { 
              echo  ' => Total des ventes en ligne =  '.number_format(($T_venteEnLigne * $_SESSION['devise']), 2, ',', ' ').' '.$_SESSION['symbole'];
            }
