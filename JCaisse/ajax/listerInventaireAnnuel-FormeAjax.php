    ...
    // else{
      ...
      echo '<tr>';
        if($inventaire!=null){
          ...
          echo '<td style="background-color: lightslategray; "><input type="text" id="forme-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="'.$designation['forme'].'" /></td>';
          echo '<td style="background-color: lightslategray; "><input type="number" id="prixSessionF-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="'.$designation['prixSession'].'" /></td>';
          echo '<td style="background-color: lightslategray; "><input type="number" id="prixPublicF-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="'.$designation['prixPublic'].'" /></td>';
          echo '<td style="background-color: lightslategray; ">'.$S_stock[0].'</td>';
          echo '<td style="background-color: lightslategray; ">'.'<input type="number" id="quantiteF-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="" /></td>'; 	
          if($S_stock[0]==0){
            echo '<td style="background-color: lightslategray; ">
            <button type="button" class="btn btn-success btn-sm btn_ajtStock" id="btn_InvStock-'.$stock['idDesignation'].'" onclick="inventaireAnnuelForme('.$stock["idDesignation"].',1)">
          ...
          echo '<td><input type="text" id="forme-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="'.$designation['forme'].'" /></td>';
          echo '<td><input type="number" id="prixSessionF-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="'.$designation['prixSession'].'" /></td>';
          echo '<td><input type="number" id="prixPublicF-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="'.$designation['prixPublic'].'" /></td>';
          echo '<td>'.$S_stock[0].'</td>';
          echo '<td>'.'<input type="number" id="quantiteF-'.$stock["idDesignation"].'" class="form-control quantitePhysiqueIntermittent" width="20%"  min=1 value="" /></td>'; 	
          if($S_stock[0]==0){
            echo '<td>
            <button type="button" class="btn btn-success btn-sm btn_ajtStock" id="btn_InvStock-'.$stock['idDesignation'].'" onclick="inventaireAnnuelForme('.$stock["idDesignation"].',1)">
              <i class="glyphicon glyphicon-refresh"></i>
