...
if ($operation=="1" || $operation=="3" || $operation=="4") {
  ...
  while($design=mysql_fetch_array($res)){ //fetch values
    ...
    if($_SESSION['proprietaire']==1){
      ...
      echo  '<td><a onclick="desarchiver_Designation('.$design["idDesignation"].','.$i.')" data-toggle="modal" class="btn btn-warning">Desarchiver</a></td>';
...
if ($operation=="2") {
  ...
  echo '<table class="table table-striped contents display tabDesign tableau3" id="tableArchiver" border="1">';
...
if ($operation=="13") {
  ...
  echo '<table class="table table-striped contents" id="tableArchiver" border="1">';
