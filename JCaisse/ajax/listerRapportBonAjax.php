...
if ($operation=="1" || $operation=="3" || $operation=="4") {
  ...
  $nbEntreeBonParProduit = @$_POST["nbEntreeBonParProduit"];
  $query = @$_POST["query"];
  $cb = @$_POST["cb"];
  $item_per_page 		= ($nbEntreeBonParProduit!=0) ? $nbEntreeBonParProduit : 10; //item to display per page
  ...
  echo '
  <center style="margin-bottom :10px; margin-top :10px; display:none" class="btn_Impression"> 
    <button onclick="bonProduit_Excel()">
      <span class="glyphicon glyphicon-download"></span>
      EXCEL
    </button> 
    <button onclick="bonProduit_PDF()">
      <span class="glyphicon glyphicon-download"></span>
      PDF
    </button> 
  </center> 
        ...
        $(function(){
          bonProduit_Excel= function ()  {
              ...
              for(var i = 0; i<taille; i++){
                ...
                column2 = table[i]["qte"];
                column3 = table[i]["uniteStock"];
                column4 = table[i]["nbreArticleUniteStock"];
                column5 = table[i]["prixuniteStock"];
                column6 = table[i]["total"];
              ...
              link.setAttribute("download", "Bon_Produit_Rapport.csv");
            ...
            function setColumns(data) {
                ...
                for(var i = 0; i<taille; i++){
                        tableData.push([
                            ...
                            { text: table[i]["uniteStock"],fontSize: 08,alignment: "center"  },
                            { text: table[i]["nbreArticleUniteStock"],fontSize: 08 ,alignment: "center"},
                            { text: table[i]["prixU"],fontSize: 08 ,alignment: "center" },
                  ...
                  table: {
                    ...
                    body: [
                      [
                        ...
                        { text: "Nombre Article U.S", style: "tableHeader",alignment: "center" }, 
