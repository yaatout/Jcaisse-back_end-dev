...
// $sql="SELECT * FROM `".$nomtableStock."` s
  ...
  //   $rows[] = '<button type="button" class="btn btn-success btn_ajtStock" id="btn_InvStock-'.$stock['idDesignation'].'" onclick="inventaireIntermittentB('.$stock["idDesignation"].')"><i class="glyphicon glyphicon-plus">
  //     </i>CORRIGER
  //   </button>&nbsp;';
  ...
  foreach ($produits as $stock) {
    ...
    // else{
      ...
      echo '<tr>';      
        ...
        echo '<td>'.'<input type="number" id="qtyRayon-'.$stock["idDesignation"].'" class="form-control" width="20%"  min=1 value="" /></td>'; 	
        echo '<td>'.'<input type="number" id="qtyDepot-'.$stock["idDesignation"].'" class="form-control" width="20%"  min=1 value="" /></td>'; 	

        echo '<td><button type="button" class="btn btn-success btn_ajtStock" id="btn_InvStock-'.$stock['idDesignation'].'" onclick="inventaireIntermittentB('.$stock["idDesignation"].')"><i class="glyphicon glyphicon-ok">
          </i>
        </button>&nbsp;</td>';
      echo '</tr>';
