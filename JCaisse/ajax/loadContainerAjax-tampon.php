...
// if($_SESSION['proprietaire']==1){
    ...
    //     $sql2="SELECT * FROM `".$nomtablePagnetTampon."` where iduser='".$_SESSION['iduser']."' && idClient=0 && datepagej ='".$dateString2."' ORDER BY idPagnet DESC";
        ...
        <div class="panel-group" id="accordion">
                ...
                if($_SESSION['proprietaire']==1){
                    ...
                    if (isset($_POST['produit'])) {
                        ...
                        /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                            ...
                            $sqlC="SELECT COUNT(*) FROM `".$nomtablePagnetTampon."` p
                        ...
                        /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                            ...
                            $sqlP1="SELECT * FROM `".$nomtablePagnetTampon."` p
                        ...
                        /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                            ...
                            $sqlC="SELECT COUNT(*) FROM `".$nomtablePagnetTampon."` where datepagej ='".$dateString2."' && (type=0 || type=11 || type=30 || type=10) && verrouiller=1  ORDER BY idPagnet DESC";
                        ...
                        /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                            ...
                            $sqlP1="SELECT * FROM `".$nomtablePagnetTampon."` where datepagej ='".$dateString2."' && (type=0 || type=11 || type=30 || type=10) && verrouiller=1 ORDER BY idPagnet DESC LIMIT ".$premier.",".$parPage." ";
                    ...
                    /**Debut requete pour Lister les Paniers en cours d'Aujourd'hui (2 aux maximum) **/
                        ...
                        $sqlP0="SELECT * FROM `".$nomtablePagnetTampon."` where iduser='".$_SESSION['iduser']."' && datepagej ='".$dateString2."' && verrouiller=0 ORDER BY idPagnet DESC";
                    ...
                    /**Debut requete pour Lister tout les Paniers d'Aujourd'hui  **/
                        ...
                        $sql2="SELECT * FROM `".$nomtablePagnetTampon."` where datepagej ='".$dateString2."' ORDER BY idPagnet DESC";
                    ...
                    /**Debut requete pour Rechercher le dernier Panier Ajouter  **/
                        ...
                        $reqA="SELECT idPagnet from `".$nomtablePagnetTampon."` order by idPagnet desc limit 1";
                    ...
                    if (isset($_POST['produit'])) {
                        ...
                        /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                            ...
                            $sqlC="SELECT COUNT(*) FROM `".$nomtablePagnetTampon."` where  iduser='".$_SESSION['iduser']."' && (type=0 || type=11 || type=30 || type=10) && datepagej ='".$dateString2."' && verrouiller=1  ORDER BY idPagnet DESC";
                        ...
                        /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                            ...
                            $sqlP1="SELECT * FROM `".$nomtablePagnetTampon."` where  iduser='".$_SESSION['iduser']."' && (type=0 || type=11 || type=30 || type=10) && datepagej ='".$dateString2."' && verrouiller=1  ORDER BY idPagnet DESC LIMIT 10 ";
                    ...
                    /**Debut requete pour Lister tout les Paniers d'Aujourd'hui  **/
                        ...
                        $sql2="SELECT * FROM `".$nomtablePagnetTampon."` where  iduser='".$_SESSION['iduser']."' && datepagej ='".$dateString2."' ORDER BY idPagnet DESC";
                    ...
                    /**Debut requete pour Rechercher le dernier Panier Ajouter  **/
                        ...
                        $reqA="SELECT idPagnet from `".$nomtablePagnetTampon."` where  iduser='".$_SESSION['iduser']."' order by idPagnet desc limit 1";
                            ...
                            <div class="panel-heading">
                                ...
                                <h4 data-toggle="collapse" data-parent="#accordion" <?php echo  "href=#pagnet".$pagnet['idPagnet']."" ; ?>  class="panel-title expand">
                                    ...
                                    <a class="row" href="#"> 
                                        ...
                                        <?php	$sqlT="SELECT SUM(prixtotal) FROM `".$nomtableLigneTampon."` where idPagnet=".$pagnet['idPagnet']." ";
                                        ...
                                        <?php if($_SESSION['Pays']=='Canada'){ 
                                            ...
                                            $sqlTP="SELECT SUM(prixtotalTvaP) FROM `".$nomtableLigneTampon."` where idPagnet=".$pagnet['idPagnet']." ";

                                            $resTP = mysql_query($sqlTP) or die ("persoonel requête 2".mysql_error());

                                            $TotalTvaP = mysql_fetch_array($resTP) ;

                                            $sqlTR="SELECT SUM(prixtotalTvaR) FROM `".$nomtableLigneTampon."` where idPagnet=".$pagnet['idPagnet']." ";
                                ...
                                <div class="panel-body" >
                                    ...
                                    <table  <?php echo  "id=tablePanier".$pagnet['idPagnet']."" ; ?> class="tabPanier table"  width="100%" >
                                        ...
                                        <tbody>
                                            ...
                                            $sql8="SELECT * FROM `".$nomtableLigneTampon."` l
                                    ...
                                    <table  <?php echo  "id=tablePanier".$pagnet['idPagnet']."" ; ?> class="tabPanier table"  width="100%" >
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $sql8="SELECT * FROM `".$nomtableLigneTampon."` where idPagnet=".$pagnet['idPagnet']." ORDER BY numligne DESC";
            ...
            <?php if($_SESSION['proprietaire']==1){ ?> 
                ...
                <?php	$idmax=mysql_result($resA,0); ?>
                    ...
                    $sql="SELECT * FROM `".$nomtableLigneTampon."` l
                                ...
                                <div class="panel-heading">
                                    ...
                                    <h4 data-toggle="collapse" data-parent="#accordion" <?php echo  "href=#pagnet".$pagnet['idPagnet']."" ; ?>  class="panel-title expand">
                                        ...
                                        <a href="#"> Panier <?php echo $n; ?>
                                            ...
                                            <?php   $sqlT="SELECT totalp FROM `".$nomtablePagnetTampon."` where idPagnet=".$pagnet['idPagnet']." ";

                                                    $resT=mysql_query($sqlT) or die ("select stock impossible =>".mysql_error());

                                                    $TotalT = mysql_fetch_array($resT);

                                                    $sqlP="SELECT apayerPagnet FROM `".$nomtablePagnetTampon."` where idPagnet=".$pagnet['idPagnet']." ";
                                            ...
                                            <?php if($_SESSION['Pays']=='Canada'){  
                                                ...
                                                $sqlTP="SELECT apayerPagnetTvaP FROM `".$nomtablePagnetTampon."` where idPagnet=".$pagnet['idPagnet']." ";

                                                $resTP=mysql_query($sqlTP) or die ("select stock impossible =>".mysql_error());

                                                $TotalTvaP = mysql_fetch_array($resTP);

                                                $sqlTR="SELECT apayerPagnetTvaR FROM `".$nomtablePagnetTampon."` where idPagnet=".$pagnet['idPagnet']." ";
