...
// require('../declarationVariables.php');
   ...
   if($operation == 0){
      ...
      $sql="SELECT * FROM `".$nomtableLigneTampon."` where numligne=".$numligne."";
      ...
      if(($unitevente!='Article')&&($unitevente!='article')){
        ...
        if($quantiteCourant >= 0){
          ...
          $sql1="update `".$nomtableLigneTampon."` set unitevente='".$unitevente."',prixunitevente=".$prixunitevente.",prixtotal=".$prixTotal." where numligne='".$numligne."'";
      ...
      if(($ligne['unitevente']!="Article")&&($ligne['unitevente']!="article")){
        ...
        if($quantiteCourant >= 0){
          ...
          $sql1="update `".$nomtableLigneTampon."` set quantite=".$quantite.",prixtotal=".$prixTotal." where numligne='".$numligne."'";
          $res1=@mysql_query($sql1)or die ("");/**/
        }
        $sql2="SELECT SUM(prixtotal) FROM `".$nomtableLigneTampon."` where idPagnet=".$idPagnet." ";
    ...
    if($_SESSION['Pays']=='Canada' && $designation['tva']==1){ 
      ...
      $sql1="update `".$nomtableLigneTampon."` set prixunitevente=".$prix.",prixtotal=".$prixTotal.",prixtotalTvaP=".$prixTotalTvaP.",prixtotalTvaR=".$prixTotalTvaR." where numligne='".$numligne."'";
      $res1=@mysql_query($sql1)or die ("modification impossible");/**/
    }
    else{
      $sql1="update `".$nomtableLigneTampon."` set prixunitevente=".$prix.",prixtotal=".$prixTotal." where numligne='".$numligne."'";
      $res1=@mysql_query($sql1)or die ("modification impossible");/**/
    }
    ...
    if($_SESSION['Pays']=='Canada'){ 
      $sql3="SELECT SUM(prixtotalTvaP) FROM `".$nomtableLigneTampon."` where idPagnet=".$idPagnet." ";
      $res3 = mysql_query($sql3) or die ("persoonel requête 2".mysql_error());
      $TotalTvaP = mysql_fetch_array($res3) ;
  
      $sql4="SELECT SUM(prixtotalTvaR) FROM `".$nomtableLigneTampon."` where idPagnet=".$idPagnet." ";
    ...
    if($_SESSION['Pays']=='Canada'){ 
      $sql2="SELECT SUM(prixtotalTvaP) FROM `".$nomtableLigneTampon."` where idPagnet=".$idPagnet." ";
      $res2 = mysql_query($sql2) or die ("persoonel requête 2".mysql_error());
      $TotalTvaP = mysql_fetch_array($res2) ;

      $sql3="SELECT SUM(prixtotalTvaR) FROM `".$nomtableLigneTampon."` where idPagnet=".$idPagnet." ";
      $res3 = mysql_query($sql3) or die ("persoonel requête 2".mysql_error());
    ...
    $sqlQte="SELECT * FROM `".$nomtableLigneTampon."` where idPagnet='".$idPagnet."' and numligne!='".$numligne."' and idStock='".$ligne['idStock']."' ";
    ...
    $prixTotal=$prix*$ligne['quantite'];
    $sql1="update `".$nomtableLigneTampon."` set prixPublic=".$prix.",prixtotal=".$prixTotal." where numligne='".$numligne."'";
    $res1=@mysql_query($sql1)or die ("modification impossible");/**/
    ...
    $sqlQte="SELECT * FROM `".$nomtableLigneTampon."` where idPagnet='".$idPagnet."' and numligne!='".$numligne."' and idDesignation='".$ligne['idDesignation']."' ";
    $resQte = mysql_query($sqlQte) or die ("persoonel requête 2".mysql_error());
    $produitQte = mysql_fetch_assoc($resQte) ;
    ...
    if(($ligne['unitevente']!="Article")&&($ligne['unitevente']!="article")){
      ...
      //if($quantiteCourant >= 0){
        ...
        if($_SESSION['Pays']=='Canada'  && $designation['tva']==1){ 
          $prixTotalTvaP=$prixTotal*$_SESSION['tvaP'];
          $prixTotalTvaR=$prixTotal*$_SESSION['tvaR'];
          $sql1="update `".$nomtableLigneTampon."` set quantite=".$quantite.",prixtotal=".$prixTotal.",prixtotalTvaP=".$prixTotalTvaP.",prixtotalTvaR=".$prixTotalTvaR." where numligne='".$numligne."'";
          $res1=@mysql_query($sql1)or die ("");/**/
        }
        else{
          $sql1="update `".$nomtableLigneTampon."` set quantite=".$quantite.",prixtotal=".$prixTotal." where numligne='".$numligne."'";
    ...
    if(($unitevente!='Article')&&($unitevente!='article')){
      ...
      //if($quantiteCourant >= 0){
        ...
        if($_SESSION['Pays']=='Canada' && $designation['tva']==1){ 
          $prixTotalTvaP=$prixTotal*$_SESSION['tvaP'];
          $prixTotalTvaR=$prixTotal*$_SESSION['tvaR'];
          $sql1="update `".$nomtableLigneTampon."` set unitevente='".$unitevente."',prixunitevente=".$prixunitevente.",prixtotal=".$prixTotal.",prixtotalTvaP=".$prixTotalTvaP.",prixtotalTvaR=".$prixTotalTvaR." where numligne='".$numligne."'";
          $res1=@mysql_query($sql1)or die ("");
          $init='1';
        }
        else{
    ...
    $sqlP="SELECT * FROM `".$nomtablePagnetTampon."` where idPagnet=".$ligne['idPagnet']."";
    ...
    $result='0'; 
    if($ligne!=null){
      $sql1="UPDATE `".$nomtableLigneTampon."` set idEntrepot='".$idEntrepot."' where numligne='".$numligne."'";
      $res1=@mysql_query($sql1)or die ("");
      $result='1';
    }
    exit($result);
    ...
    $reqA="SELECT * from `".$nomtablePagnetTampon."` where idPagnet='".$idPagnet."' ";
    ...
    $sql1="UPDATE `".$nomtablePagnetTampon."` set totalp='".$commission."',apayerPagnet='".$commission."',verrouiller=1 where idPagnet='".$idPagnet."' ";
    $res1=@mysql_query($sql1)or die ("modification impossible");
    if($res1){ 
    ...
    $sql1="UPDATE `".$nomtableLigneTampon."` set unitevente='".$especes."' where numligne='".$numligne."'";
    $res1=@mysql_query($sql1)or die ("modification impossible");/**/
    if($res1){
      $result='1';
    }
    ...
    $sql1="UPDATE `".$nomtableLigneTampon."` set designation='".$designation."' where numligne='".$numligne."'";
    $res1=@mysql_query($sql1)or die ("modification impossible");/**/
    if($res1){
      $result='1';
    }
    ...
    if($resMP){
      ...
      $sql2="SELECT SUM(prixtotal) FROM `".$nomtableLigneTampon."` where idMutuellePagnet=".$idMutuellePagnet." ";
      $res2 = mysql_query($sql2) or die ("persoonel requête 2".mysql_error());
      $Total = mysql_fetch_array($res2) ;
    ...
    $sqlQte="SELECT * FROM `".$nomtableLigneTampon."` where idMutuellePagnet='".$idMutuellePagnet."' and numligne!='".$numligne."' and idDesignation='".$ligne['idDesignation']."' ";
    $resQte = mysql_query($sqlQte) or die ("persoonel requête 2".mysql_error());
    $produitQte = mysql_fetch_assoc($resQte) ;
    ...
    $sql3="UPDATE `".$nomtablePagnetTampon."` SET taux='".$taux."' WHERE idPagnet='".$idPagnet."' ";
    $res3=@mysql_query($sql3) or die ("mise à jour verouillage  impossible".mysql_error());
