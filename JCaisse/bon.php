...
?>
  ...
  <input id="inpt_Mouvement_dateDebut" type="hidden" value="<?= $dateDebut?>" />
  <input id="inpt_Mouvement_dateFin" type="hidden" value="<?= $dateFin?>" />
  ...
  <script type="text/javascript">
    ...
    $(function() {
        ...
        function cb(start, end) {
            ...
            //$('#listePeriodique').DataTable().ajax.reload();
           // window.location.href = "client.php?debut="+debut+"&&fin="+fin;
...
<div class="container">
              ...
              <form class="form" >
                ...
                <?php if ($_SESSION['cbm']==1) { ?>
                      <div class="form-group">
                        <label for="ajtMarqueurCL">Marqueur </label>
                        <input type="text" class="inputbasic form-control" id="ajtMarqueurCL"  />
                      </div> 
                <?php }?>
                <div class="form-group <?= ($_SESSION['depotAvoir']==1) ? 'col-md-6' : '' ; ?>">
  ...
  <ul class="nav nav-tabs">
    ...
    <?php if ($_SESSION['proprietaire']==1 && $_SESSION['idBoutique']==170) { ?>
    <li class="" id="listePeriodiqueEvent">
        <a data-toggle="tab" href="#LISTEPERIODIQUE">LISTE DES MOUVEMENTS</a>
    </li>
    <?php } ?>
  ...
  <div class="tab-content">
    ...
    <?php if ($_SESSION['proprietaire']==1 && $_SESSION['idBoutique']==170) { ?>
      <div id="LISTEPERIODIQUE" class="tab-pane fade">
        <br />
        <div class="row">
        ...
        <div class="table-responsive">
          ...
          <table id="listePeriodique" class="display dataTable" class="tableau3" width="100%" border="1">
              <thead>
                  <tr>
                      <th>Nom</th>
                      <th>Prenom</th>
