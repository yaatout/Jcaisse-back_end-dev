...
<body >
  ...
  <div class="jumbotron noImpr">
    <h2>Bon de Commande => Numero : <?php echo $bl['numeroBl']; ?> </h2>
    <div class="panel-group">
        <div class="panel" style="background:#cecbcb;">
            <div class="panel-heading" >
                <h4 class="panel-title">
                <a data-toggle="collapse" href="#collapse" id="btn_details">Montant Bon : <span id='spn_montant_Total'><?php echo number_format($bl['montantTotal'], 0, ',', ' '); ?></span> </a>
                </h4>
            </div>
        </div>
    </div>
  ...
  <script type="text/javascript" src="scripts/bonCommande.js"></script>
