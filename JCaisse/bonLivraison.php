...
$restant = $bl['montantBl'] - $bl['montantTotal'];
...
<body >
  ...
  <div class="col-sm-4 pull-left" >
    <a  class="btn btn-warning  pull-left" style="margin-top:8px;" href="javascript:history.go(-1)" > Retour </a>
  </div>

  <div class="jumbotron noImpr">
    <h2>Bon de Livraison => Numero : <?php echo $bl['numeroBl']; ?> </h2>
    <div class="panel" style="background:#cecbcb;">
        <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" href="#collapse" id="btn_details">Montant Restant : <span id='spn_montant_Restant'><?php echo number_format($restant, 0, ',', ' '); ?></span> </a>
            </h4>
        </div>
        <div id="collapse" class="panel-collapse collapse">
            <div class="panel-heading" style="margin-left:2%;">
                <h4>Montant total Stock : <span id='spn_montant_Total'><?php echo number_format($bl['montantTotal'], 0, ',', ' '); ?></span></h4>
                <h4>Montant total BL : <span id='spn_montant_Bl'><?php echo number_format($bl['montantBl'], 0, ',', ' '); ?></span></h4>
            </div>
        </div>
    </div>
  </div>
            ...
            <div class="modal-body">
                <form >
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="span_spm_Stock_UniteStock">Unite Stock : </label>
                        <span id="span_spm_Stock_UniteStock" ></span>
                    </div>
                    <div class="form-group">
                        <label for="span_spm_Stock_PrixAchat">Prix de Reviens : </label>
          ...
          <div class="modal-content">
            ...
            <form class="form" id="form_transferer_Stock" style="padding:30px 30px;" >
              <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="inpt_trsf_Stock_UniteStock">Unite Stock (US)</label>
                    <input type="text" disabled="true"  class="form-control" id="inpt_trsf_Stock_UniteStock"  />
                </div>
                <div class="form-group">
  ...
  <script type="text/javascript" src="scripts/bonLivraison.js"></script>
