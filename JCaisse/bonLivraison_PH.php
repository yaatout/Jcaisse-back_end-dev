...
<body >
            ...
            <div class="modal-body">
                <form >
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="span_spm_Stock_PrixSession">Prix de Session : </label>
                        <span id="span_spm_Stock_PrixSession" ></span>
                    </div>
                    <div class="form-group">
                        <label for="span_spm_Stock_PrixPublic">Prix de Public : </label>
  ...
  <script type="text/javascript" src="scripts/bonLivraison_PH.js"></script>
