...
// else if ($_SESSION['cbm']=="1") {


//         require('bonPclient-cargo.php');
...
if (isset($_POST['btnActualiserBon'])) {
    ...
    $dateBon = htmlspecialchars(trim($_POST['dateActualiser']));
                    ...
                    if ($pagnet['type'] == 0) {
                        ...
                        if ($restant > 0) {
                            ...
                            if ($ligne1 != null) {
                                ...
                                $reste = $restant - ($design['nbreArticleUniteStock'] * $quantite) - $existant;
                                ...
                                if (mysql_num_rows($res)) {
                                    ...
                                    if ($ligne['classe'] == 0 || $ligne['classe'] == 1) {
                                        ...
                                        $sql7 = "insert into `" . $nomtableLigne . "` (designation, idStock,idDesignation, unitevente,prixunitevente,quantite,prixtotal,idPagnet,classe)values('" . $design['designation'] . "',0,'" . $design['idDesignation'] . "','" . $design['uniteStock'] . "'," . $design['prixuniteStock'] . ",1," . $design['prixuniteStock'] . "," . $idPagnet . ",0)";
                    ...
                    if ($pagnet['type'] == 0 || $pagnet['type'] == 30) {
                                    ...
                                    if (($ligne['unitevente'] != "Article") && ($ligne['unitevente'] != "article")) {
                                        ...
                                        if ($t_stock[0] < $stock_V) {
                                            ...
                                            $sql4 = 'INSERT INTO `' . $nomtableInventaire . '` (idStock,idDesignation,quantite,nbreArticleUniteStock,quantiteStockCourant,dateInventaire,type)
                                                    ...
                                                    VALUES(0,' . $ligne['idDesignation'] . ',' . $stock_V . ',' . $designation['nbreArticleUniteStock'] . ',' . $t_stock[0] . ',"' . $dateString . '",5)';
                                        ...
                                        if ($t_stock[0] < $stock_V) {
                                            ...
                                            $sql4 = 'INSERT INTO `' . $nomtableInventaire . '` (idStock,idDesignation,quantite,nbreArticleUniteStock,quantiteStockCourant,dateInventaire,type)
                                                    ...
                                                    VALUES(0,' . $ligne['idDesignation'] . ',' . $stock_V . ',1,' . $t_stock[0] . ',"' . $dateString . '",5)';
                        ...
                        if ($_SESSION['Pays'] == 'Canada') {
                            ...
                            if ($dateEcheance != null) {
                                ...
                                $sql3 = "UPDATE `" . $nomtablePagnet . "` set verrouiller='1', numContainer='" . $numContainer . "', remise=" . $remise . ",totalp=" . $totalp . ",apayerPagnet=" . $apayerPagnet . ",apayerPagnetTvaP=" . $totalTvaP . ",apayerPagnetTvaR=" . $totalTvaR . ",dateecheance='" . $datePaiemenent . "' where idPagnet=" . $idPagnet;

                                $res3 = @mysql_query($sql3) or die("mise à jour verouillage  impossible" . mysql_error());
                            } else {

                                $sql3 = "UPDATE `" . $nomtablePagnet . "` set verrouiller='1', numContainer='" . $numContainer . "', remise=" . $remise . ",totalp=" . $totalp . ",apayerPagnet=" . $apayerPagnet . ",apayerPagnetTvaP=" . $totalTvaP . ",apayerPagnetTvaR=" . $totalTvaR . " where idPagnet=" . $idPagnet;
                            ...
                            if ($dateEcheance != null) {
                                ...
                                $sql3 = "UPDATE `" . $nomtablePagnet . "` set verrouiller='1', numContainer='" . $numContainer . "', remise=" . $remise . ",totalp=" . $totalp . ",apayerPagnet=" . $apayerPagnet . ",dateecheance='" . $datePaiemenent . "' where idPagnet=" . $idPagnet;

                                $res3 = @mysql_query($sql3) or die("mise à jour verouillage  impossible" . mysql_error());
                            } else {

                                $sql3 = "UPDATE `" . $nomtablePagnet . "` set verrouiller='1', numContainer='" . $numContainer . "', remise=" . $remise . ",totalp=" . $totalp . ",apayerPagnet=" . $apayerPagnet . " where idPagnet=" . $idPagnet;
                        ...
                        $sql19 = "SELECT SUM(apayerPagnet) FROM `" . $nomtablePagnet . "` where verrouiller='1' && idClient=" . $idClient . " && type=1 ";
...
if (isset($_POST['btnRetournerPagnet'])) {
    ...
    if ($pagnet['type'] == 0 || $pagnet['type'] == 30) {
        ...
        $sql18 = "SELECT SUM(apayerPagnet) FROM `" . $nomtablePagnet . "` where idClient=" . $idClient . " && (type=0 || type=30) ";
...
if (isset($_POST['btnEnregistrerVersement'])) {
    ...
    if ($_SESSION['cbm'] == 1) {
        ...
        $typeEmpl = @htmlspecialchars($_POST['porteurTypeVersementHide']);

        $empl = @htmlspecialchars($_POST['porteurVersement']);

        $idPorteur = @htmlspecialchars($_POST['porteurIdVersementHide']);
        ...
        $sql2 = "insert into `" . $nomtableVersement . "` (idClient,paiement,montant,dateVersement,heureVersement,idContainer,idAvion,iduser) values(" . $idClient . ",'" . $paiement . "'," . $montant . ",'" . $dateVersement . "','" . $heureString . "'," . $idContainer . "," . $idAvion . "," . $_SESSION['iduser'] . ")";
...
if (isset($_POST['btnAnnulerVersement'])) {
    ...
    $sql30 = "UPDATE `" . $nomtableClient . "` set solde=" . $solde . " where idClient=" . $idClient;

    $res30 = mysql_query($sql30) or die("update solde client impossible =>" . mysql_error());
        ...
        <div class="container">
            ...
            if (isset($_GET['debut']) && isset($_GET['fin'])) {
                ...
                $sqlC = "SELECT
                    ...
                    (SELECT p.idClient FROM `" . $nomtablePagnet . "` p where p.idClient='" . $idClient . "' AND p.verrouiller=1 AND (p.type=0 || p.type=10 || p.type=30) AND (CONCAT(CONCAT(SUBSTR(p.datepagej,7, 10),'',SUBSTR(p.datepagej,3, 4)),'',SUBSTR(p.datepagej,1, 2)) BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "')  or (p.datepagej BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "')
                ...
                $sql12 = "SELECT SUM(apayerPagnet) FROM `" . $nomtablePagnet . "` where idClient=" . $idClient . " AND verrouiller=1 AND (type=0 || type=30) AND (CONCAT(CONCAT(SUBSTR(datepagej,7, 10),'',SUBSTR(datepagej,3, 4)),'',SUBSTR(datepagej,1, 2)) BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "') or (datepagej BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "') ";
                ...
                if ($_SESSION['Pays'] == 'Canada') {
                    ...
                    $sql12P = "SELECT SUM(apayerPagnetTvaP) FROM `" . $nomtablePagnet . "` where idClient=" . $idClient . " AND verrouiller=1 AND (type=0 || type=30) AND (CONCAT(CONCAT(SUBSTR(datepagej,7, 10),'',SUBSTR(datepagej,3, 4)),'',SUBSTR(datepagej,1, 2)) BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "') or (datepagej BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "') ";

                    $res12P = mysql_query($sql12P) or die("persoonel requête 2" . mysql_error());

                    $TotalBtvaP = mysql_fetch_array($res12P);



                    $sql12R = "SELECT SUM(apayerPagnetTvaR) FROM `" . $nomtablePagnet . "` where idClient=" . $idClient . " AND verrouiller=1 AND (type=0 || type=30) AND (CONCAT(CONCAT(SUBSTR(datepagej,7, 10),'',SUBSTR(datepagej,3, 4)),'',SUBSTR(datepagej,1, 2)) BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "') or (datepagej BETWEEN '" . $dateDebut . "' AND '" . $dateFin . "') ";

                    $res12R = mysql_query($sql12R) or die("persoonel requête 2" . mysql_error());

                    $TotalBtvaR = mysql_fetch_array($res12R);
                }
                ...
                $sqlC = "SELECT
                    ...
                    (SELECT p.idClient FROM `" . $nomtablePagnet . "` p where p.idClient='" . $idClient . "' AND p.verrouiller=1 AND (p.type=0 || p.type=10 || p.type=30)
                ...
                $sqlP1 = "SELECT codePagnet
                    ...
                    (SELECT CONCAT(SUBSTR(p.datepagej,7, 4),'',SUBSTR(p.datepagej,4, 2),'',SUBSTR(p.datepagej,1, 2),'',p.heurePagnet,'+',p.idPagnet,'+1') AS codePagnet FROM `" . $nomtablePagnet . "` p where p.idClient='" . $idClient . "' AND p.verrouiller=1 AND (p.type=0 || p.type=10 || p.type=30) 
                ...
                $sql12 = "SELECT SUM(apayerPagnet) FROM `" . $nomtablePagnet . "` where idClient=" . $idClient . " AND verrouiller=1 AND (type=0 || type=30) ";
                ...
                if ($_SESSION['Pays'] == 'Canada') {
                    ...
                    $sql12P = "SELECT SUM(apayerPagnetTvaP) FROM `" . $nomtablePagnet . "` where idClient=" . $idClient . " AND verrouiller=1 AND (type=0 || type=30) ";
                    ...
                    $sql12R = "SELECT SUM(apayerPagnetTvaR) FROM `" . $nomtablePagnet . "` where idClient=" . $idClient . " AND verrouiller=1 AND (type=0 || type=30) ";
            ...
            if ($_SESSION['Pays'] == 'Canada') {
                ...
                $T_bons = $TotalB[0] + $TotalBtvaP[0] + $TotalBtvaR[0];

                $T_versement = $TotalV[0];

                $T_solde = $TotalB[0] + $TotalBtvaP[0] + $TotalBtvaR[0] - $TotalV[0];
            } else {
            ...
            $(function() {
                ...
                $('#reportrange').daterangepicker({
                    ...
                    ranges: {
                        ...
                        'Dernier Mois': [moment().subtract(1, 'month').startOf('month'), moment()
            ...
            <div class="jumbotron noImpr">
                    ...
                    <div class="panel" style="background:#cecbcb;">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">
                                ...
                                <a data-toggle="collapse" href="#collapse1">Montant à verser :
                                    <?php echo number_format(($T_solde * $_SESSION['devise']), 2, ',', ' ') . ' ' . $_SESSION['symbole']; ?>
                                </a>
                        ...
                        <div id="collapse1" class="panel-collapse collapse">
                            ...
                            <div class="panel-heading" style="margin-left:2%;">
                                ...
                                <h4>Total des Bons :
                                    <?php echo number_format(($T_bons * $_SESSION['devise']), 2, ',', ' ') . ' ' . $_SESSION['symbole']; ?>
                                </h4>

                                <h4>Total des Versements :
                                    <?php echo number_format(($T_versement * $_SESSION['devise']), 2, ',', ' ') . ' ' . $_SESSION['symbole']; ?>
                                </h4>
                ...
                <form class="form-inline pull-left noImpr" target="_blank" style="margin-left:20px;" method="post"
                    action="pdfOperationsClient.php">
            ...
            <button disabled="true" type="button" class="btn btn-success noImpr pull-right" data-toggle="modal"
                data-target="#addVer">
            ...
            <button disabled="true" type="button" class="btn btn-warning noImpr pull-right hidden-xs hidden-sm"
                style="margin-right:400px;" data-toggle="modal" data-target="#actBon">
            ...
            <button type="button" <?= ($_SESSION['depotAvoir'] == 1) ? '' : 'hidden'; ?>
                class="btn btn-primary noImpr pull-right" style="margin-right:300px;display:none;" data-toggle="modal"
                data-target="#addAvoir">

                <i class="glyphicon glyphicon-plus"></i> Ajouter Avoir

            </button>

            <button type="button" class="btn btn-warning noImpr pull-right hidden-xs hidden-sm"
                style="margin-right:150px;display:none;" data-toggle="modal" data-target="#actBon">
                        ...
                        <div class="modal-body">
                            ...
                            <form name="formulaireVersement" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="textarea" class="form-control" id="typeVersement"
                                        name="typeVersement" placeholder="Description"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" size='11' maxLength='10' value=""
                                        class="form-control dateInputControl" name="dateActualiser"
                                ...
                                <?php endif; ?>
                                <?php
                                //     var_dump($_SESSION['cbm']);
                                if ($_SESSION['cbm'] == 1) {
                                ?>
                                <!-- <div class="form-group">
                                        <label for="emplacement"> Type de porteur</label>   
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="emplacement" id="flexRadioDefault1" value="1">
                                            <label class="form-check-label" for="flexRadioDefault1" required>
                                                Container
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="emplacement" id="flexRadioDefault2" value="2" required>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                                Avion
                                            </label>
                                        </div>
                                    </div>   -->
                                <div class="form-group" id="divporteurVersement">
                                    <label for="porteurVersement">N° du porteur</label>
                                    <input type="text" name="porteurVersement" id="porteurVersement"
                                        class="form-control porteurVersement" autocomplete="off" required>
                                    <input type="hidden" id="porteurIdVersementHide" name="porteurIdVersementHide">
                                    <input type="hidden" id="porteurTypeVersementHide" name="porteurTypeVersementHide">
                                </div>
                                <?php } ?>

                                <?php if ($_SESSION['compte'] == 1) { ?>

                                <select class="form-control compte" name="compte"
                                    <?php echo  "id=compte" . $pagnet['idPagnet']; ?>>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="btnEnregistrerVersement"
                        ...
                        <div class="modal-body">
                            ...
                            <form name="formulaireAvoir" method="post" action="bonPclient.php?c=<?= $idClient ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" maxLength="100" class="form-control" id="motifAvoir"
                                        name="motifAvoir" placeholder="Motif avoir" required="" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" maxLength="10" class="form-control dateInputControl"
                                        id="dateAvoir" name="dateAvoir" placeholder="jj-mm-aaaa" required="" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="montantAvoir" name="montantAvoir"
                                        placeholder="Montant avoir" required="" autofocus>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="btnEnregistrerAvoir"
                                        class="btn btn-primary">Enregistrer</button>
                        ...
                        <div class="modal-body">
                            ...
                            <form name="formulaireVersement" method="post"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="addPanier_1" name="btnActualiserBon"
                                        class="btn btn-primary">Enregistrer</button>
            ...
            <form name="formulairePagnet" method="post">
                ...
                <button type="submit" class="btn btn-success noImpr" id="ajout_P_Bon" name="btnSavePagnetVente"
                    <?= ($client['plafond'] != null && $client['plafond'] != 0 && $client['plafond'] <= ($T_solde * $_SESSION['devise'])) ? 'disabled' : ''; ?>>
            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel <?= ($pagnet['type'] == 30) ? 'panel-info' : 'panel-primary' ?>">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 data-toggle="collapse" data-parent="#accordion"
                            <?php echo  "href=#pagnet" . $pagnet['idPagnet'] . ""; ?> class="panel-title expand">

                            <div class="right-arrow pull-right">+</div>

                            <a class="row" href="#">

                                <span class="noImpr col-md-2 col-sm-2 col-xs-12"> Panier <?php echo ': En cours...'; ?>
                                </span>

                                <span class="noImpr col-md-3 col-sm-3 col-xs-12">Heure:
                                    <?php echo $pagnet['heurePagnet']; ?></span>
                                ...
                                <span class="noImpr col-md-3 col-sm-3 col-xs-12">Sous-Total : <span
                                        <?php echo  "id=somme_TotalCN" . $pagnet['idPagnet']; ?>><?php echo number_format((($TotalT[0] - $pagnet['remise']) * $_SESSION['devise']), 2, ',', ' '); ?>
                                    </span></span>

                                <span class="noImpr col-md-3 col-sm-3 col-xs-12"> Total : <span
                                        <?php echo  "id=somme_ApayerCN" . $pagnet['idPagnet']; ?>><?php echo number_format(((($TotalT[0] + $TotalTvaP[0] + $TotalTvaR[0]) - $pagnet['remise']) * $_SESSION['devise']), 2, ',', ' '); ?>
                                    </span></span>

                                <?php } else {   ?>

                                <span class="noImpr col-md-3 col-sm-3 col-xs-12">Total panier: <span
                                        <?php echo  "id=somme_Total" . $pagnet['idPagnet']; ?>><?php echo $TotalT[0]; ?>
                                    </span></span>

                                <span class="noImpr col-md-3 col-sm-3 col-xs-12">Total à payer: <span
                                        <?php echo  "id=somme_Apayer" . $pagnet['idPagnet']; ?>><?php echo $TotalT[0]; ?>
                                    </span></span>
                    ...
                    <div <?php echo  "id=pagnet" . $pagnet['idPagnet'] . ""; ?> class="panel-collapse collapse in">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="cache_btn_Terminer row">
                                ...
                                <form class="form-inline noImpr ajouterProdForm col-md-4 col-sm-4 col-xs-12"
                                    id="ajouterProdFormB<?= $pagnet['idPagnet']; ?>" onsubmit="return false">

                                    <input type="text" class="inputbasic form-control codeBarreLigneVt" name="codeBarre"
                                        id="panier_<?= $pagnet['idPagnet']; ?>" style="width:100%;" autofocus=""
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 content2">
                                    ...
                                    <form class="form-inline noImpr" id="factForm" method="post">
                                        ...
                                        <input type="number" step="0.1"
                                            <?php echo "id=val_remise" . $pagnet['idPagnet']; ?> name="remise"
                                            onkeyup="modif_Remise(this.value, <?php echo  $pagnet['idPagnet']; ?>)"
                                            class="remise form-control col-md-2 col-sm-2 col-xs-3"
                                            placeholder="Remise....">

                                        <?php if (@$_SESSION['echeanceClient'] == 1) : ?>

                                        <input type="date" name="dateEcheance"
                                            class="avanceInput form-control col-md-2 col-sm-2 col-xs-3">

                                        <?php endif; ?>


                                        <?php if ($_SESSION['cbm'] == 1) : ?>

                                        <input type="text" <?php echo "id=numContainer" . $pagnet['idPagnet']; ?>
                                            name="numContainer"
                                            class="versement form-control col-md-2 col-sm-2 col-xs-3"
                                            placeholder="Numéro container....">

                                        <?php endif; ?>

                                        <?php if ($_SESSION['compte'] == 1) : ?>

                                        <input type="number" class="avanceInput form-control col-md-2 col-sm-2 col-xs-3"
                                            data-idPanier="<?= $pagnet['idPagnet']; ?>" name="avanceInput"
                                            id="avanceInput<?= $pagnet['idPagnet']; ?>" autocomplete="off"
                                            placeholder="Avance" />

                                        <select
                                            class="compteAvance <?= $pagnet['idPagnet']; ?> form-control col-md-2 col-sm-2 col-xs-3"
                                            data-idPanier="<?= $pagnet['idPagnet']; ?>" name="compteAvance"
                                            <?php echo  "id=compteAvance" . $pagnet['idPagnet']; ?>>
                                        ...
                                        <input type="hidden" name="totalp"
                                            <?php echo  "id=totalp" . $pagnet['idPagnet'] . ""; ?>
                                            value="<?php echo $pagnet['totalp']; ?>">

                                        <!-- <div class="btnAction col-md-1 col-xs-12"> -->

                                        <button type="submit" style="" name="btnImprimerFacture"
                                            <?php echo  "id=btnImprimerFacture" . $pagnet['idPagnet'] . ""; ?>
                                            class="btn btn-success btn_Termine_Panier terminer"
                                            data-toggle="modal"><span class="glyphicon glyphicon-ok"></span></button>

                                        <button tabindex="1" type="button" class="btn btn-danger annuler"
                                            data-toggle="modal"
                                            <?php echo  "data-target=#msg_ann_pagnet" . $pagnet['idPagnet']; ?>>
                                    ...
                                    <div class="modal fade" <?php echo  "id=msg_ann_pagnet" . $pagnet['idPagnet']; ?>
                                        role="dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form class="form-inline noImpr" id="factForm" method="post">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="btnAnnulerPagnet"
                            ...
                            <table <?php echo  "id=tablePanier" . $pagnet['idPagnet'] . ""; ?> class="tabPanier table"
                                width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="quantite form-control"
                                                <?php echo  "id=ligne" . $ligne['numligne'] . ""; ?>
                                                onkeyup="modif_Quantite(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>,<?php echo  $designation['nbreArticleUniteStock']; ?>,<?php echo  $stock['quantiteStockCourant']; ?>)"
                                                style="width: 30%" size="3" type="number"
                                                <?php echo  "id=quantite" . $ligne['numligne'] . ""; ?>
                                            ...
                                            <input class="quantite form-control"
                                                <?php echo  "id=ligne" . $ligne['numligne'] . ""; ?>
                                                onkeyup="modif_Quantite(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>,<?php echo  '1'; ?>,<?php echo  $stock['quantiteStockCourant']; ?>)"
                                                style="width: 30%" size="3" type="number"
                                                <?php echo  "id=quantite" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['quantite'] . ""; ?>>
                                            ...
                                            <input class="quantite form-control"
                                                <?php echo  "id=ligne" . $ligne['numligne'] . ""; ?>
                                                onkeyup="modif_QuantiteP(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>,<?php echo  $designation['nbreArticleUniteStock']; ?>)"
                                                style="width: 30%" size="3" type="number"
                                                <?php echo  "id=quantite" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['quantite'] . ""; ?>>
                                            ...
                                            <input class="quantite form-control"
                                                <?php echo  "id=ligne" . $ligne['numligne'] . ""; ?>
                                                onkeyup="modif_QuantiteP(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>,<?php echo  '1'; ?>)"
                                                style="width: 30%" size="3" type="number"
                                                <?php echo  "id=quantite" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['quantite'] . ""; ?>>
                                            ...
                                            <input class="quantite form-control"
                                                <?php echo  "id=ligne" . $ligne['numligne'] . ""; ?>
                                                onkeyup="modif_QuantiteSD(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>)"
                                                style="width: 30%" size="3" type="number"
                                                <?php echo  "id=quantite" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['quantite'] . ""; ?>>
                                        ...
                                        <td class="unitevente ">
                                            ...
                                            <select name="uniteVente"
                                                <?php echo  "id=uniteVente" . $ligne['numligne'] . ""; ?>
                                            ...
                                            <select name="uniteVente"
                                                ...
                                                <option
                                                    <?php echo  "value=Article§" . $ligne['numligne'] . '§' . $pagnet['idPagnet'] . " "; ?>>
                                                    Article</option>
                                        ...
                                        <td>
                                            ...
                                            <input <?php echo  "id=prixUniteStock" . $ligne['numligne'] . ""; ?>
                                                class="prixunitevente form-control" style="width: 70%" type="number"
                                                <?php echo  "id=prixunitevente" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['prixunitevente'] . ""; ?>
                                                onkeyup="modif_Prix(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>)">

                                            <?php } else if ($ligne['classe'] == 5 || $ligne['classe'] == 7) { ?>
                                            ...
                                            <input disabled="true"
                                                <?php echo  "id=prixUniteStock" . $ligne['numligne'] . ""; ?>
                                                class="prixunitevente form-control" style="width: 70%" type="number"
                                                <?php echo  "id=prixunitevente" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['prixunitevente'] . ""; ?>
                                                onkeyup="modif_Prix(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>)">
                                        ...
                                        <td>
                                            ...
                                            <button type="submit"
                                                class="btn btn-warning pull-right btn_Retourner_Produit"
                                                data-toggle="modal"
                                                <?php echo  "data-target=#msg_rtrnAvant_ligne" . $ligne['numligne']; ?>>
                                            ...
                                            <div class="modal fade"
                                                <?php echo  "id=msg_rtrnAvant_ligne" . $ligne['numligne']; ?>
                                                role="dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="form-inline noImpr" id="factForm" method="post">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" name="btnRetourAvant"
                                                                    class="btn btn-success">Confirmer</button>
                            ...
                            <div class="cache_btn_Terminer row">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 content2">
                                    ...
                                    <form class="form-inline noImpr" id="factForm" method="post">
                                        ...
                                        <!-- <input type="date" name="dateEcheance" class="remise form-control col-md-2 col-sm-2 col-xs-3">                                                  -->
                                        ...
                                        <button type="submit" style="" name="btnImprimerProforma"
                                            <?php echo  "id=btnImprimerFacture" . $pagnet['idPagnet'] . ""; ?>
                                            class="btn btn-success btn_Termine_Panier terminer"
                                            data-toggle="modal"><span class="glyphicon glyphicon-ok"></span></button>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="quantite form-control"
                                                <?php echo  "id=ligne" . $ligne['numligne'] . ""; ?>
                                                onkeyup="modif_QuantiteRP(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>,<?php echo  $designation['nbreArticleUniteStock']; ?>,<?php echo  $stock['quantiteStockinitial']; ?>)"
                                                style="width: 30%" size="3" type="number"
                                                <?php echo  "id=quantite" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['quantite'] . ""; ?>>
                                            ...
                                            <input class="quantite form-control"
                                                <?php echo  "id=ligne" . $ligne['numligne'] . ""; ?>
                                                onkeyup="modif_QuantiteRP(this.value,<?php echo  $ligne['numligne']; ?>,<?php echo  $pagnet['idPagnet']; ?>,<?php echo  '1'; ?>,<?php echo  $stock['quantiteStockinitial']; ?>)"
                                                style="width: 30%" size="3" type="number"
                                                <?php echo  "id=quantite" . $ligne['numligne'] . ""; ?>
                                                <?php echo  "value=" . $ligne['quantite'] . ""; ?>>
                                        ...
                                        <td class="unitevente ">
                                            ...
                                            <select name="uniteVente" class="form-control"
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" class="btn btn-warning pull-right" data-toggle="modal"
                                                <?php echo  "data-target=#msg_rtrnAvant_ligne" . $ligne['numligne']; ?>>
                ...
                <?php
                    ...
                    if ($bon[2] == 1) {
                        ...
                        if ($pagnet != null) {
                            ...
                            if (($ligne['classe'] == 0 || $ligne['classe'] == 1 || $ligne['classe'] == 2) && ($pagnet['type'] == 0 || $pagnet['type'] == 30)) { ?>
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 data-toggle="collapse" data-parent="#accordion"
                            ...
                            <a href="#"> <?php echo $n; ?> Bon
                                ...
                                <span class="spanTotal noImpr">Sous-Total:
                                    <span><?php echo number_format(($TotalP[0] * $_SESSION['devise']), 2, ',', ' '); ?>
                                    </span></span>

                                <span class="spanTotal noImpr">Total :
                                    <span><?php echo number_format((($TotalP[0] + $TotalTvaP[0] + $TotalTvaR[0]) * $_SESSION['devise']), 2, ',', ' '); ?>
                                    </span></span>

                                <?php } else {   ?>

                                <span class="spanTotal noImpr">Total panier: <span
                                        <?php echo  "id=somme_Total" . $pagnet['idPagnet']; ?>><?php echo $TotalT[0]; ?>
                                    </span></span>

                                <span class="spanTotal noImpr">Total à payer: <span
                                        <?php echo  "id=somme_Apayer" . $pagnet['idPagnet']; ?>><?php echo $TotalP[0]; ?>
                                    </span></span>
                    ...
                    <div <?php echo  "id=pagnet" . $pagnet['idPagnet'] . ""; ?> <?php
                        ...
                        <div class="panel-body">
                            ...
                            <button type="submit" class="btn btn-danger pull-right" data-toggle="modal"
                                <?php echo  "data-target=#msg_rtrn_pagnet" . $pagnet['idPagnet']; ?>>
                            ...
                            <div class="modal fade" <?php echo  "id=msg_rtrn_pagnet" . $pagnet['idPagnet']; ?>
                                role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="form-inline noImpr" id="factForm" method="post">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="btnRetournerPagnet"
                                                    class="btn btn-success">Confirmer</button>
                            ...
                            <button class="btn btn-warning  pull-right" style="margin-right:20px;"
                                onclick="document.getElementById('<?php echo 'facture' . $pagnet['idPagnet']; ?>').submit();">
                            ...
                            <form class="form-inline pull-right noImpr"
                                <?php echo  "id=facture" . $pagnet['idPagnet']; ?> target="_blank"
                                style="margin-right:20px;" method="post" action="pdfFacture.php">
                            ...
                            <button class="btn btn-info  pull-right" style="margin-right:20px;"
                                onclick="document.getElementById('<?php echo 'ticket' . $pagnet['idPagnet']; ?>').submit();">
                            ...
                            <form class="form-inline pull-right noImpr"
                                <?php echo  "id=ticket" . $pagnet['idPagnet']; ?> target="_blank"
                                style="margin-right:20px;" method="post" action="barcodeFacture.php">
                            ...
                            <button type="button" style="margin-right:20px;"
                                class="btn btn-primary pull-right modeEditionBtn" id="edit-<?= $pagnet['idPagnet']; ?>">

                                <span class="glyphicon glyphicon-edit"></span> Editer

                            </button>

                            <div class="modal fade" <?php echo  "id=msg_edit_pagnet" . $pagnet['idPagnet']; ?>
                                role="dialog">
                            ...
                            <div id="factForm">
                                ...
                                <input type="text" placeholder="Remise"
                                    class="client form-control col-md-2 col-sm-2 col-xs-3 alert alert-warning"
                                    id="remiseCargo<?= $pagnet['idPagnet']; ?>" />
                                <button type="button" id="remiseCargoBtn<?= $pagnet['idPagnet']; ?>"
                                    onClick="remiseCargo(<?= $pagnet['idPagnet']; ?>)"
                                    class="btn btn-success btn-sm glyphicon glyphicon-ok"> </button>
                                <div width="100%">
                                    <br><br>
                                    <input type="text" placeholder="Changer la quantité"
                                        class="client form-control col-md-2 col-sm-2 col-xs-3 alert alert-info"
                                        id="changeQtyCargo<?= $pagnet['idPagnet']; ?>" />
                                    <button type="button" id="changeQtyCargoBtn<?= $pagnet['idPagnet']; ?>"
                                        onClick="changeQtyCargo(<?= $pagnet['idPagnet']; ?>)"
                                        class="btn btn-info btn-sm glyphicon glyphicon-ok"> </button>
                                </div>
                                <?php } ?>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" class="btn btn-danger pull-right" data-toggle="modal"
                                                <?php echo  "data-target=#msg_rtrnApres_ligne" . $ligne['numligne']; ?>>
                                            ...
                                            <div class="modal fade"
                                                <?php echo  "id=msg_rtrnApres_ligne" . $ligne['numligne']; ?>
                                                role="dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="form-inline noImpr" id="factForm" method="post">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" name="btnRetourApres"
                                                                    class="btn btn-success">Confirmer</button>
                            ...
                            <div>
                                ...
                                <div id="numContainerdetail<?= $pagnet['idPagnet']; ?>">

                                    <?php if ($_SESSION['cbm'] == 1 && $pagnet['numContainer'] != "" && $pagnet['numContainer'] != 0) : ?>

                                    <?php

                                                            $sql3 = "SELECT * FROM `" . $nomtableContainer . "` where idContainer='" . $pagnet['numContainer'] . "'";

                                                            $res3 = mysql_query($sql3) or die("persoonel requête 3" . mysql_error());

                                                            $container = mysql_fetch_assoc($res3);

                                                            // echo 'Container : '. $pagnet['numContainer'].'<br/>';
                                                            echo 'Container : ' . $container['numContainer'] . '<br/>';
                                                            ?>

                                    <?php endif; ?><?php if ($_SESSION['cbm'] == 1 && $pagnet['idAvion'] != "" && $pagnet['idAvion'] != 0) : ?>

                                    <?php

                                                                                $sql3 = "SELECT * FROM `" . $nomtableAvion . "` where idAVion='" . $pagnet['idAvion'] . "'";
                                ...
                                <div id="nbPcsContainerdetail<?= $pagnet['idPagnet']; ?>">

                                    <?php if ($_SESSION['cbm'] == 1 && $pagnet['nbPcsInContainer'] != "" && $pagnet['nbPcsInContainer'] != null && $pagnet['nbPcsInContainer'] > 0) : ?>

                                    <?php echo 'Nombre de pièces : ' . $pagnet['nbPcsInContainer'] . '<br/>'; ?>

                                    <?php endif; ?>


                                    <?php if ($_SESSION['cbm'] == 1 && $pagnet['codeBarrePcsInContainer'] != '') { ?>
                                    <!--  target="_blank" -->
                                    <form action="barcodeCBM.php" target="_blank" method="post">
                                        <input type="hidden" name="idPagnetCbm" value="<?= $pagnet['idPagnet']; ?>">
                                        <input type="hidden" name="codeBarrePcsInContainer"
                                            value="<?= $pagnet['codeBarrePcsInContainer']; ?>">
                                        <input type="hidden" name="nbPcsInContainer"
                                            value="<?= $pagnet['nbPcsInContainer']; ?>">
                                        <input type="hidden" name="numContainer"
                                            value="<?= $pagnet['numContainer']; ?>">
                                        <input type="hidden" name="idClient" value="<?= $pagnet['idClient']; ?>">
                                        <button type="submit" class="btn btn-secondary  pull-left"
                                            style="margin-right:20px;">

                                            <span class="glyphicon glyphicon-print"> </span> Imprimer Code barre pièces
                ...
                <?php
                            ...
                            if ($ligne['classe'] == 0  && $pagnet['type'] == 1) { ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" disabled="true" class="btn btn-danger pull-right"
                                                data-toggle="modal"
                                                <?php echo  "data-target=#msg_rtrnApres_ligne" . $ligne['numligne']; ?>>
                ...
                <?php
                            ...
                            if (($ligne['classe'] == 6 || $ligne['classe'] == 9) && $pagnet['type'] == 0) { ?>
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 data-toggle="collapse" data-parent="#accordion"
                            ...
                            <a href="#"><?= ($ligne['prixtotal'] < 0) ? "Avoir" : "Bon"; ?>
                                ...
                                <span class="spanTotal noImpr">Total panier: <span
                                        <?php echo  "id=somme_Total" . $pagnet['idPagnet']; ?>><?php echo abs($TotalT[0]); ?>
                                    </span></span>

                                <span class="spanTotal noImpr">Total à payer: <span
                                        <?php echo  "id=somme_Apayer" . $pagnet['idPagnet']; ?>><?php echo abs($TotalP[0]); ?>
                                    </span></span>
                    ...
                    <div <?php echo  "id=pagnet" . $pagnet['idPagnet'] . ""; ?> <?php
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <input class="numligne" type="hidden" name="numligne"
                                            <?php echo  "id=numligne" . $pagnet['idPagnet'] . ""; ?><?php echo  "value=" . $ligne['numligne'] . ""; ?>>
                                        ...
                                        <td>
                                            ...
                                            <?php echo  abs($ligne['prixunitevente']); ?> <span
                                                class="factureFois"></span>
                            ...
                            <div class="col-sm-1" tyle="text-align:right;">
                                ...
                                <?php if ($format == 'pdf') { ?>
                                <img class="btn btn-xs" src="images/pdf.png" align="middle" alt="apperçu" width="50"
                                    height="45" data-toggle="modal"
                                    <?php echo "data-target=#imageNvBon" . $pagnet['idPagnet']; ?>
                                    onclick="imageUpBon(<?php echo $pagnet['idPagnet']; ?>,<?php echo $pagnet['image']; ?>)" />
                                <?php } else {
                                                    ?>
                                <img class="btn btn-xs" src="images/img.png" align="middle" alt="apperçu" width="50"
                                    height="45" data-toggle="modal"
                                    <?php echo "data-target=#imageNvBon" . $pagnet['idPagnet']; ?>
                                    onclick="imageUpBon(<?php echo $pagnet['idPagnet']; ?>,<?php echo $pagnet['image']; ?>)" />
                                <?php } ?>
                                <?php } else {
                                                ?>
                                <img class="btn btn-xs" src="images/upload.png" align="middle" alt="apperçu" width="45"
                                    height="40" data-toggle="modal"
                                    <?php echo "data-target=#imageNvBon" . $pagnet['idPagnet']; ?>
                                    onclick="imageUpBon(<?php echo $pagnet['idPagnet']; ?>,<?php echo $pagnet['image']; ?>)" />
                                <?php } ?>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="padding:35px 50px;">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title"><span class="glyphicon glyphicon-picture"></span> Bon :
                            ...
                            <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" style="text-align:center;">
                                        <?php
                                                        if ($pagnet['image'] != null && $pagnet['image'] != ' ') {
                                                            $format = substr($pagnet['image'], -3);
                                                        ?>
                                        <input type="file" name="file" value="<?php echo  $pagnet['image']; ?>"
                                            accept="image/*" id="input_file_Bon<?php echo  $pagnet['idPagnet']; ?>"
                                            onchange="showPreviewBon(event,<?php echo  $pagnet['idPagnet']; ?>);" /><br />
                                        <?php if ($format == 'pdf') { ?>
                                        <iframe id="output_pdf_Bon<?php echo  $pagnet['idPagnet']; ?>"
                                            src="./PiecesJointes/<?php echo  $pagnet['image']; ?>" width="100%"
                                            height="500px"></iframe>
                                        <img style="display:none;" width="500px" height="500px"
                                            id="output_image_Bon<?php echo  $pagnet['idPagnet'];  ?>" />
                                        <?php } else { ?>
                                        <img src="./PiecesJointes/<?php echo  $pagnet['image']; ?>" width="500px"
                                            height="500px" id="output_image_Bon<?php echo  $pagnet['idPagnet']; ?>" />
                                        <iframe id="output_pdf_Bon<?php echo  $pagnet['idPagnet'];  ?>"
                                            style="display:none;" width="100%" height="500px"></iframe>
                                        <?php } ?>
                                        <?php
                                                        } else { ?>
                                        <input type="file" name="file" accept="image/*"
                                            id="input_file_Bon<?php echo  $pagnet['idPagnet']; ?>" id="cover_image"
                                            onchange="showPreviewBon(event,<?php echo  $pagnet['idPagnet']; ?>);" /><br />
                                        <img style="display:none;" width="500px" height="500px"
                                            id="output_image_Bon<?php echo  $pagnet['idPagnet']; ?>" />
                                        <iframe id="output_pdf_Bon<?php echo  $pagnet['idPagnet'];  ?>"
                                ...
                                <div class="modal-footer">
                                    <button type="submit" style="display:none" class="btn btn-success pull-left"
                                        name="btnUploadImgBon" id="btn_upload_Bon<?php echo  $pagnet['idPagnet']; ?>">
                ...
                <div class="panel panel-default">
                    ...
                    <div <?php echo  "id=pagnet" . $pagnet['idPagnet'] . ""; ?> <?php
                        ...
                        <div class="panel-body">
                            ...
                            <button type="submit" class="btn btn-warning pull-right" style="margin-right:20px;"
                                data-toggle="modal"
                                <?php echo  "data-target=#msg_factEntreprise_pagnet" . $pagnet['idPagnet']; ?>>
                            ...
                            <button type="submit" class="btn btn-warning pull-right" style="margin-right:20px;"
                                data-toggle="modal"
                                <?php echo  "data-target=#msg_factClient_pagnet" . $pagnet['idPagnet']; ?>>
                            ...
                            <div class="modal fade" <?php echo  "id=msg_factClient_pagnet" . $pagnet['idPagnet']; ?>
                                role="dialog">
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="form-inline noImpr" method="post" action="pdfFactureProforma.php"
                                            target="_blank">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="btnFacture"
                                                    class="btn btn-success">Confirmer</button>
                            ...
                            <div class="modal fade" <?php echo  "id=msg_factEntreprise_pagnet" . $pagnet['idPagnet']; ?>
                                role="dialog">
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class=" noImpr" method="post" action="pdfFactureProformaEntreprise.php"
                                            target="_blank">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="entreprise"
                                                        required="" placeholder="Le nom de l'Entreprise ici...">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button disabled="true" type="submit" class="btn btn-danger pull-right"
                                                data-toggle="modal"
                                                <?php echo  "data-target=#msg_rtrnApres_ligne" . $ligne['numligne']; ?>>
                ...
                <div style="padding-top : 2px;" class="panel panel-warning">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 data-toggle="collapse" data-parent="#accordion"
                            <?php echo  "href=#versement" . $versement['idVersement'] . ""; ?>
                            class="panel-title expand">

                            <div class="right-arrow pull-right">+</div>

                            <a href="#"> <?php echo $n; ?> Versement
                                ...
                                <span class="spanDate noImpr">Montant:
                                    <?php echo ($versement['montant'] * $_SESSION['devise']) . ' ' . $_SESSION['symbole']; ?></span>

                                <span class="spanDate noImpr"> Facture :
                                    #<?php echo $versement['idVersement']; ?></span>
                    ...
                    <div class="panel-collapse collapse "
                        <?php echo  "id=versement" . $versement['idVersement'] . ""; ?>>

                        <div class="panel-body">

                            <!-- <?php if ($_SESSION['proprietaire'] == 1) { ?> -->
                            <div id="divChangePorteur">
                                <input type="text" placeholder="Changer le container/vol"
                                    class="client porteurInput form-control col-md-2 col-sm-2 col-xs-3 alert alert-info"
                                    onkeyup="changerPorteur(<?= $versement['idVersement'] ?>)"
                                    id="porteurInput<?= $versement['idVersement'] ?>" autocomplete="off" />&ensp;<span
                                    class="btn btn-success btn-sm glyphicon glyphicon-ok"
                                    id="validerPorteur<?= $versement['idVersement']; ?>" style="display:none"></span>
                            </div>
                            ...
                            <button type="submit" class="btn btn-danger pull-right" data-toggle="modal"
                                <?php echo  "data-target=#msg_anl_versement" . $versement['idVersement']; ?>>
                            ...
                            <div class="modal fade" <?php echo  "id=msg_anl_versement" . $versement['idVersement']; ?>
                                role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="form-inline noImpr" id="factForm" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><?php echo "Voulez-vous annuler le versement numéro <b>" . $n . "<b>"; ?>
                                                </p>

                                                <input type="hidden" name="idVersement" id="idVersement"
                                                    <?php echo  "value=" . $versement['idVersement'] . ""; ?>>

                                                <input type="hidden" name="montant" id="montant"
                                                    <?php echo  "value=" . $versement['montant'] . ""; ?>>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="btnAnnulerVersement"
                                                    class="btn btn-success">Confirmer</button>
                            ...
                            <form class="form-inline pull-right noImpr" style="margin-right:20px;" method="post">
                                ...
                                <button disabled="true" type="submit" class="btn btn-warning pull-right"
                                    data-toggle="modal" name="barcodeFactureV">
                            ...
                            <form class="form-inline pull-right noImpr" style="margin-right:20px;" method="post"
                                action="barcodeFacture.php" target="_blank">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="ancienV<?php echo  $versement['idVersement']; ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php if ($format == 'pdf') { ?>
                                                <img class="btn btn-xs" src="images/pdf.png" align="middle"
                                                    alt="apperçu" width="50" height="45" data-toggle="modal"
                                                    <?php echo "data-target=#imageNvVersement" . $versement['idVersement']; ?>
                                                    onclick="imageUpVersement(<?php echo $versement['idVersement']; ?>,<?php echo $versement['image']; ?>)" />
                                                <?php } else {
                                                                ?>
                                                <img class="btn btn-xs" src="images/img.png" align="middle"
                                                    alt="apperçu" width="50" height="45" data-toggle="modal"
                                                    <?php echo "data-target=#imageNvVersement" . $versement['idVersement']; ?>
                                                    onclick="imageUpVersement(<?php echo $versement['idVersement']; ?>,<?php echo $versement['image']; ?>)" />
                                                <?php } ?>
                                                <?php } else {
                                                            ?>
                                                <img class="btn btn-xs" src="images/upload.png" align="middle"
                                                    alt="apperçu" width="45" height="40" data-toggle="modal"
                                                    <?php echo "data-target=#imageNvVersement" . $versement['idVersement']; ?>
                                                    onclick="imageUpVersement(<?php echo $versement['idVersement']; ?>,<?php echo $versement['image']; ?>)" />
                                                <?php } ?>
                                            </td>
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-warning pull-right"
                                                    onclick="modifierVersement(<?php echo $versement['idVersement']; ?>)">
                                        ...
                                        <tr style="display:none" id="nouveauV<?php echo  $versement['idVersement']; ?>">
                                            ...
                                            <form class="form-inline noImpr" method="post">
                                                ...
                                                <td><textarea type="textarea" class="form-control" name="description"
                                                        placeholder="Description"><?php echo $versement['paiement']; ?></textarea>
                                                </td>

                                                <td><input type="number" class="form-control"
                                                        value="<?php echo $versement['montant']; ?>" name="montant"
                                                        placeholder="Montant" required=""></td>

                                                <td>

                                                    <input type="text" size='11' maxLength='10'
                                                        value="<?php echo $versement['dateVersement']; ?>"
                                                        class="form-control dateInputControl" name="dateVersement"
                                                        placeholder="jj-mm-aaaa" required="">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" name="idVersement"
                                                        <?php echo  "value=" . $versement['idVersement'] . ""; ?>>

                                                    <button type="submit" class="btn btn-success pull-right"
                                                        name="btnModifierVersement">
                ...
                <div class="modal fade" <?php echo  "id=imageNvVersement" . $versement['idVersement']; ?> role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="padding:35px 50px;">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title"><span class="glyphicon glyphicon-picture"></span> Versement :
                                    <b>#<?php echo  $versement['idVersement']; ?></b>
                                </h4>
                            </div>
                            <form method="post" enctype="multipart/form-data">
                                <div class="modal-body" style="padding:40px 50px;">
                                    ...
                                    <div class="form-group" style="text-align:center;">
                                        <?php
                                                    if ($versement['image'] != null && $versement['image'] != ' ') {
                                                        $format = substr($versement['image'], -3);
                                                    ?>
                                        <input type="file" name="file" value="<?php echo  $versement['image']; ?>"
                                            accept="image/*"
                                            id="input_file_Versement<?php echo  $versement['idVersement']; ?>"
                                            onchange="showPreviewVersement(event,<?php echo  $versement['idVersement']; ?>);" /><br />
                                        <?php if ($format == 'pdf') { ?>
                                        <iframe id="output_pdf_Versement<?php echo  $versement['idVersement']; ?>"
                                            src="./PiecesJointes/<?php echo  $versement['image']; ?>" width="100%"
                                            height="500px"></iframe>
                                        <img style="display:none;" width="500px" height="500px"
                                            id="output_image_Versement<?php echo  $versement['idVersement'];  ?>" />
                                        <?php } else { ?>
                                        <img src="./PiecesJointes/<?php echo  $versement['image']; ?>" width="500px"
                                            height="500px"
                                            id="output_image_Versement<?php echo  $versement['idVersement']; ?>" />
                                        <iframe id="output_pdf_Versement<?php echo  $versement['idVersement'];  ?>"
                                            style="display:none;" width="100%" height="500px"></iframe>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" style="display:none" class="btn btn-success pull-left"
                                        name="btnUploadImgVersement"
                                        id="btn_upload_Versement<?php echo  $versement['idVersement']; ?>">
                                        <span class="glyphicon glyphicon-upload"></span> Enregistrer
                                    </button>
                                    <?php if ($versement['image'] != null && $versement['image'] != ' ') { ?>
                ...
                <ul class="pagination pull-right">
                    ...
                    <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                        ...
                        <a href="bonPclient.php?c=<?= $idClient; ?>&&debut=<?= $dateDebut ?>&&fin=<?= $dateFin ?>&&page=<?= $currentPage - 1 ?>"
                    ...
                    <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                        ...
                        <a href="bonPclient.php?c=<?= $idClient; ?>&&debut=<?= $dateDebut ?>&&fin=<?= $dateFin ?>&&page=<?= $page ?>"
                ...
                <ul class="pagination pull-right">
                    ...
                    <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                        ...
                        <a href="bonPclient.php?c=<?= $idClient; ?>&&page=<?= $currentPage - 1 ?>"
                            class="page-link">Précédente</a>
                    ...
                    <li class="page-item <?= ($currentPage == $page) ? "active" : "" ?>">
                        ...
                        <a href="bonPclient.php?c=<?= $idClient; ?>&&page=<?= $page ?>"
                            class="page-link"><?= $page ?></a>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="closeAvance" class="btn btn-primary"
                                data-dismiss="modal">Close</button>
