...
/**Debut Button Terminer Versement**/
    ...
    if (isset($_POST['btnEnregistrerVersement'])) {
        ...
        if ($dateActualiser!=null && $dateActualiser!='') {
...
<header>
    ...
    <div class="container" >
        ...
        <?php
            ...
            if(isset($_GET['debut']) && isset($_GET['fin'])){
                ...
                /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                    ...
                    (SELECT p.idClient FROM `".$nomtablePagnet."` p where p.idClient='".$idClient."' AND p.validerProforma=0 AND p.verrouiller=1 AND (p.type=0 || p.type=10 || p.type=11 || p.type=30 || p.type=2) AND (CONCAT(CONCAT(SUBSTR(p.datepagej,7, 10),'',SUBSTR(p.datepagej,3, 4)),'',SUBSTR(p.datepagej,1, 2)) BETWEEN '".$dateDebut."' AND '".$dateFin."')  or (p.datepagej BETWEEN '".$dateDebut."' AND '".$dateFin."')
                ...
                /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                    ...
                    (SELECT p.idClient FROM `".$nomtablePagnet."` p where p.idClient='".$idClient."' AND p.validerProforma=0 AND p.verrouiller=1 AND (p.type=0 || p.type=10 || p.type=11 || p.type=30 || p.type=2)
                ...
                /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                    ...
                    (SELECT CONCAT(SUBSTR(p.datepagej,7, 4),'',SUBSTR(p.datepagej,4, 2),'',SUBSTR(p.datepagej,1, 2),'',p.heurePagnet,'+',p.idPagnet,'+1') AS codePagnet FROM `".$nomtablePagnet."` p where p.idClient='".$idClient."' AND p.validerProforma=0 AND p.verrouiller=1 AND (p.type=0 || p.type=10 || p.type=11 || p.type=30 || p.type=2) 
                ...
                $sql12="SELECT SUM(apayerPagnet) FROM `".$nomtablePagnet."` where idClient=".$idClient." AND verrouiller=1 AND (type=0 || type=30 || type=11) ";
        ...
        <div class="jumbotron noImpr">
            ...
            <?php if($_SESSION['listeRemiseClient']==1) { ?> 
                        ...
                        <div class="modal-body">
                            ...
                            <form name="formulaireVersement" method="post" <?php echo  "action=bonPclient.php?c=". $idClient."" ; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dateActualiser" name="dateActualiser" placeholder="Date" <?= ($_SESSION['proprietaire']!=1 && @$_SESSION['versementAccess']==1) ? 'value="'. $dateString.'" disabled' : '' ;?> required="">
                                        ...
                                        <div style="padding-top : 2px;" class="panel panel-warning">
                                            ...
                                            <div class="panel-collapse collapse " <?php echo  "id=versement".$versement['idVersement']."" ; ?> >
                                                ...
                                                <div class="panel-body" >
                                                    ...
                                                    <button class="btn btn-warning  pull-right" style="margin-right:20px;display:none" onclick="document.getElementById('<?php echo 'recu'.$versement['idVersement'] ;?>').submit();">
