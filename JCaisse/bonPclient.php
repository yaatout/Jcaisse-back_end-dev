...
if ($_SESSION['compte']==1) {
    ...
    $sqlGetComptePay="SELECT * FROM `".$nomtableCompte."` where idCompte <> 2 && idCompte<>3 && idCompte<>1000 && typeCompte<>'Caisse Transfert' ORDER BY idCompte";
...
<header>
    ...
    <div class="container" >
            ...
            <div class="panel-group">
                ...
                <div class="panel" style="background:#cecbcb;">
                    ...
                    <div class="panel-heading" >
                        ...
                        <a data-toggle="collapse" href="#collapse1">Montant à verser : <?php echo number_format(($T_solde * $_SESSION['devise']), 2, ',', ' ').' '.$_SESSION['symbole']; ?>   </a>
                    ...
                    <div id="collapse1" class="panel-collapse collapse">
                        ...
                        <div class="panel-heading" style="margin-left:2%;">
                            ...
                            <?php ?>
                             ...
                             <h4>Total des Bons : <?php echo number_format(($T_bons * $_SESSION['devise']), 2, ',', ' ').' '.$_SESSION['symbole']; ?></h4>

                            <h4>Total des Versements : <?php echo number_format(($T_versement * $_SESSION['devise']), 2, ',', ' ').' '.$_SESSION['symbole']; ?></h4>
        ...
        <?php
            ...
            if(mysql_num_rows($res0)){
                ...
                if($jour > 30){?>
                    ...
                    <button type="button" <?= ($_SESSION['depotAvoir']==1) ? '' : 'hidden'; ?> class="btn btn-primary noImpr pull-right" style="margin-right:300px;" data-toggle="modal" data-target="#addAvoir">
                                ...
                                <?php endif; ?>    
                                 <?php
                                    ...
                                    <div class="form-group" id="divporteurVersement">
                                        ...
                                        <input type="text" name="porteurVersement" id="porteurVersement" class="form-control porteurVersement" autocomplete="off" required>
                    ...
                    <div class="modal-content">
                        ...
                        <form name="formulaireVersement" method="post" <?php echo  "action=bonPclient.php?c=". $idClient."" ; ?>>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="addPanier_1" name="btnActualiserBon" class="btn btn-primary">Enregistrer</button>
        ...
        <form name="formulairePagnet" method="post">
            ...
            <button type="submit" class="btn btn-success noImpr" id="ajout_P_Bon"  name="btnSavePagnetVente" <?= ($client['plafond']!=null && $client['plafond']!=0 && $client['plafond']<=($T_solde * $_SESSION['devise'])) ? 'disabled' : '' ;?> >
                                        ...
                                        <div class="panel-body" >
                                            ...
                                            <div class="cache_btn_Terminer row">
                                                ...
                                                <form  class="form-inline noImpr ajouterProdForm col-md-4 col-sm-4 col-xs-12" id="ajouterProdFormB<?= $pagnet['idPagnet'];?>" onsubmit="return false" >
                                                    ...
                                                    <input type="text" class="inputbasic form-control codeBarreLigneVt" name="codeBarre" id="panier_<?= $pagnet['idPagnet'];?>" style="width:100%;" autofocus="" autocomplete="off"  required />
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12 content2">
                                                    ...
                                                    <form class="form-inline noImpr" id="factForm" method="post">
                                                        ...
                                                        <input type="number" step="0.1" <?php echo "id=val_remise".$pagnet['idPagnet'] ; ?> name="remise" onkeyup="modif_Remise(this.value, <?php echo  $pagnet['idPagnet']; ?>)" class="remise form-control col-md-2 col-sm-2 col-xs-3" placeholder="Remise....">
                                                       
                                                        <?php if(@$_SESSION['echeanceClient']==1):?>

                                                            <input type="date" name="dateEcheance" class="avanceInput form-control col-md-2 col-sm-2 col-xs-3">
                                                        ...
                                                        <?php if($_SESSION['cbm']==1):?>
                                                            ...
                                                            <input type="text" <?php echo "id=numContainer".$pagnet['idPagnet'] ; ?> name="numContainer" class="versement form-control col-md-2 col-sm-2 col-xs-3" placeholder="Numéro container....">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($ligne = mysql_fetch_assoc($res8)) {?>
                                                        ...
                                                        <tr>
                                                                                    ...
                                                                                    $produit = mysql_fetch_assoc($resP);
                                                                                        ...
                                                                                        if(($produit["uniteStock"]!='Article')&&($produit["uniteStock"]!='article')){
                                                                                            ...
                                                                                            ?> 
                                                                                                ...
                                                                                                <select name="uniteVente" <?php echo  "id=uniteVente".$ligne['numligne'].""; ?> class="form-control" onchange="modif_UniteStock(this.value)" >  
                                                            ...
                                                            <input disabled="true" <?php echo  "id=prixUniteStock".$ligne['numligne'].""; ?> class="prixunitevente form-control" style="width: 70%"  type="number" <?php echo  "id=prixunitevente".$ligne['numligne'].""; ?>  <?php echo  "value=".$ligne['prixunitevente'].""; ?>
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12 content2">
                                                    ...
                                                    <form class="form-inline noImpr" id="factForm" method="post">
                                                        ...
                                                        <!-- <div class="btnAction col-md-1 col-xs-12"> -->
                                                            ...
                                                            <button type="submit" style="" name="btnImprimerProforma" <?php echo  "id=btnImprimerFacture".$pagnet['idPagnet']."" ; ?> class="btn btn-success btn_Termine_Panier terminer" data-toggle="modal"><span class="glyphicon glyphicon-ok"></span></button>
                                            ...
                                            <div <?php echo  "id=pagnet".$pagnet['idPagnet']."" ; ?>
                                                ...
                                                <div class="panel-body" >
                                                    ...
                                                    <?php if ($_SESSION['proprietaire']==1 && $_SESSION['editionPanier']==1){ ?>
                                                        ...
                                                        <button type="button" style="margin-right:20px;" class="btn btn-primary pull-right modeEditionBtn" id="edit-<?= $pagnet['idPagnet'] ; ?>">
                                                    ...
                                                    <div id="factForm">
                                                        ...
                                                        <?php if (@$_SESSION['cbm']==1){ ?>
                                                                <input type="text" placeholder="Numéro de container" data-idPanier="<?= $pagnet['idPagnet'];?>" class="numContainerChanged client form-control col-md-2 col-sm-2 col-xs-3 alert alert-warning" name="numContainerChanged" id="numContainerChanged<?= $pagnet['idPagnet'];?>" required autocomplete="off" />
                                                                <button type="button" id="numContainerChangedValidate<?= $pagnet['idPagnet'];?>" onClick="changeNumContainer(<?= $pagnet['idPagnet'];?>)" class="btn btn-success btn-sm glyphicon glyphicon-ok"> </button>
                                                            <?php }?>
                                                    </div>
                                                        ...
                                                        <?php }
                                                            ...
                                                            <div>
                                                                ...
                                                                <div id="numContainerdetail<?= $pagnet['idPagnet'];?>">
                                                                    ...
                                                                    <?php if($_SESSION['cbm']==1 && $pagnet['numContainer']!="" && $pagnet['numContainer']!=null): ?>
                                                                ...
                                                                <div id="nbPcsContainerdetail<?= $pagnet['idPagnet'];?>">
                                                                    ...
                                                                    <?php if ($_SESSION['cbm']==1 && $pagnet['codeBarrePcsInContainer']!=''){ ?>
                                                                        ...
                                                                        <form action="barcodeCBM.php" target="_blank" method="post">
                                                                            ...
                                                                            <input type="hidden" name="codeBarrePcsInContainer" value="<?= $pagnet['codeBarrePcsInContainer'];?>">
                                                                            <input type="hidden" name="nbPcsInContainer" value="<?= $pagnet['nbPcsInContainer'];?>">
                                                                            <input type="hidden" name="numContainer" value="<?= $pagnet['numContainer'];?>">
                                                                            <input type="hidden" name="idClient" value="<?= $pagnet['idClient'];?>">
                                                                            <button type="submit" class="btn btn-secondary  pull-left" style="margin-right:20px;">
                                                            ...
                                                            <?php
                                                                ...
                                                                while ($ligne = mysql_fetch_assoc($res8)) {?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input class="numligne" type="hidden" name="numligne" <?php echo  "id=numligne".$pagnet['idPagnet'].""; ?><?php echo  "value=".$ligne['numligne']."" ; ?> >
                                                            ...
                                                            <tr style="display:none" id="nouveauV<?php echo  $versement['idVersement'] ; ?>">
                                                                ...
                                                                <form class="form-inline noImpr" method="post" >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" size='11' maxLength='10' value="<?php echo $versement['dateVersement'];?>" class="form-control dateInputControl"  name="dateVersement" placeholder="jj-mm-aaaa" required="">
