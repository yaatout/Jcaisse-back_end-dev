...
try{
    ...
    /**Debut Ajouter Stock**/
        if($operation=='ajouter_Stock'){
            ...
            $stmStock_Ajouter = $bdd->prepare("INSERT INTO `".$nomtableStock."` (idDesignation, designation, quantiteCommande, uniteStock, nbreArticleUniteStock, totalArticleStock, dateStockage, quantiteStockCourant, prixuniteStock, prixunitaire, prixachat, dateExpiration, idBl, iduser)
            VALUES (:idDesignation, :designation, :quantiteCommande, :uniteStock, :nbreArticleUniteStock, :totalArticleStock, :dateStockage, :quantiteStockCourant,:prixuniteStock, :prixunitaire, :prixachat, :dateExpiration, :idBl, :iduser)");
