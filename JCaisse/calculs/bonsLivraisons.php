...
try{
    ...
    /**Debut Ajouter Bon Livraison**/
        if($operation=='ajouter_Livraison'){
            ...
            (dateBl,heureBl,montantBl,iduser)
            VALUES (:dateBl, :heureBl, :montantBl, :iduser)");
    ...
    /**Debut Terminer Bon Livraison et Bon Commande**/
        if($operation=='terminer_Bon'){
            ...
            $stmtBon_Modifier = $bdd->prepare("UPDATE `".$nomtableBl."` SET idFournisseur =:idFournisseur, numeroBl =:numeroBl,
    ...
    /**Debut Modifier Bon Livraison et Bon Commande**/
        if($operation=='modifier_Bon'){
            ...
            $stmtBon_Modifier = $bdd->prepare("UPDATE `".$nomtableBl."` SET idFournisseur =:idFournisseur, numeroBl =:numeroBl, dateBl =:dateBl,
