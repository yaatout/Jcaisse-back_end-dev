...
<body onload="window.print();" style="padding: 0px;margin-top: 0px;">
		<?php
			...
			$idEnreg = @htmlentities($_POST['idEnreg']);
				...
				if ($i==1) {
					...
					echo '<span>
						<b style="font-size: 40px;">';
							echo '<img class="barcode" style="width:5cm;" alt="'.$codeBarre.'" src="../barcode128.php?text='.$codeBarre.'&codetype='.$type.'&orientation='.$orientation.'&size='.$size.'&print='.$print.'&unite='.$txt.'"/>';
							echo '</b>
					</span>';
