...
if (isset($_POST['idPayement'])) {
    ...
    if (file_exists($filename)) {
        ...
        // Objet. 
        $objet = "Facture de paiement numéro : ".$num_fact; 


        // Entêtes supplémentaires. 
        $entêtes  = ""; 
        // -> origine du message 
        $entêtes .= "From: \"JCAISSE\" <camalack@gmail.com>\r\n"; 
        ...
        $message .= "Bonjour ".$proprietaire['prenom'].' '.$proprietaire['nom'].",\nvoici votre facture numéro : ".$num_fact." pour le paiement du service de la plateforme JCaisse pour la période de ".$periode.' '.$annee_paie.".\n \nCordialement.\nL'équipe JCaisse.\r\n\n\n"; 
        $message .= "\r\n";   // ligne vide 
        ...
        if (mail($proprietaire['email'],$objet,$message,$entêtes)) {
            $result="1";
        } 
    }
