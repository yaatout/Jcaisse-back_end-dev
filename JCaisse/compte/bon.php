					...
					<div class="modal-body">
						<form role="form" class="formulaire2" name="formulaire2" method="post" action="bon.php">
						  <?php  echo  '<input type="hidden" name="idClient"    value="'. htmlspecialchars($client['idClient']).'" >'; ?>
							<label for="inputEmail3" class="control-label">PRENOM</label>
							<?php  echo  '<input type="text" class="form-control" id="inputprenom" name="prenom" placeholder="Votre prenom"  value="'. htmlspecialchars($client['prenom']).'">' ; ?>
							<span class="text-danger" ></span>
							<div class="form-group ">
								<label for="inputEmail3" class="control-label">NOM</label>
								<?php  echo  '<input type="text" class="form-control" id="inputprenom" name="nom" placeholder="Votre nom" value="'. htmlspecialchars($client['nom']).'" >' ; ?>
								<span class="text-danger" ></span>
							</div>
							<div class="form-group ">
								<label for="inputEmail3" class="control-label">ADRESSE</label>
								<?php  echo '<input type="text" class="form-control" id="inputprenom" name="adresse" placeholder="adresse" value="'. htmlspecialchars($client['adresse']).'">' ; ?>
								<span class="text-danger" ></span>
							</div>
							<div class="form-group ">
								<label for="inputEmail3" class="control-label">TELEPHONE</label>
								<?php  echo  '<input type="text" class="form-control" id="inputprenom" name="telephone" placeholder="telephone"  <?php echo  "value="'. htmlspecialchars($client['telephone']).'" >' ; ?>
								<span class="text-danger" ></span>
							</div>
