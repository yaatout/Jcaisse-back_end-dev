...
if(!$modifier and !$supprimer){
  if($nomTransaction) {
		...
		echo'<script language="JavaScript">document.location="insertionDepense.php"</script>';
		echo'</head>';
		echo'</html>';
		}
...
<div class="container">
        ...
        <center><button type="button" class="btn btn-primary btn-success" data-toggle="modal" data-target="#categorieModal" id="AjoutDesignation">Ajouter une depense </button></center>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Ajout d'un depanse </h4>
                    </div>
                    <div class="modal-body">
                       <form role="form" class=" formulaire2" name="formulaire2" method="post" action="insertionDepense.php">
                             <input type="hidden" class="inputbasic" id="dateAjout" name="dateAjout" value="<?php echo $dateString2; ?> " >
							    ...
							    <div class="form-group row">
							                 <div class="col-sm-6">
                                                 <input type="hidden" class="inputbasic" id="aliasTransaction" name="typeTransaction" size="35" value="Depense">
											</div>
								</div>
...
echo'<li class="active"><a data-toggle="tab" href="#PRODUIT">LISTE DES DEPENSES </a></li>';
/*echo'<li><a data-toggle="tab" href="#DEPENSE">LISTE DES CATEGORIES DE DEPENSES</a></li>';
echo'<li><a data-toggle="tab" href="#FRAIS">LISTE DES CATEGORIES DE FRAIS</a></li>';*/
echo'</ul><div class="tab-content">';

$sql="select * from `aaa-transaction` where typeTransaction='Depense' order by idTransaction ASC";
$res=mysql_query($sql);
		...
		echo '<div id="imgsup'.$tab["idTransaction"].'" class="modal fade" role="dialog">
				<div class="modal-dialog">
				   <div class="modal-content">
					   <div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h4 class="modal-title">Confirmation Suppression DEPENSE </h4>
						</div>
						<div class="modal-body" style="padding:40px 50px;">


                            <form role="form" class="" id="form" name="formulaire2" method="post" action="insertionDepense.php">
