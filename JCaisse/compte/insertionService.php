...
if(!$modifier and !$supprimer){
  if($nomTransaction) {
		...
		echo'<script language="JavaScript">document.location="insertionService.php"</script>';
		echo'</head>';
		echo'</html>';
		}
...
<div class="container">
        ...
        <center><button type="button" class="btn btn-primary btn-success" data-toggle="modal" data-target="#categorieModal" id="AjoutDesignation">Ajouter un Service </button></center>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form role="form" class=" formulaire2" name="formulaire2" method="post" action="insertionService.php">
                             <input type="hidden" class="inputbasic" id="dateAjout" name="dateAjout" value="<?php echo $dateString2; ?> " >
							    ...
							    <div class="form-group row">
							                 <div class="col-sm-6">
                                                 <input type="hidden" class="inputbasic" id="aliasTransaction" name="typeTransaction" size="35" value="Service">
											</div>
								</div>
...
echo'<li class="active"><a data-toggle="tab" href="#PRODUIT">LISTE DES SERVICES </a></li>';
...
$sql="select * from `aaa-transaction` where typeTransaction='Service' order by idTransaction ASC";
$res=mysql_query($sql);
		...
		echo '<div id="imgsup'.$tab["idTransaction"].'" class="modal fade" role="dialog">
				<div class="modal-dialog">
				   <div class="modal-content">
					   <div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h4 class="modal-title">Confirmation Suppression SERVICE </h4>
						</div>
						<div class="modal-body" style="padding:40px 50px;">


                            <form role="form" class="" id="form" name="formulaire2" method="post" action="insertionService.php">
