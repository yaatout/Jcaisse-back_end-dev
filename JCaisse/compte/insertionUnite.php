...
if(!$modifier and !$supprimer){
  if($nomUniteStock) {
		...
		if(!@mysql_num_rows($res11)){
				$sql="insert into `aaa-unitestock` (nomUniteStock) values ('".mysql_real_escape_string($nomUniteStock)."')";
				//echo $sql;
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form role="form" class=" formulaire2" name="formulaire2" method="post" action="insertionUnite.php">
                             <input type="hidden" class="inputbasic" id="classe" name="classe" value="0" ><b>
                            UNITE DE STOCK <font color="red">*</font> </b><input type="text" class="inputbasic" placeholder="Entrez le nom de la catégorie" id="nomUniteStock" name="nomUniteStock" size="35" value="" required autofocus="" />
