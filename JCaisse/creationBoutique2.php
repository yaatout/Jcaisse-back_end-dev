...
$sql0="CREATE TABLE IF NOT EXISTS `".$nomtableJournal."` (`idjournal` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,`mois` INT NOT NULL ,`annee` INT NOT NULL ,`totalVente` double NOT NULL,`totalVersement` double NOT NULL,`totalBon` double NOT NULL,`totalFrais` double NOT NULL) ENGINE = MYISAM ;";



$sql1="CREATE TABLE IF NOT EXISTS `".$nomtableCategorie."` (`idcategorie` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,`nomcategorie` VARCHAR(50) NOT NULL,`categorieParent` int(11) DEFAULT NULL) ENGINE = MYISAM ;";



$sql2="CREATE TABLE IF NOT EXISTS `".$nomtablePage."` (`numpage` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,`datepage` VARCHAR(15) NOT NULL ,`totalVente` double NOT NULL,`totalService` double NOT NULL,`totalVersement` double NOT NULL,`totalBon` double NOT NULL,`totalFrais` double NOT NULL,`totalCaisse` double NOT NULL,`datetime` VARCHAR(25) NOT NULL,`iduser` INT NOT NULL) ENGINE = MYISAM ;";



$sql3="CREATE TABLE IF NOT EXISTS `".$nomtablePagnet."` (`idPagnet` INT NOT NULL AUTO_INCREMENT ,`datepagej` VARCHAR(15) NOT NULL ,`type` INT NOT NULL,`heurePagnet` VARCHAR(10) NOT NULL ,`totalp` REAL NOT NULL ,`remise` REAL NOT NULL,`apayerPagnet` REAL NOT NULL,`restourne` REAL NOT NULL,`versement` REAL NOT NULL,`paiement` VARCHAR(25) NOT NULL,`verrouiller` BOOLEAN NOT NULL,`idClient` INT NOT NULL,`iduser` INT NOT NULL,`apayerPagnetTva` DOUBLE NOT NULL,`apayerPagnetTvaR` DOUBLE NOT NULL,`image` VARCHAR(50) NOT NULL,`dejaTerminer` INT NOT NULL,PRIMARY KEY (`idPagnet`)) ENGINE = MYISAM;";
...
if (($_SESSION['type']=="Pharmacie") && ($_SESSION['categorie']=="Detaillant")) {
	...
	$sql10="CREATE TABLE IF NOT EXISTS `".$nomtableVersement."` (`idVersement` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,`idClient` INT NOT NULL,`idFournisseur` INT NOT NULL,`idMutuelle` INT NOT NULL,`montant` DOUBLE NOT NULL,`paiement` VARCHAR(25) NOT NULL,`dateVersement` VARCHAR(15) NOT NULL,`heureVersement` VARCHAR(10) NOT NULL,`image` VARCHAR(50) NOT NULL,`iduser` INT NOT NULL) ENGINE = MYISAM ;";

	

	$sql14="CREATE TABLE IF NOT EXISTS `".$nomtableInventaire."` (`idInventaire` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,`idStock` int(11) NOT NULL,`idDesignation` int(11) NOT NULL,`quantite` double NOT NULL,`quantiteStockCourant` double NOT NULL,`nbreArticleUniteStock` int(11) NOT NULL,`dateInventaire` varchar(10) COLLATE utf8_bin NOT NULL,`type` int(11) DEFAULT NULL,`iduser` int(11) NOT NULL) ENGINE=MyISAM ";



	$sql18="CREATE TABLE IF NOT EXISTS `".$nomtableMutuelle."` (`idMutuelle` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,`nomMutuelle` varchar(50) NOT NULL,`tauxMutuelle` int(11) NOT NULL,`adresseMutuelle` varchar(50) NOT NULL,`telephoneMutuelle` varchar(20) NOT NULL,PRIMARY KEY (`idMutuelle`)) ENGINE = MYISAM ;";



	$sql19="CREATE TABLE IF NOT EXISTS `".$nomtableMutuellePagnet."` (`idMutuellePagnet` INT NOT NULL AUTO_INCREMENT ,`datepagej` VARCHAR(15) NOT NULL ,`type` INT NOT NULL,`heurePagnet` VARCHAR(10) NOT NULL ,`totalp` REAL NOT NULL ,`remise` REAL NOT NULL,`taux` REAL NOT NULL,`apayerPagnet` REAL NOT NULL,`apayerMutuelle` REAL NOT NULL,`verrouiller` BOOLEAN NOT NULL,`idClient` INT NOT NULL,`idMutuelle` INT NOT NULL,`adherant` VARCHAR(250) NOT NULL,`codeAdherant` VARCHAR(30) NOT NULL,`codeBeneficiaire` VARCHAR(20) NOT NULL,`numeroRecu` VARCHAR(20) NOT NULL,`dateRecu` VARCHAR(20) NOT NULL,`iduser` INT NOT NULL,`image` VARCHAR(50) NOT NULL,PRIMARY KEY (`idMutuellePagnet`)) ENGINE = MYISAM;";
	...
	$sql10="CREATE TABLE IF NOT EXISTS `".$nomtableVersement."` (`idVersement` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,`idClient` INT NOT NULL,`idFournisseur` INT NOT NULL,`montant` DOUBLE NOT NULL,`paiement` VARCHAR(25) NOT NULL,`dateVersement` VARCHAR(15) NOT NULL,`heureVersement` VARCHAR(10) NOT NULL,`iduser` INT NOT NULL,`image` VARCHAR(50) NOT NULL) ENGINE = MYISAM ;";

	

	$sql12="CREATE TABLE IF NOT EXISTS `".$nomtableEntrepot."` (`idEntrepot` INT NOT NULL AUTO_INCREMENT,`nomEntrepot` VARCHAR(50) NOT NULL,`adresseEntrepot` VARCHAR(100), PRIMARY KEY (`idEntrepot`)) ENGINE = MYISAM";



	$sql13="CREATE TABLE IF NOT EXISTS `".$nomtableEntrepotStock."` (
	...
	$sql14="CREATE TABLE IF NOT EXISTS `".$nomtableInventaire."` (`idInventaire` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,`idStock` int(11) NOT NULL,`idEntrepotStock` int(11) NOT NULL,`idDesignation` int(11) NOT NULL,`quantite` double NOT NULL,`quantiteStockCourant` double NOT NULL,`nbreArticleUniteStock` int(11) NOT NULL,`dateInventaire` varchar(10) COLLATE utf8_bin NOT NULL,`type` int(11) DEFAULT NULL,`iduser` int(11) NOT NULL) ENGINE=MyISAM ";
    ...
    $sql4="CREATE TABLE IF NOT EXISTS `".$nomtableLigne."` (`numligne` INT NOT NULL AUTO_INCREMENT,`idPagnet` INT NOT NULL,`idDesignation` INT NOT NULL ,`designation` VARCHAR(155) NOT NULL,`idStock` INT NOT NULL,`unitevente` VARCHAR(155) NOT NULL,`prixunitevente` REAL NOT NULL,`quantite` INT NOT NULL,`prixtotal` REAL NOT NULL,`classe` INT(1) NOT NULL, PRIMARY KEY (`numligne`)) ENGINE = MYISAM";
...
$sql7="CREATE TABLE IF NOT EXISTS `".$nomtableTotalStock."` (`designation` VARCHAR(50) NOT NULL,`quantiteEnStocke` REAL NOT NULL, PRIMARY KEY (`designation`)) ENGINE = MYISAM ;";



$sql8="CREATE TABLE IF NOT EXISTS `".$nomtableClient."` (`idClient` INT NOT NULL AUTO_INCREMENT ,`prenom` VARCHAR(50) NOT NULL,`nom` VARCHAR(20) NOT NULL ,`adresse` VARCHAR(50) NOT NULL,`telephone` VARCHAR(50) NOT NULL,`solde` double NOT NULL, `activer` INT NOT NULL,`datetime` VARCHAR(25) NOT NULL,`iduser` INT NOT NULL,`personel` INT NOT NULL,`archiver` INT NOT NULL,`avoir` INT NOT NULL,`montantAvoir` double NOT NULL,`matriculePension` varchar(30) NOT NULL,`numCarnet` varchar(30) NOT NULL, PRIMARY KEY (`idClient`)) ENGINE = MYISAM ;";



$sql9="CREATE TABLE IF NOT EXISTS `".$nomtableBon."` (`idBon` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,`idClient` INT NOT NULL,`montant` DOUBLE NOT NULL ,`date` VARCHAR(15) NOT NULL,`heureBon` VARCHAR(10) NOT NULL,`iduser` INT NOT NULL) ENGINE = MYISAM ;";




$sql16="CREATE TABLE IF NOT EXISTS `".$nomtableBl."` (`idBl` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,`idFournisseur` INT NOT NULL,  `numeroBl` varchar(30) NOT NULL,`dateBl` varchar(20) NOT NULL,`heureBl` varchar(10) NOT NULL,`montantBl` double NOT NULL,`iduser` int(11) NOT NULL,`description` varchar(200) NOT NULL,`image` VARCHAR(50) NOT NULL) ENGINE = MYISAM ;";



$sql17="CREATE TABLE IF NOT EXISTS `".$nomtableFournisseur."` (`idFournisseur` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,`nomFournisseur` varchar(50) NOT NULL,`adresseFournisseur` varchar(50) NOT NULL,`telephoneFournisseur` varchar(20) NOT NULL, `montant` double NOT NULL) ENGINE = MYISAM ;";





$res0 =@mysql_query($sql0) or die ("creation table journal impossible -- ".mysql_error());

$res1 =@mysql_query($sql1) or die ("creation table categorie impossible -- ".mysql_error());

$res2 =@mysql_query($sql2) or die ("creation table page impossible -- ".mysql_error());

$res3 =@mysql_query($sql3) or die ("creation table pagnet impossible -- ".mysql_error());

$res4 =@mysql_query($sql4) or die ("creation table ligne impossible -- ".mysql_error());

$res5 =@mysql_query($sql5) or die ("creation table designation impossible -- ".mysql_error());

$res6 =@mysql_query($sql6) or die ("creation table stock impossible -- ".mysql_error());

$res7 =@mysql_query($sql7) or die ("creation table totalStock impossible -- ".mysql_error());

$res8 =@mysql_query($sql8) or die ("creation table client impossible -- ".mysql_error());

$res9 =@mysql_query($sql9) or die ("creation table bon impossible".mysql_error());

$res10=@mysql_query($sql10) or die ("creation table versement impossible -- ".mysql_error());

if (($_SESSION['type']=="Entrepot") && ($_SESSION['categorie']=="Grossiste")) {

	$res12=@mysql_query($sql12) or die ("creation table Entrepot impossible -- ".mysql_error());

	$res13=@mysql_query($sql13) or die ("creation table Stock Entrepot impossible -- ".mysql_error());

}

$res14=@mysql_query($sql14) or die ("creation table Inventaire impossible -- ".mysql_error());

if (($_SESSION['type']=="Multi-service") && ($_SESSION['categorie']=="Detaillant")) {

	$res15=@mysql_query($sql15) or die ("creation table Transfert impossible -- ".mysql_error());

}

$res16=@mysql_query($sql16) or die ("creation table Bl impossible -- ".mysql_error());

$res17=@mysql_query($sql17) or die ("creation table fournisseur impossible -- ".mysql_error());

if (($_SESSION['type']=="Pharmacie") && ($_SESSION['categorie']=="Detaillant")) {

	$res18=@mysql_query($sql16) or die ("creation table Mutuelle impossible -- ".mysql_error());

	$res19=@mysql_query($sql17) or die ("creation table Pagnet Mutuelle impossible -- ".mysql_error());	
