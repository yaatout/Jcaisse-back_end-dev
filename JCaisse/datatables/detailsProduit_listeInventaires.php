<?php
   ...
   $stmt = $bdd->prepare("SELECT COUNT(*) AS allcount FROM `".$nomtableInventaire."` 
   WHERE idDesignation=:idDesignation AND (dateInventaire  BETWEEN '".$dateDebut."' AND '".$dateFin."') ");
   ...
   $stmt = $bdd->prepare("SELECT COUNT(*) AS allcount FROM `".$nomtableInventaire."` 
   WHERE 1 ".$searchQuery." AND idDesignation=:idDesignation AND (dateInventaire  BETWEEN '".$dateDebut."' AND '".$dateFin."') ");
   $stmt->bindValue(':idDesignation', (int)$idDesignation, PDO::PARAM_INT);
   ...
   // Fetch records
   $stmt = $bdd->prepare("SELECT * FROM `".$nomtableInventaire."` 
   WHERE 1 ".$searchQuery."  AND idDesignation=:idDesignation AND (dateInventaire  BETWEEN '".$dateDebut."' AND '".$dateFin."') ORDER BY ".$columnName." ".$columnSortOrder." LIMIT :limit,:offset");
