    ...
    foreach ($operations as $operation) {
      ...
      if($type[1]==1){
        ...
        if($ligne['classe']==0){
          ...
          $cols_boutons=' <button type="submit" class="btn btn-danger pull-right" style="margin-bottom:10px; margin-right:10px;" onclick="supprimer_Chambre('.$ligne['numligne'].')" >
          ...
          echo '<div class="panel panel-success">
              <div class="panel-heading">
                <h4 style="padding-bottom: 18px;" data-toggle="collapse" data-parent="#accordion" href="#chambre'.$ligne['numligne'].'" class="panel-title expand">
                  <div class="right-arrow pull-right">+</div>
                  <a href="#" onclick="detailsVente('.$ligne['numligne'].')">  
                    <span class="hidden-xs col-sm-2 col-md-2 col-lg-3"><span class="mot_Panier">Chambre : '.$ligne['designation'].'</span></span>
              ...
              <div id="chambre'.$ligne['numligne'].'" class="panel-collapse collapse">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td>'.$ligne['prixchambre'].'</td>
                          <td>'.$ligne['dateArrivee'].' '.$ligne['heureArrivee'].'</td>
                          <td>'.$ligne['dateDepart'].' '.$ligne['heureDepart'].'</td>
                          <td>'.$ligne['jour'].'</td>
                          <td>'.$ligne['nbreMoins4'].'</td>
                          <td>'.$ligne['nbreMoins12'].'</td>
                          <td>'.$ligne['nbrePlus12'].'</td>
                          <td>
                              <button type="button" disabled="true" class="btn btn-warning pull-right" onclick="modifier_Chambre('.$ligne['numligne'].')" >
          ...
          $cols_boutons=' <button type="submit" class="btn btn-danger pull-right" style="margin-bottom:10px; margin-right:10px;" onclick="supprimer_Pension('.$ligne['numligne'].')" >
              <span class="glyphicon glyphicon-remove"></span> Supprimer
            </button>
            <form class="form-inline pull-right noImpr" style="margin-bottom:10px; margin-right:10px;" method="post" >
                <input type="hidden" name="numligne" id="numligne"  value="'.$ligne['numligne'].'" />
          ...
          echo '<div class="panel panel-info">
              <div class="panel-heading">
                <h4 style="padding-bottom: 18px;" data-toggle="collapse" data-parent="#accordion" href="#pension'.$ligne['numligne'].'" class="panel-title expand">
                  <div class="right-arrow pull-right">+</div>
                  <a href="#" onclick="detailsVente('.$ligne['numligne'].')">  
                    <span class="hidden-xs col-sm-2 col-md-2 col-lg-3"><span class="mot_Panier">Pension :  '.$ligne['designation'].'</span></span>
                    <span class="hidden-xs hidden-sm hidden-md col-lg-2"><span class="mot_Total">Date</span> : '.$ligne['datePension'].' </span>
                    <span class="hidden-xs col-sm-3 col-md-3 col-lg-2"><span class="mot_Heure">Personne(s)</span> : '.$ligne['nbrePension'].'</span>
                    <span class="col-xs-6 col-sm-3 col-md-3 col-lg-2"> Montant : '.number_format(($ligne['prixtotal'] * $_SESSION['devise']), 0, ',', ' ').'</span>
                    <span class="col-xs-5 col-sm-3 col-md-3 col-lg-2 pull-right">Recu : #'.$ligne['numligne'].'</span>
                  </a>
                </h4>
              ...
              <div id="pension'.$ligne['numligne'].'" class="panel-collapse collapse">
                <div class="content-panel" style="margin:10px;">
                '.$cols_boutons.'
                  <table class="table table-bordered">
                      <thead class="noImpr">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td>'.$ligne['prixpension'].'</td>
                          <td>'.$ligne['nbrePension'].'</td>
                          <td>'.$ligne['datePension'].'</td>
                          <td>
                              <button type="button" disabled="true"  class="btn btn-warning pull-right" onclick="modifier_Pension('.$ligne['numligne'].')" >
                                      <span class="glyphicon glyphicon-pencil"></span>
                              </button>
                          </td>
                        </tr>
