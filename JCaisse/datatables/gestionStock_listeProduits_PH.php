<?php
   ...
   foreach ($empRecords as $row) {
      ...
      $cols_prixPublic = '<input type="number" class="form-control" id="inpt_Stock_PrixPublic_'.$row['idDesignation'].'" style="width: 100px;"  min=1 value="'.$row['prixPublic'].'" required=""/>';
      $cols_prixSession = '<input type="number" class="form-control" id="inpt_Stock_PrixSession_'.$row['idDesignation'].'" min=1 value="'.$row['prixSession'].'" required=""/>';
