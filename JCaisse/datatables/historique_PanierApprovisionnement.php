    ...
    foreach ($operations as $vente) {
      ...
      <div class="panel-heading">
        <h4 style="padding-bottom: 18px;"  class="panel-title expand">
          ...
          <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#Approvisionnement'.$vente['idPagnet'].'" onclick="panier_Approvisionnement('.$vente['idPagnet'].')">  
      ...
      <div id="Approvisionnement'.$vente['idPagnet'].'" class="panel-collapse collapse">
        <div class="content-panel">
          <div class="panel-body">
            ...
            <table class="table table-hover" id="panier_Approvisionnement'.$vente['idPagnet'].'">
              <thead>
                <tr>
...
';
    ...
    if($total_rows>0){
      ...
      echo '<div class="col-md-1"> 
          <select class="form-control pull-left" id="slct_Nbre_Approvisionnement">
          <optgroup>
