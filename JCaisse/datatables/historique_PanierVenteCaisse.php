...
try{
    ...
    if ($query =="") {
        ...
        WHERE p.verrouiller=1 AND p.idClient=0 AND (p.idCompte=1 || p.idCompte=0) AND  (p.type=0 || p.type=30) AND (l.classe=0 || l.classe=1) AND ((CONCAT(CONCAT(SUBSTR(p.datepagej,7, 10),'',SUBSTR(p.datepagej,3, 4)),'',SUBSTR(p.datepagej,1, 2)) ='".$dateJour."') or (p.datepagej ='".$dateJour."') )  ");
        $stmt->execute();
        $records = $stmt->fetch();
      ...
      echo '<div class="panel panel-success">
            <div class="panel-heading">
              <h4 style="padding-bottom: 18px;"  class="panel-title expand">
                ...
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#VenteCaisse'.$vente['idPagnet'].'" onclick="panier_VenteCaisse('.$vente['idPagnet'].')">  
            ...
            <div id="VenteCaisse'.$vente['idPagnet'].'" class="panel-collapse collapse">
              <div class="content-panel">
                ...
                <button type="submit" class="btn btn-warning pull-right" >
                  ...
                  <table class="table table-hover" id="panier_VenteCaisse'.$vente['idPagnet'].'">
                    <thead>
                      <tr>
    ...
    if($total_rows>0){
      ...
      echo '<div class="col-md-1"> 
          <select class="form-control pull-left" id="slct_Nbre_VenteCaisse">
          <optgroup>
