<?php
   ...
   foreach ($empRecords as $row) {
      ...
      $cols_operations = '<a><img src="images/edit.png" align="middle" alt="modifier" onclick="modifier_Bien('.$row["idDesignation"].')" id="" data-toggle="modal" data-target="#imgmodifier'.$row["idDesignation"].'" /></a>&nbsp;
      <a><img src="images/drop.png" align="middle" alt="supprimer" onclick="supprimer_Bien('.$row["idDesignation"].')"  data-toggle="modal" data-target="#imgsup'.$row["idDesignation"].'" /></a>'; 

      //$cols_operations = $cols_operations.' <a href="detailsBien.php?iDS='.$row["idDesignation"].'"><span style="color:green;">Details</span></a>';
