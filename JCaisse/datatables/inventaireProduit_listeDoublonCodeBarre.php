<?php
   ...
   $stmt = $bdd->prepare("SELECT COUNT(DISTINCT(codeBarreDesignation)) AS allcount FROM `".$nomtableDesignation."`
      WHERE classe=0 AND codeBarreDesignation<>'' AND codeBarreDesignation IN
      (
         SELECT codeBarreDesignation FROM `".$nomtableDesignation."` WHERE classe=0 AND codeBarreDesignation<>''
   ...
   $stmt = $bdd->prepare("SELECT COUNT(DISTINCT(codeBarreDesignation)) AS allcount FROM `".$nomtableDesignation."`
   WHERE 1 ".$searchQuery." AND classe=0 AND codeBarreDesignation<>'' AND codeBarreDesignation IN
   (
      SELECT codeBarreDesignation FROM `".$nomtableDesignation."` WHERE classe=0 AND codeBarreDesignation<>''
      GROUP BY codeBarreDesignation
      HAVING COUNT(codeBarreDesignation)>1
