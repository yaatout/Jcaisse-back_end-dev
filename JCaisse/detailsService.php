...
<script type="text/javascript">
  ...
  $(function() {
      ...
      function cb(start, end) {
          ...
          window.location.href = "detailsService.php?iDS="+id+"&&debut="+debut+"&&fin="+fin;
...
<div class="col-sm-4 pull-left" >
 <a  class="btn btn-warning  pull-left" style="margin-top:8px;" href="insertionService.php" > Retour </a>
</div>
...
<div class="jumbotron noImpr">
  ...
  <h2>Service : <?php echo $design['designation']; ?> </h2>
