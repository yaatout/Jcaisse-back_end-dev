...
?>
    ...
    <div class="container">
        ...
        <script >
            $(function() {
                ...
                /*************** Début lister Dépenses ***************/
                        ...
                        // $("#etatVenteEntrepot").empty();

                        debut=$('#input_dateDebut').val();
                        fin=$('#input_dateFin').val();

                        $("#etatVenteEntrepot").load( "ajax/etatVente-EntrepotAjax.php",{"operation":1,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":""}, function(){ //get content from PHP page
                        ...
                        $("#dateSelectedValidate").on( "click", function (e){
                            // $("#etatVenteEntrepot").on( "click", function (e){
                            e.preventDefault();
                            $("#etatVenteEntrepot").hide(); //hide content element
                            ...
                            if (query.length == 0) {
                                $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"operation":1,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":""}, function(){ //get content from PHP page
                                    $(".loading-gif").hide(); //once done, hide loading element
                                    $("#etatVenteEntrepot").show(); //show content element
                                });
                                    
                            }else{
                                $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"operation":1,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":query}, function(){ //get content from PHP page
                                    $(".loading-gif").hide(); //once done, hide loading element
                                    $("#etatVenteEntrepot").show(); //show content element
                                });
                            }
                            // $("#etatVenteEntrepot").load("ajax/etatVente-EntrepotAjax.php",{"page":page,"operation":1}
                        });
                        //executes code below when user click on pagination links
                        $("#etatVenteEntrepot").on( "click", ".pagination a", function (e){
                            // $("#etatVenteEntrepot").on( "click", function (e){
                            e.preventDefault();
                            $("#etatVenteEntrepot").hide(); //hide content element
                            $(".loading-gif").show(); //show loading element
                            ...
                            if (query.length == 0) {
                                $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"page":page,"operation":1,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":""}, function(){ //get content from PHP page
                                    $(".loading-gif").hide(); //once done, hide loading element
                                    $("#etatVenteEntrepot").show(); //show content element
                                ...
                                $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"page":page,"operation":1,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":query}, function(){ //get content from PHP page
                                    $(".loading-gif").hide(); //once done, hide loading element
                                    $("#etatVenteEntrepot").show(); //show content element
                                });
                            }
                        ...
                        $('#searchInputEVT').on("keyup", function(e) {
                            ...
                            if (keycode == '13') {
                                ...
                                if (query.length > 0) {
                                    ...
                                    $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"operation":3,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":query,"cb":t}); //load initial records
                                }else{
                                    $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"operation":3,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":"","cb":t}); //load initial records
                                }
                            }else{
                                // alert(2222)
                                t = 0; // no code barre
                        ...
                        $('#nbEntreeEVT').on("change", function(e) {
                            ...
                            if (query.length == 0) {
                                $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"operation":4,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":""}); //load initial records
                                    
                            }else{
                                $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"operation":4,"debut":debut,"fin":fin,"nbEntreeEVT":nbEntreeEVT,"query":query}); //load initial records
                            }
                                
                            // $("#etatVenteEntrepot" ).load( "ajax/etatVente-EntrepotAjax.php",{"operation":4,"nbEntreeEVT":nbEntreeEVT}); //load initial records
                        });
                /*************** Fin lister Dépenses ***************/
                })
        </script>
        ...
        <div class="table-responsive">
            ...
            <div id="etatVenteEntrepot"><!-- content will be loaded here --></div>	
        </div>
