        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="STOCKPRODUITDETAIL">';
                   $sql3='SELECT * from  `'.$nomtableStock.'` where quantiteStockCourant!=0 order by idStock desc';
                    ...
                    echo'<table id="stockTable" class="display" border="1"><thead><tr>
						<th>REFERENCE</th>
						<th>QUANTITE</th>
						<th>UNITE STOCK</th>
						<th>PRIX ACHAT</th>
					...
					<tfoot><tr>
                      ...
                      while($tab3=mysql_fetch_array($res3)){
						     $sql1="SELECT * FROM `". $nomtableDesignation."` where idDesignation='".$tab3['idDesignation']."'";
								$res1=mysql_query($sql1);
								$designation=mysql_fetch_array($res1);
                              echo'<tr><td>'.$tab3["designation"].'</td>
                              <td>'.$tab3["quantiteStockCourant"].'</td>
                              <td>'.$tab3["uniteStock"].'</td>
							  <td>'.$designation["prixachat"].'</td>
							  <td>'.$designation["prix"].'</td>
