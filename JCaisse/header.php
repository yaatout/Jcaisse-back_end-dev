...
$sqlS = "SELECT * FROM `" . $nomtablePagnet . "` where type=10";

$resPro = mysql_query($sqlS) or die("select stock impossible =>" . mysql_error());

// $S_ventes = mysql_fetch_array($resS);

// var_dump(mysql_num_rows($resS));
					...
					<ul class="nav navbar-nav">
						...
						<?php if ($_SESSION['gerant'] == 1) {
							...
							echo '<li><a href="gestionStock.php"><b>GESTION STOCK</b></a></li>
										...
										<li><a href="inventaireStockPartielle.php"><b>INVENTAIRE PARTIELLE</b></a></li>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav">
						...
						if (($_SESSION['type'] == "Entrepot") && ($_SESSION['categorie'] == "Grossiste") && ($_SESSION['importExp'] == 1)) {
							...
							if (($_SESSION['gerant'] == 1) || ($_SESSION['caissier'] == 1) || ($_SESSION['vendeur'] == 1)) {
						...
						if (($_SESSION['proprietaire'] == 1 || $_SESSION['gerant'] == 1) && ($_SESSION['mutuelle'] == 1 && $_SESSION['type'] == "Pharmacie") && ($_SESSION['categorie'] == "Detaillant")) {
						...
						<?php if ($_SESSION['proprietaire'] == 1 || $_SESSION['gerant'] == 1) {
							...
							if (($_SESSION['type'] == "Pharmacie") && ($_SESSION['categorie'] == "Detaillant")) {
								...
								echo '<li><a href="gestionStock.php"><b>GESTION STOCK</b></a></li>
										...
										<li><a href="#"><b>INVENTAIRE ANNUEL</b></a></li>
										';
								// <li><a href="inventaireStockPartielle.php"><b>INVENTAIRE STOCK</b></a></li>';
