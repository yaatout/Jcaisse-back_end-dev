                        ...
                        <div class="panel-body" >
                          ...
                          <table class="table ">
						    ...
						    <div>
									...
									<div>
										<?php if ($pagnet['verrouiller']==0): ?>
											<input class="noImpr" size="7" type="number" placeholder="remise" name="remise"
											 <?php echo  "id=remise".$pagnet['idPagnet'].""; ?> disabled>
									...
									<div>
										<?php if ($pagnet['verrouiller']==0): ?>
											...
											<input class="noImpr" size="7" type="number" placeholder="Espéce" name="versement"
											 <?php echo  "id=versement".$pagnet['idPagnet'].""; ?> disabled>
											<?php else: ?>
