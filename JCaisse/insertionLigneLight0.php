    ...
    if (isset($_POST['btnSavePagnetVente'])) {
        ...
        if(mysql_num_rows($res0)){
            if($jour > 4){
                ...
                $query = mysql_query("SELECT * FROM `".$nomtablePagnet."` where  iduser='".$_SESSION['iduser']."' && type=0 && idClient=0 && datepagej ='".$dateString2."' && verrouiller=0");
    ...
    <header>
        ...
        <div class="container" >
                    ...
                    <div class="panel-group">
                        <div class="panel" style="background:#cecbcb;">
                            <div class="panel-heading">
                                ...
                                <a data-toggle="collapse" href="#collapse1">Total opérations : <?php echo number_format((($T_caisse + $T_versements[0]) * $_SESSION['devise']), 2, ',', ' ').' '.$_SESSION['symbole']; ?>   </a>
                                </h4>
                            </div>
            ...
            <form name="formulairePagnet" method="post" >
                <button type="submit" class="btn btn-success noImpr" id="addPanier" name="btnSavePagnetVente">
            ...
            <!-- Debut de l'Accordion pour Tout les Paniers -->
                <div class="panel-group" id="accordion">
                        ...
                        if($_SESSION['proprietaire']==1){
                            if (isset($_POST['produit'])) {
                                ...
                                /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                                    ...
                                    INNER JOIN `".$nomtableLigne."` l ON l.idPagnet = p.idPagnet
                                    where p.datepagej ='".$dateString2."' && p.verrouiller=1 && (p.type=0 || p.type=30 || p.type=10) && l.designation='".$produit."' ORDER BY p.idPagnet DESC";
                                ...
                                /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                                    ...
                                    INNER JOIN `".$nomtableLigne."` l ON l.idPagnet = p.idPagnet
                                    where p.datepagej ='".$dateString2."' && p.verrouiller=1 && (p.type=0 || p.type=30 || p.type=10 || p.type=1) && l.designation='".$produit."' ORDER BY p.idPagnet DESC LIMIT ".$premier.",".$parPage." ";
                                    $resP1 = mysql_query($sqlP1) or die ("persoonel requête 2".mysql_error());
                                /**Fin requete pour Lister les Paniers vendus Aujourd'hui  **/
                            }
                            else{
                                /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                                    $sqlC="SELECT COUNT(*) FROM `".$nomtablePagnet."` where datepagej ='".$dateString2."' && (type=0 || type=30 || type=10) && verrouiller=1  ORDER BY idPagnet DESC";
                                    $resC = mysql_query($sqlC) or die ("persoonel requête 2".mysql_error());
                                    $nbre = mysql_fetch_array($resC) ;
                                    $nbPaniers = (int) $nbre[0];
                                /**Fin requete pour Compter les Paniers vendus Aujourd'hui  **/
                                ...
                                /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                                    $sqlP1="SELECT * FROM `".$nomtablePagnet."` where datepagej ='".$dateString2."' && (type=0 || type=30 || type=10) && verrouiller=1 ORDER BY idPagnet DESC LIMIT ".$premier.",".$parPage." ";
                                    $resP1 = mysql_query($sqlP1) or die ("persoonel requête 2".mysql_error());
                                /**Fin requete pour Lister les Paniers vendus Aujourd'hui  **/
                            }
                            ...
                            if (isset($_POST['produit'])) {
                                ...
                                /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                                    $sqlC="SELECT COUNT(*) FROM `".$nomtablePagnet."` p
                                    INNER JOIN `".$nomtableLigne."` l ON l.idPagnet = p.idPagnet
                                    where  p.iduser='".$_SESSION['iduser']."' && (p.type=0 || p.type=30 || p.type=10) && p.datepagej ='".$dateString2."' && p.verrouiller=1 && l.designation='".$produit."' ORDER BY p.idPagnet DESC";
                                    $resC = mysql_query($sqlC) or die ("persoonel requête 2".mysql_error());
                                    $nbre = mysql_fetch_array($resC) ;
                                    $nbPaniers = (int) $nbre[0];
                                /**Fin requete pour Compter les Paniers vendus Aujourd'hui  **/
                                ...
                                /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                                    $sqlP1="SELECT * FROM `".$nomtablePagnet."` p
                                    INNER JOIN `".$nomtableLigne."` l ON l.idPagnet = p.idPagnet
                                    where  p.iduser='".$_SESSION['iduser']."' && (p.type=0 || p.type=30 || p.type=10 || p.type=1) && p.datepagej ='".$dateString2."' && p.verrouiller=1 && l.designation='".$produit."' ORDER BY p.idPagnet DESC LIMIT ".$premier.",".$parPage." ";
                                    $resP1 = mysql_query($sqlP1) or die ("persoonel requête 2".mysql_error());
                                /**Fin requete pour Lister les Paniers vendus Aujourd'hui  **/
                            }
                            else{
                                /**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
                                    $sqlC="SELECT COUNT(*) FROM `".$nomtablePagnet."` where  iduser='".$_SESSION['iduser']."' && (type=0 || type=30 || type=10) && datepagej ='".$dateString2."' && verrouiller=1  ORDER BY idPagnet DESC";
                                    $resC = mysql_query($sqlC) or die ("persoonel requête 2".mysql_error());
                                    $nbre = mysql_fetch_array($resC) ;
                                    $nbPaniers = (int) $nbre[0];
                                /**Fin requete pour Compter les Paniers vendus Aujourd'hui  **/
                                ...
                                /**Debut requete pour Lister les Paniers vendus Aujourd'hui  **/
                                    $sqlP1="SELECT * FROM `".$nomtablePagnet."` where  iduser='".$_SESSION['iduser']."' && (type=0 || type=30 || type=10) && datepagej ='".$dateString2."' && verrouiller=1  ORDER BY idPagnet DESC LIMIT 10 ";
                                    $resP1 = mysql_query($sqlP1) or die ("persoonel requête 2".mysql_error());
                                /**Fin requete pour Lister les Paniers vendus Aujourd'hui  **/
                            }
                    ...
                    <!-- Debut Boucle while concernant les Paniers en cours (2 aux maximum) -->  
                        ...
                        <?php
                            if($pagnet['type'] == 0 || $pagnet['type'] == 30){   ?>
                                <div class="panel <?= ($pagnet['type']==0) ? 'panel-primary' : 'panel-info'?>">
                                    <div class="panel-heading">
