...
$id=@$_GET["id"];
$sql3="SELECT * FROM `".$nomtableEntrepot."` where idEntrepot=".$id."";
...
<body >
   ...
   <input id="inpt_Entrepot_id" type="hidden" value="<?= $id?>" />
...
<!-- 
  ...
  <div class="container">
    ...
    <ul class="nav nav-tabs">
      ...
      <li id="listeStockEvent">
        <a data-toggle="tab" href="#listeStockTab">OMISSIONS </a>
      </li>
  ...
  <script type="text/javascript" src="scripts/inventaireProduit_ET.js"></script>
