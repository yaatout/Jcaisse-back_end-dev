...
try {
  ...
  $pdo->beginTransaction();
    ...
    $sql = "insert into `".$nomtablePagnet."` (datepagej,heurePagnet,iduser,type,totalp,remise,apayerPagnet,restourne,versement,verrouiller,idClient,idVitrine,idCompte,avance,apayerPagnetTvaP,apayerPagnetTvaR,dejaTerminer,synchronise)
    values (:datepagej,:heurePagnet,:iduser,:type,:totalp,:remise,:apayerPagnet,:restourne,:versement,:verrouiller,:idClient,:idVitrine,:idCompte,:avance,:apayerPagnetTvaP,:apayerPagnetTvaR,:dejaTerminer,:synchronise)";
    ...
    if($panier!=null){
      ...
      $result=$panier['idPagnet'].'<>'.$idPanier;
