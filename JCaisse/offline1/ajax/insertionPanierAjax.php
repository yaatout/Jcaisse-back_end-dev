...
try {
  ...
  $pdo->beginTransaction();
    ...
    if($searchPanier){
        ...
        $sql = "insert into `".$nomtablePagnet."` (identifiantP,datepagej,heurePagnet,iduser,type,totalp,remise,apayerPagnet,restourne,versement,verrouiller,idClient,idVitrine,idCompte,avance,apayerPagnetTvaP,apayerPagnetTvaR,dejaTerminer,synchronise)
        values (:identifiantP,:datepagej,:heurePagnet,:iduser,:type,:totalp,:remise,:apayerPagnet,:restourne,:versement,:verrouiller,:idClient,:idVitrine,:idCompte,:avance,:apayerPagnetTvaP,:apayerPagnetTvaR,:dejaTerminer,:synchronise)";
        ...
        $result=$panier['idPagnet'].'<>'.json_encode($lignes);
        ...
        // if($panier!=NULL){
            ...
            //     //     $sql = "insert into `".$nomtableLigne."` (designation, idStock, idDesignation, unitevente,prixunitevente,quantite,prixtotal,idPagnet,classe,synchronise,prixtotalTvaP,prixtotalTvaR)
            //     //     values (:designation,:idStock,:idDesignation,:unitevente,:prixunitevente,:quantite,:prixtotal,:idPagnet,:classe,:synchronise,:prixtotalTvaP,:prixtotalTvaR)";
