    ...
    for(var i=0; i<clients.length; i++){        
        if(clients[i].solde > 0){
            var l="<tr>" +
                ...
                "<td><span class='alert-danger'>"+clients[i].solde+" <a href='bonPclient.html?c="+clients[i].idClient+"' onclick='getIdClient("+clients[i].idClient+")'> Details</a> </span></td>"+
            ...
            if(clients[i].solde < 0){
                var l="<tr>" +
                    ...
                    "<td><span class='alert-success'>"+clients[i].solde+" <a href='bonPclient.html?c="+clients[i].idClient+"' onclick='getIdClient("+clients[i].idClient+")'> Details</a> </span></td>"+
