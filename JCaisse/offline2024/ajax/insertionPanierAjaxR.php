...
try {
  ...
  $pdo->beginTransaction();
    ...
    if($searchPanier!=NULL){
        ...
        $sql = "insert into `".$nomtablePagnet."` (identifiantP,datepagej,heurePagnet,iduser,type,totalp,remise,apayerPagnet,restourne,versement,verrouiller,idClient,idCompte,idCompteAvance,avance,dejaTerminer,synchronise)
        values (:identifiantP,:datepagej,:heurePagnet,:iduser,:type,:totalp,:remise,:apayerPagnet,:restourne,:versement,:verrouiller,:idClient,:idCompte,:idCompteAvance,:avance,:dejaTerminer,:synchronise)";
