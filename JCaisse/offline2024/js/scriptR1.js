...
function imprimerTicket(id) {
  ...
  window.open("/JCaisse_Mare/offline/ticketCaisse.html", "_blank");
}
...
function imprimerFacture(id) {
  ...
  window.open("/JCaisse_Mare/offline/factureClient.html");
}
    ...
    success: function (data) {
      ...
      if (result == 0) {
        ...
        if (panierE != undefined) {
          ...
          // }else{
          //     window.location.href="/JCaisse_Mare/insertionLigneLight.php";
          // }
        }
      }
    },
