...
require('code128.php');
		...
		WHERE classe = 1 AND uniteStock!='Transaction' AND uniteStock!='Facture' AND uniteStock!='Credit' ORDER BY idDesignation ASC";
	...
	/**Debut requete pour Compter les Paniers vendus Aujourd'hui  **/
		...
		FROM `".$nomtableDesignation."` 
		WHERE classe = 1  ORDER BY idDesignation ASC";
