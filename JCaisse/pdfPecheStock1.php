...
if($idEntrepotInventaire!=''){
    ...
    $pdf->SetFont( "Arial", "BU", 10 ); $pdf->SetXY( 15, 35 ) ; $pdf->Cell($pdf->GetStringWidth("ENTREPOT : ".strtoupper($nomEntrepot)), 0, 'ENTREPOT : '.strtoupper($nomEntrepot).' => Quantite egale a 0', 0, "L");
}
