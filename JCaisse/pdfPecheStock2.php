...
if($idEntrepotInventaire!=''){
    ...
    $pdf->SetFont( "Arial", "BU", 10 ); $pdf->SetXY( 15, 35 ) ; $pdf->Cell($pdf->GetStringWidth("ENTREPOT : ".strtoupper($nomEntrepot)), 0, 'ENTREPOT : '.strtoupper($nomEntrepot).' => Quantite comprise entre 1 et 20', 0, "L");
}
