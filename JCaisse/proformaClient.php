...
<body onLoad="process()">
  ...
  if (isset($_POST['dateSelectedValidate'])) {
    ...
    // header("Location:./proformaClient.php?page=1&day=".$dateString2);
  ...
  <div class="container">
    ...
    <div class="container row" align="center">
      ...
      <form class="form-inline col-lg-6" method="POST" action="proformaClient.php">
        <div class="form-group mx-sm-3 mb-2">
    ...
    <div align="center">
      <?php if ($_SESSION['proprietaire'] == 1) { ?>
        <a class="btn btn-warning" href="proformaClientInValider.php"> Proforma non terminer</a> <br>
      <?php } ?>
    ...
    <div class="panel-group mt-5" id="accordion">
      ...
      if (isset($_POST['clientSearchedValidation'])) {
        ...
        $sqlP01 = "SELECT count(idPagnet) FROM `" . $nomtablePagnet . "` where type=10 && verrouiller=1 && nomClient='" . $nomClient . "' ORDER BY idPagnet DESC";
        ...
        $sqlP0 = "SELECT * FROM `" . $nomtablePagnet . "` where type=10 && verrouiller=1 && nomClient='" . $nomClient . "' ORDER BY validerProforma,terminerProforma,idPagnet DESC LIMIT $page_position, $item_per_page";
        $resP0 = mysql_query($sqlP0) or die("persoonel requête 2" . mysql_error());
      } else {

        $sqlP01 = "SELECT count(idPagnet) FROM `" . $nomtablePagnet . "` where type=10 && verrouiller=1 && datepagej='" . $dateString2 . "' ORDER BY idPagnet DESC";
        $resP01 = mysql_query($sqlP01) or die("persoonel requête 2" . mysql_error());
        ...
        $sqlP0 = "SELECT * FROM `" . $nomtablePagnet . "` where type=10 && verrouiller=1 && datepagej='" . $dateString2 . "' ORDER BY validerProforma,terminerProforma,idPagnet DESC LIMIT $page_position, $item_per_page";
        $resP0 = mysql_query($sqlP0) or die("persoonel requête 2" . mysql_error());
      }
      ...
      ?>
        ...
        if (($proforma['validerProforma'] == 1)) {

        ?> <div class="panel panel-success">

          <?php

        } else if (($proforma['terminerProforma'] == 1)) {
            ...
            ?> <div class="panel panel-default">
              ...
              <div id="collapse<?= $proforma['idPagnet'] ?>" <?php
                ...
                <div class="panel-body">
                  <?php if ($proforma['validerProforma'] == 0) { ?>
                    <button class="btn btn-info pull-right" target="_blank" style="margin-right:20px;" onclick="imprimerProforma(<?= $proforma['idPagnet'] ?>)">

                      Imprimer

                    </button>
                    <?php if ($proforma['terminerProforma'] == 1) { ?>
                      <button class="btn btn-warning pull-right" style="margin-right:20px;" onclick="editerProforma(<?= $proforma['idPagnet'] ?>)">
                    ...
                    <form class="form-inline pull-left noImpr" <?php echo  "id=ticket" . $proforma['idPagnet']; ?> target="_blank" style="margin-right:20px;" method="post" action="barcodeFactureProforma.php">

                      <input type="number" class="form-control" name="nbColis" id="nbColis<?= $proforma['idPagnet'] ?>" placeholder="Nombre de colis" required>
                      <input type="hidden" name="idPagnet" id="idPagnet" <?php echo  "value=" . $proforma['idPagnet'] . ""; ?>>

                    </form>
                  <?php } ?>

                  <?php if ($proforma['validerProforma'] == 0 && $proforma['terminerProforma'] == 0) { ?>

                    <button class="btn btn-success  pull-right" style="margin-right:20px;" onclick="terminerProforma(<?= $proforma['idPagnet'] ?>)">
                  ...
                  <img class="btn btn-xs pull-right" style="margin-right:30%;" src="images/img.png" alt="apperçu" width="50" height="45" data-toggle="modal" <?php echo "data-target=#imageNvProforma" . $proforma['idPagnet']; ?>>
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-success" id="dmc-<?= $ligne['numligne'] ?>" data-idc="<?= $ligne['numligne'] ?>" onClick="depotManagerConfirm(<?= $ligne['numligne'] ?>)" <?= ($ligne['depotConfirm'] == 0) ? "" : "style=display:none"; ?> <?= ($ligne['idEntrepot'] == $user['idEntrepot'] || $user['idEntrepot'] == '' || $user['idEntrepot'] == 0) ? "" : "disabled"; ?>><i class="glyphicon glyphicon-ok"></i></button>

                            <button class="btn btn-primary" id="dme-<?= $ligne['numligne'] ?>" data-ide="<?= $ligne['numligne'] ?>" onClick="depotManagerEdit(<?= $ligne['numligne'] ?>)" <?= ($ligne['depotConfirm'] == 0) ? "style=display:none" : ""; ?> <?= ($ligne['idEntrepot'] == $user['idEntrepot'] || $user['idEntrepot'] == '' || $user['idEntrepot'] == 0) ? "" : "disabled"; ?> <?= ($proforma['terminerProforma'] == 1 || $proforma['validerProforma'] == 1) ? "disabled" : ""; ?>><i class="glyphicon glyphicon-edit"></i></button>
                          </td>
                        </tr>
          ...
          function paginate_function($item_per_page, $current_page, $total_records, $total_pages, $dateString2)
          {
            ...
            if ($total_pages > 0 && $total_pages != 1 && $current_page <= $total_pages) { //verify total pages and current page number
              ...
              if ($current_page == 1) {
                # code...
                $pagination .= '<li class="page-item disabled"><a href="proformaClient.php?page=1&day=' . $dateString2 . '" data-page="1" class="page-link"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></a>
          </li>';
              } else {
                # code...
                $pagination .= '<li class="page-item"><a href="proformaClient.php?page=' . ($current_page - 1) . '&day=' . $dateString2 . '" data-page="' . ($current_page - 1) . '" class="page-link"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></a></li>';
              }
              ...
              if ($total_pages <= 5) {
                for ($page = 1; $page <= $total_pages; $page++) {
                  if ($current_page == $page) {
                    # code...
                    $pagination .= '<li class="page-item page active"><a href="proformaClient.php?page=' . $page . '&day=' . $dateString2 . '" data-page="' . $page . '" class="page-link">' . $page . '</a></li>';
                  } else {
                    # code...
                    $pagination .= '<li class="page-item page"><a href="proformaClient.php?page=' . $page . '&day=' . $dateString2 . '" data-page="' . $page . '" class="page-link">' . $page . '</a></li>';
                  }
                }
              } else {
                if ($current_page == 1) {
                  # code...
                  $pagination .= '<li class="page-item active"><a href="proformaClient.php?page=1&day=' . $dateString2 . '" data-page="1" class="page-link">1</a></li>';
                } else {
                  # code...
                  $pagination .= '<li class="page-item"><a href="proformaClient.php?page=1&day=' . $dateString2 . '" data-page="1" class="page-link">1</a></li>';
                }
                ...
                if ($current_page == $total_pages) {
                  # code...
                  $pagination .= '<li class="page-item page active"><a href="proformaClient.php?page=' . $page . '&day=' . $dateString2 . '" data-page="' . $total_pages . '" class="page-link">' . $total_pages . '</a></li>';
                } else {
                  # code...
                  $pagination .= '<li class="page-item page"><a href="proformaClient.php?page=' . $total_pages . '&day=' . $dateString2 . '" data-page="' . $total_pages . '" class="page-link">' . $total_pages . '</a></li>';
                }
              }
              if ($current_page == $total_pages) {
                # code...
                $pagination .= '<li class="page-item disabled"><a href="proformaClient.php?page=' . $total_pages . '&day=' . $dateString2 . '" data-page="' . $total_pages . '" class="page-link"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></li>';
              } else {
                # code...
                $pagination .= '<li class="page-item"><a href=" href="proformaClient.php?page=' . ($current_page + 1) . '&day=' . $dateString2 . '" " data-page="' . ($current_page + 1) . '" class="page-link"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></li>';
              }
