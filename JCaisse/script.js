...
$(document).ready(function() { 
    ...
    $(document).ready(function() {
        ...
        $("#listeDesClientsEnLigne").load( "ajax/listerClientEnLigneAjax.php",{"operation":1,"nbEntreeEnLigne":nbEntreeEnLigne,"query":"","cb":""}); //load initial records
        ...
        // $("#listeDesClientsEnLigne").on( "click", function (e){
            ...
            if (query.length == 0) {
                ...
                $("#listeDesClientsEnLigne" ).load( "ajax/listerClientEnLigneAjax.php",{"page":page,"operation":1,"nbEntreeEnLigne":nbEntreeEnLigne,"query":"","cb":""}, function(){ //get content from PHP page
                ...
                $("#listeDesClientsEnLigne" ).load( "ajax/listerClientEnLigneAjax.php",{"page":page,"operation":1,"nbEntreeEnLigne":nbEntreeEnLigne,"query":query,"cb":""}, function(){ //get content from PHP page
    ...
    $(document).ready(function() {
        ...
        $('#searchInputEnLigne').on("keyup", function(e) {
            ...
            if (keycode == '13') {
                ...
                if (query.length > 0) {
                    ...
                    $("#listeDesClientsEnLigne" ).load( "ajax/listerClientEnLigneAjax.php",{"operation":3,"nbEntreeEnLigne":nbEntreeEnLigne,"query":query,"cb":tl}); //load initial records

                }else{

                    $("#listeDesClientsEnLigne" ).load( "ajax/listerClientEnLigneAjax.php",{"operation":3,"nbEntreeEnLigne":nbEntreeEnLigne,"query":"","cb":tl}); //load initial records
        ...
        $('#nbEntreeEnLigne').on("change", function(e) {
            ...
            if (query.length == 0) {
                ...
                $("#listeDesClientsEnLigne" ).load( "ajax/listerClientEnLigneAjax.php",{"operation":4,"nbEntreeEnLigne":nbEntreeEnLigne,"query":"","cb":""}); //load initial records

                    

            }else{

                $("#listeDesClientsEnLigne" ).load( "ajax/listerClientEnLigneAjax.php",{"operation":4,"nbEntreeEnLigne":nbEntreeEnLigne,"query":query,"cb":""}); //load initial records
    ...
    $(document).ready(function() {    
        ...
        $("#btnVenteParDate").on( "click", function (e){
            ...
            // $(".loading-gif").show();
            $("#results_vente_par_date" ).load( "ajax/listerVenteParDateAjax.php",{"operation":1,"page":pageActu,"nbEntreeVD":nbEntreeVD,"query":"","cb":""}, function(data){ //get content from PHP page
        ...
        // $("#results_vente_par_date").on( "click", function (e){
            ...
            $("#results_vente_par_date" ).load( "ajax/listerVenteParDateAjax.php",{"page":page,"operation":1,"nbEntreeVD":nbEntreeVD,"query":"","cb":""}, function(data){ //get content from PHP page
...
$(document).ready(function() {    
    ...
    $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"operation":1,"nbEntreeTrans":nbEntreeTrans,"query":"","cb":""}, function(data){ //get content from PHP page
    ...
    // $("#resultsTransfert").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"page":page,"operation":1,"nbEntreeTrans":nbEntreeTrans,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"page":page,"operation":1,"nbEntreeTrans":nbEntreeTrans,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputTrans').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"operation":3,"nbEntreeTrans":nbEntreeTrans,"query":query,"cb":t}); //load initial records

            }else{

                $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"operation":3,"nbEntreeTrans":nbEntreeTrans,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeTrans').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"operation":4,"nbEntreeTrans":nbEntreeTrans,"query":"","cb":""}); //load initial records

                

        }else{

            $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"operation":4,"nbEntreeTrans":nbEntreeTrans,"query":query,"cb":""}); //load initial records
    ...
    //    alert(12)
        ...
        if (triTrans == 1) {
            ...
            if (query.length == 0) {
                ...
                $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"operation":2,"nbEntreeTrans":nbEntreeTrans,"tri":1, "query":"","cb":""}); //load initial records

                    

            }else{

                $("#resultsTransfert" ).load( "ajax/listerTransfertAjax.php",{"operation":2,"nbEntreeTrans":nbEntreeTrans,"tri":1, "query":query,"cb":""}); //load initial records
            ...
            if (query.length == 0) {
                ...
                $("#resultsTransfert").load( "ajax/listerTransfertAjax.php",{"operation":2,"nbEntreeTrans":nbEntreeTrans,"tri":0, "query":"","cb":""}); //load initial records

                    

            }else{

                $("#resultsTransfert").load( "ajax/listerTransfertAjax.php",{"operation":2,"nbEntreeTrans":nbEntreeTrans,"tri":0, "query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#INVENTAIREJOUR3").on( "click", function (e){
        $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":1,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"query":"","cb":""}, function(data){ //get content from PHP page
            // alert(data)
            console.log(data)
    ...
    // $("#resultsInventairesJour3").on( "click", function (e){
        ...
        if (query3.length == 0) {
            ...
            $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"page":page,"operation":1,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"page":page,"operation":1,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"query":query3,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputInvJour3').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query3.length > 0) {
                ...
                $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":3,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"query":query3,"cb":t}); //load initial records

            }else{

                $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":3,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeInvJour3').on("change", function(e) {
        ...
        if (query3.length == 0) {
            ...
            $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":4,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"query":"","cb":""}); //load initial records

                

        }else{

            $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":4,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"query":query3,"cb":""}); //load initial records
    ...
    //    alert(12)
        ...
        if (triBIJour3 == 1) {
            ...
            if (query3.length == 0) {
                ...
                $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"tri":1, "query":"","cb":""}); //load initial records

                    

            }else{

                $("#resultsInventairesJour3" ).load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"tri":1, "query":query3,"cb":""}); //load initial records
            ...
            if (query3.length == 0) {
                ...
                $("#resultsInventairesJour3").load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"tri":0, "query":"","cb":""}); //load initial records

                    

            }else{

                $("#resultsInventairesJour3").load( "ajax/listerStock-InventaireJour3Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour3,"idEntrepotInventaire":idEntrepotInventaire,"tri":0, "query":query3,"cb":""}); //load initial records
...
// alert(5555)
    ...
    $("#INVENTAIREJOUR2").on( "click", function (e){
        // alert(2565)
        $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":1,"nbEntreeInvJour":nbEntreeInvJour2,"query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}, function(data){ //get content from PHP page
            // alert(data)
            console.log(data)
            $(".loading-divI").hide(); //once done, hide loading element
    ...
    // $("#resultsInventairesJour2").on( "click", function (e){
        ...
        if (query2.length == 0) {
            ...
            $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"page":page,"operation":1,"nbEntreeInvJour":nbEntreeInvJour2,"query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}, function(){ //get content from PHP page
            ...
            $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"page":page,"operation":1,"nbEntreeInvJour":nbEntreeInvJour2,"query":query2,"cb":"","idEntrepotInventaire":idEntrepotInventaire}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputInvJour2').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query2.length > 0) {
                ...
                $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":3,"nbEntreeInvJour":nbEntreeInvJour2,"query":query2,"cb":t,"idEntrepotInventaire":idEntrepotInventaire}); //load initial records

            }else{

                $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":3,"nbEntreeInvJour":nbEntreeInvJour2,"query":"","cb":t,"idEntrepotInventaire":idEntrepotInventaire}); //load initial records
    ...
    $('#nbEntreeInvJour2').on("change", function(e) {
        ...
        if (query2.length == 0) {
            ...
            $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":4,"nbEntreeInvJour":nbEntreeInvJour2,"query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records

                

        }else{

            $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":4,"nbEntreeInvJour":nbEntreeInvJour2,"query":query2,"cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records
    ...
    //    alert(12)
        ...
        if (triBIJour2 == 1) {
            ...
            if (query2.length == 0) {
                ...
                $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour2,"tri":1, "query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records

                    

            }else{

                $("#resultsInventairesJour2" ).load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour2,"tri":1, "query":query2,"cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records
            ...
            if (query2.length == 0) {
                ...
                $("#resultsInventairesJour2").load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour2,"tri":0, "query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records

                    

            }else{

                $("#resultsInventairesJour2").load( "ajax/listerStock-InventaireJour2Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour2,"tri":0, "query":query2,"cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records
...
$(document).ready(function() {
    ...
    $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":1,"nbEntreeInvJour":nbEntreeInvJour1,"query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}, function(data){ //get content from PHP page
        // alert(data)
        console.log(data)
        $(".loading-divI").hide(); //once done, hide loading element
    ...
    // $("#resultsInventairesJour1").on( "click", function (e){
        ...
        if (query1.length == 0) {
            ...
            $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"page":page,"operation":1,"nbEntreeInvJour":nbEntreeInvJour1,"query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}, function(){ //get content from PHP page
            ...
            $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"page":page,"operation":1,"nbEntreeInvJour":nbEntreeInvJour1,"query":query1,"cb":"","idEntrepotInventaire":idEntrepotInventaire}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputInvJour1').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query1.length > 0) {
                ...
                $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":3,"nbEntreeInvJour":nbEntreeInvJour1,"query":query1,"cb":t,"idEntrepotInventaire":idEntrepotInventaire}); //load initial records

            }else{

                $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":3,"nbEntreeInvJour":nbEntreeInvJour1,"query":"","cb":t,"idEntrepotInventaire":idEntrepotInventaire}); //load initial records
    ...
    $('#nbEntreeInvJour1').on("change", function(e) {
        ...
        if (query1.length == 0) {
            ...
            $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":4,"nbEntreeInvJour":nbEntreeInvJour1,"query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records

                

        }else{

            $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":4,"nbEntreeInvJour":nbEntreeInvJour1,"query":query1,"cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records
    ...
    //    alert(12)
        ...
        if (triBIJour1 == 1) {
            ...
            if (query1.length == 0) {
                ...
                $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour1,"tri":1, "query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records

                    

            }else{

                $("#resultsInventairesJour1" ).load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour1,"tri":1, "query":query1,"cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records
            ...
            if (query1.length == 0) {
                ...
                $("#resultsInventairesJour1").load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour1,"tri":0, "query":"","cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records

                    

            }else{

                $("#resultsInventairesJour1").load( "ajax/listerStock-InventaireJour1Ajax.php",{"operation":2,"nbEntreeInvJour":nbEntreeInvJour1,"tri":0, "query":query1,"cb":"","idEntrepotInventaire":idEntrepotInventaire}); //load initial records
    ...
    $(document).on("keyup","#produitVenduB", function(e) {
        ...
        if (query.length > 0 || query.length != '') {
            ...
            if (keycode == '13') {
                ...
                $("#venteContent" ).load("ajax/loadContainerAjax.php", {"produit":designation}, function(data){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $("#resultsProductsASE" ).load( "ajax/listeProduit-EntrepotAjax.php",{"operation":1,"nbEntreeASEt":nbEntreeASEt,"query":"","cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
        ...
        var keycode = (e.keyCode ? e.keyCode : e.which);
            ...
            if (keycode == '13') {
                ...
                if (query.length > 0) {
                    ...
                    $("#resultsProductsASE" ).load( "ajax/listeProduit-EntrepotAjax.php",{"operation":3,"nbEntreeASEt":nbEntreeASEt,"query":query,"cb":t}, function(){ //get content from PHP page
                    ...
                    $("#resultsProductsASE" ).load( "ajax/listeProduit-EntrepotAjax.php",{"operation":3,"nbEntreeASEt":nbEntreeASEt,"query":"","cb":t}, function(){ //get content from PHP page
    ...
    $('#nbEntreeASEt').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#resultsProductsASE" ).load( "ajax/listeProduit-EntrepotAjax.php",{"operation":4,"nbEntreeASEt":nbEntreeASEt,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#resultsProductsASE" ).load( "ajax/listeProduit-EntrepotAjax.php",{"operation":4,"nbEntreeASEt":nbEntreeASEt,"query":query,"cb":""}, function(){ //get content from PHP page
    ...
    //    alert(12)
        ...
        if (triASE == 1) {
            ...
            if (query.length == 0) {
                ...
                $("#resultsProductsASE" ).load( "ajax/listeProduit-EntrepotAjax.php",{"operation":2,"nbEntreeASEt":nbEntreeASEt,"tri":1, "query":"","cb":""}, function(){ //get content from PHP page
                ...
                $("#resultsProductsASE" ).load( "ajax/listeProduit-EntrepotAjax.php",{"operation":2,"nbEntreeASEt":nbEntreeASEt,"tri":1, "query":query,"cb":""}, function(){ //get content from PHP page
            ...
            if (query.length == 0) {
                ...
                $("#resultsProductsASE").load( "ajax/listeProduit-EntrepotAjax.php",{"operation":2,"nbEntreeASEt":nbEntreeASEt,"tri":0, "query":"","cb":""}, function(){ //get content from PHP page
                ...
                $("#resultsProductsASE").load( "ajax/listeProduit-EntrepotAjax.php",{"operation":2,"nbEntreeASEt":nbEntreeASEt,"tri":0, "query":query,"cb":""}, function(){ //get content from PHP page
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (tab1[0]=="1") {
                ...
                $("#uniteVente"+ligne+" option[value='"+tab2[0]+"§"+ligne+"§"+pagnet+"§"+quantite+"']").remove()
                $("#uniteVente"+ligne).prepend("<option value='"+tab2[0]+"§"+ligne+"§"+pagnet+"§"+quantite+"' selected='selected'>"+tab2[0]+"</option>");

                $("#uniteVente"+ligne+" option[value='"+tab2[0]+"§"+ligne+"§"+pagnet+"§"+quantite+"']").attr("selected", "selected"); 
                ...
                $("#somme_Apayer" + pagnet).text(tab2[1] - $("#val_remise" + pagnet).val());
            }
            console.log(data);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (reste >= 0) {
                ...
                oldDepotTxt = $("#depot"+ligne+" option[value='"+oldDepot+"§"+ligne+"§"+pagnet+"']").text()
                $("#depot"+ligne+" option[value='"+oldDepot+"§"+ligne+"§"+pagnet+"']").remove()

                $("#depot"+ligne).prepend("<option value='"+oldDepot+"§"+ligne+"§"+pagnet+"' selected='selected'>"+oldDepotTxt+"</option>");
    ...
    $("#btn_aj_Paiement").click(function() {
        ...
        if(refTransf.length >0 && numTel.length >0){
            ...
            dataType: "text"
               ...
               alert("Les champs Référence du Transfert et numéro téléphone ne doivent pas etre vide");
         }
    });
    ...
    $("#btn_aj_PaiementWave").click(function() {
        ...
        if(refTransf.length >0 && numTel.length >0){
            ...
            dataType: "text"
               ...
               alert("Les champs ID de transaction et numéro téléphone ne doivent pas etre vide");
         }
            ...
            if (result[0] == 1) {
                ...
                $("#tablePanier"+panier+' tr').each(function(row, tr) {
                    ...
                    if (reference != '' && reference == result[2]) {
                        ...
                        $("#somme_Apayer" + panier).text(result[6] - $("#val_remise" + panier).val() - ((result[6] * result[7]) / 100));
        ...
        success: function(data) {
            ...
            if (tab[0] == 1) {
                ...
                if (tab[10]!=null && tab[10]!='') {
                    ...
                    $("#plafondSelect_Mdf option[value='1']").attr("selected", "selected");
                    $(".plafondInput").show();

                } else {
                    $('#plafondCL_Mdf').val(null);
                    $("#plafondSelect_Mdf option[value='0']").attr("selected", "selected");
                    $(".plafondInput").hide();
                }
                            ...
                            if (result[0] == 1) {
                                ...
                                if (result[7] == 9) {
                                    ...
                                    if(result[7]!="Article" && result[7]!="article"){
                                        ...
                                        "<td><input class='form-control filedReadonly"+idPanier+"' id='ligne"+result[5]+"' onkeyup='modif_QuantiteP(this.value," + result[5] + "," + idPanier + "," + result[8]+" )' value='1' style='width: 30%' type='number' ></input></td>" +

                                        "<td>" +

                                            "<select id='uniteVente"+result[5]+"' class='form-control filedReadonly"+idPanier+"' onchange='modif_UniteStock(this.value)' >" +
                                        ...
                                        "<button type='button' onclick='retour_Produit(" + result[5] + "," + idPanier + ")'	 class='btn btn-warning pull-right btnRtrAvant"+idPanier+"'>" +
                                        ...
                                        "<td><input class='form-control filedReadonly"+idPanier+"' id='ligne"+result[5]+"' onkeyup='modif_QuantiteP(this.value," + result[5] + "," + idPanier + ",1)' value='1' style='width: 30%' type='number' ></input></td>" +
                            ...
                            if (result[0] == 2) {
                                ...
                                $("#tablePanier"+idPanier+" tr").each(function(row, tr) {
                                    ...
                                    if (reference != '' && reference == result[2]) {
                                        ...
                                        $(tr).find('td:eq(1)').html("<input class='form-control filedReadonly"+idPanier+"' id='ligne"+result[5]+"' onkeyup='modif_QuantiteP(this.value," + result[5] + "," + idPanier + ",1)' value='" + result[9] + "' style='width: 30%' type='number' ></input>");
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (result[0] == 1) {
                                ...
                                $("#somme_Apayer" + idPanier).text(result[6] - $("#val_remise" + idPanier).val() - ((result[6] * result[7]) / 100) );
                            ...
                            if (result[0] == 2) {
                                ...
                                $("#tablePanier"+idPanier+" tr").each(function(row, tr) {
                                    ...
                                    if (reference != '' && reference == result[2]) {
                                        ...
                                        $("#somme_Apayer" + idPanier).text(result[6] - $("#val_remise" + idPanier).val() - ((result[6] * result[8]) / 100) );
                    ...
                    success: function(data) {
                        ...
                        if (result[0] == 1) {
                            ...
                            if ($("#sessioninfosup").val()==1) {
                                infoSupp="<button type='button' data-idligne='"+result[5]+"' data-toggle='modal' data-target='#add_infoSup_modal' class='btn btn-info pull-right btn_add_infoSup1'>" +
                            ...
                            var ligne = "<tr>" +
                                ...
                                "<td><input class='form-control' id='quantite"+result[5]+"' onkeyup='modif_QuantiteET(this.value," + result[5] + "," + idPanier + "," + result[8]+" )' value='1' style='width: 100%' type='number' ></input></td>" +
                                ...
                                "<td><input class='form-control' id='prixunitevente"+result[5]+"' onkeyup='modif_Prix(this.value," + result[5] + "," + idPanier + ")' value='" + result[4] + "' style='width: 100%' type='number'></input></td>" +
                            ...
                            $("#somme_Apayer" + idPanier).text(result[6] - $("#val_remise" + idPanier).val() - ((result[6] * result[13]) / 100) );
                        ...
                        if(result[0]== 5) {
                            ...
                            "<td><input class='form-control' id='prixunitevente"+result[5]+"' onkeyup='modif_Prix(this.value," + result[5] + "," + idPanier + ")' value='" + result[4] + "' style='width: 70%' type='number'></input></td>" +
                            ...
                            $("#somme_Apayer" + idPanier).text(result[6] - $("#val_remise" + idPanier).val() - ((result[6] * result[10]) / 100) );
            ...
            if (restant >= 0) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#somme_Apayer" + pagnet).text(result[0] - $("#val_remise" + pagnet).val() - ((result[0] * result[1]) / 100));
...
function ajt_Stock(designation) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(tab[0]==1){
                var ligne = "<tr><td>0</td><td>" + tab[1] + "</td><td>" + tab[2] + "</td><td>" + quantite + "</td><td>" + uniteStock + "</td><td>" + tab[4] + "</td><td>" + tab[5] + "</td><td>" + tab[6] + "</td><td>" + tab[7] + "</td><td>En cours ...</td></tr>";
...
function modif_Remise(remise, pagnet) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#somme_Apayer" + pagnet).text(tab[0] - remise - ((tab[0] * tab[2]) / 100));
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (tab[0] == 1) {
                    ...
                    var ligne = "<tr><td>0</td><td>" + tab[1] + "</td><td>"+tab[2]+' % - '+tab[5]+' % - '+tab[6]+' % - '+tab[7]+' % - '+tab[8]+" % </td><td>" + tab[3] + "</td><td>" + tab[4] + "</td><td>0</td><td>En cours ...</td></tr>";
                ...
                if (tab[0] == 1) {
                    ...
                    $('#tableMutuelle tr').each(function(row, tr) {
                        ...
                        if (mutuelle != '' && mutuelle == ordre) {
                            ...
                            $(tr).find('td:eq(2)').html(tab[3]+' % - '+tab[7]+' % - '+tab[8]+' % - '+tab[9]+' % - '+tab[10]+' %');
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (tab[0] == 1) {
                ...
                $('#tauxMT_Spm').val(tab[3]+' % - '+tab[6]+' % - '+tab[7]+' % - '+tab[8]+' % - '+tab[9]+' %');
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (tab1[0] == 1) {
                ...
                $('.multiMutuelle').append("<option value='"+tab1[1]+"§"+tab1[7]+"§"+tab1[8]+"'>"+tab1[1]+"  %</option>");
                if(tab1[3]!=0){
                    $('.multiMutuelle').append("<option value='"+tab1[3]+"§"+tab1[7]+"§"+tab1[8]+"'>"+tab1[3]+"  %</option>");
                }
                if(tab1[4]!=0){
                    $('.multiMutuelle').append("<option value='"+tab1[4]+"§"+tab1[7]+"§"+tab1[8]+"'>"+tab1[4]+"  %</option>");
                }
                if(tab1[5]!=0){
                    $('.multiMutuelle').append("<option value='"+tab1[5]+"§"+tab1[7]+"§"+tab1[8]+"'>"+tab1[5]+"  %</option>");
                }
                if(tab1[6]!=0){
                    $('.multiMutuelle').append("<option value='"+tab1[6]+"§"+tab1[7]+"§"+tab1[8]+"'>"+tab1[6]+"  %</option>");
                }
                ...
                success: function(data) {
                    ...
                    if (result[0] == 1) {
                        ...
                        var ligne = "<tr>" +
                            ...
                            "<td><input class='form-control filedReadonly_E"+idPanier+"' id='quantite"+result[5]+"' onkeyup='modif_QuantiteET(this.value," + result[5] + "," + idPanier + "," + result[8]+" )' value='1' style='width: 100%' type='number' ></input></td>" +

                            "<td><select id='uniteVente"+result[5]+"' class='form-control filedReadonly_ES"+idPanier+"' onchange='modif_UniteStockET(this.value)' >" +
                            ...
                            "<td><input class='form-control filedReadonly_E"+idPanier+"' id='prixunitevente"+result[5]+"' onkeyup='modif_Prix(this.value," + result[5] + "," + idPanier + ")' value='" + result[4] + "' style='width: 100%' type='number'></input></td>" +

                            "<td><select id='depot"+result[5]+"' class='form-control filedReadonly_ES"+idPanier+"' onchange='modif_Depot(this.value)' >" +
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            tab1 = data.split('<>');
                ...
                $("#somme_Apayer" + pagnet).text(tab1[0] - $("#val_remise" + pagnet).val() - ((tab1[0] * tab1[1]) / 100));
...
$(document).ready(function() {
    ...
    //     e.preventDefault();
        ...
        $("#listeDesAlertesSeuil_0" ).load( "ajax/alerteSeuil_0Ajax.php",{"operation":1,"nbEntreeAlerteSeuil_0":nbEntreeAlerteSeuil,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesSeuil").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesSeuil_0" ).load( "ajax/alerteSeuil_0Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteSeuil_0":nbEntreeAlerteSeuil,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesSeuil_0" ).load( "ajax/alerteSeuil_0Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteSeuil_0":nbEntreeAlerteSeuil,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $("#toggleSEUIL_1").on( "click", function (e){
        ...
        $(".loading-gif").show(); //show loading element
        $("#listeDesAlertesSeuil_1" ).load( "ajax/alerteSeuil_1Ajax.php",{"operation":1,"nbEntreeAlerteSeuil_1":nbEntreeAlerteSeuil,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesSeuil").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesSeuil_1" ).load( "ajax/alerteSeuil_1Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteSeuil_1":nbEntreeAlerteSeuil,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesSeuil_1" ).load( "ajax/alerteSeuil_1Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteSeuil_1":nbEntreeAlerteSeuil,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $("#toggleSEUIL_2").on( "click", function (e){
        ...
        $("#listeDesAlertesSeuil_2" ).load( "ajax/alerteSeuil_2Ajax.php",{"operation":1,"nbEntreeAlerteSeuil_2":nbEntreeAlerteSeuil,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesSeuil").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesSeuil_2" ).load( "ajax/alerteSeuil_2Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteSeuil_2":nbEntreeAlerteSeuil,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesSeuil_2" ).load( "ajax/alerteSeuil_2Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteSeuil_2":nbEntreeAlerteSeuil,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteSeuil_0').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesSeuil_0" ).load( "ajax/alerteSeuil_0Ajax.php",{"operation":3,"nbEntreeAlerteSeuil_0":nbEntreeAlerteSeuil,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesSeuil_0" ).load( "ajax/alerteSeuil_0Ajax.php",{"operation":3,"nbEntreeAlerteSeuil_0":nbEntreeAlerteSeuil,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteSeuil_0').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesSeuil_0" ).load( "ajax/alerteSeuil_0Ajax.php",{"operation":4,"nbEntreeAlerteSeuil_0":nbEntreeAlerteSeuil,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesSeuil_0" ).load( "ajax/alerteSeuil_0Ajax.php",{"operation":4,"nbEntreeAlerteSeuil_0":nbEntreeAlerteSeuil,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteSeuil_1').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesSeuil_1" ).load( "ajax/alerteSeuil_1Ajax.php",{"operation":3,"nbEntreeAlerteSeuil_1":nbEntreeAlerteSeuil,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesSeuil_1" ).load( "ajax/alerteSeuil_1Ajax.php",{"operation":3,"nbEntreeAlerteSeuil_1":nbEntreeAlerteSeuil,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteSeuil_1').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesSeuil_1" ).load( "ajax/alerteSeuil_1Ajax.php",{"operation":4,"nbEntreeAlerteSeuil_1":nbEntreeAlerteSeuil,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesSeuil_1" ).load( "ajax/alerteSeuil_1Ajax.php",{"operation":4,"nbEntreeAlerteSeuil_1":nbEntreeAlerteSeuil,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteSeuil_2').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesSeuil_2" ).load( "ajax/alerteSeuil_2Ajax.php",{"operation":3,"nbEntreeAlerteSeuil_2":nbEntreeAlerteSeuil,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesSeuil_2" ).load( "ajax/alerteSeuil_2Ajax.php",{"operation":3,"nbEntreeAlerteSeuil_2":nbEntreeAlerteSeuil,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteSeuil_2').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesSeuil_2" ).load( "ajax/alerteSeuil_2Ajax.php",{"operation":4,"nbEntreeAlerteSeuil_2":nbEntreeAlerteSeuil,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesSeuil_2" ).load( "ajax/alerteSeuil_2Ajax.php",{"operation":4,"nbEntreeAlerteSeuil_2":nbEntreeAlerteSeuil,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    //     e.preventDefault();
        ...
        $("#listeDesAlertesDepot_0" ).load( "ajax/alerteDepot_0Ajax.php",{"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_0,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesSeuil").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesDepot_0" ).load( "ajax/alerteDepot_0Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_0,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesDepot_0" ).load( "ajax/alerteDepot_0Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_0,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $("#toggleDepot1").on("click", function (e){
        ...
        $(".loading-gif").show(); //show loading element
        $("#listeDesAlertesDepot_1" ).load( "ajax/alerteDepot_1Ajax.php",{"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_1,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesSeuil").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesDepot_1" ).load( "ajax/alerteDepot_1Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_1,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesDepot_1" ).load( "ajax/alerteDepot_1Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_1,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $("#toggleDepot2").on( "click", function (e){
        ...
        $("#listeDesAlertesDepot_2" ).load( "ajax/alerteDepot_2Ajax.php",{"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_2,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesSeuil").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesDepot_2" ).load( "ajax/alerteDepot_2Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_2,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesDepot_2" ).load( "ajax/alerteDepot_2Ajax.php",{"page":page,"operation":1,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_2,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteDepot_0').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesDepot_0" ).load( "ajax/alerteDepot_0Ajax.php",{"operation":3,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_0,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesDepot_0" ).load( "ajax/alerteDepot_0Ajax.php",{"operation":3,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_0,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteDepot_0').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesDepot_0" ).load( "ajax/alerteDepot_0Ajax.php",{"operation":4,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_0,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesDepot_0" ).load( "ajax/alerteDepot_0Ajax.php",{"operation":4,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_0,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteDepot_1').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesDepot_1" ).load( "ajax/alerteDepot_1Ajax.php",{"operation":3,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_1,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesDepot_1" ).load( "ajax/alerteDepot_1Ajax.php",{"operation":3,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_1,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteDepot_1').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesDepot_1" ).load( "ajax/alerteDepot_1Ajax.php",{"operation":4,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_1,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesDepot_1" ).load( "ajax/alerteDepot_1Ajax.php",{"operation":4,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_1,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteDepot_2').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesDepot_2" ).load( "ajax/alerteDepot_2Ajax.php",{"operation":3,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_2,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesDepot_2" ).load( "ajax/alerteDepot_2Ajax.php",{"operation":3,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_2,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteDepot_2').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesDepot_2" ).load( "ajax/alerteDepot_2Ajax.php",{"operation":4,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_2,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesDepot_2" ).load( "ajax/alerteDepot_2Ajax.php",{"operation":4,"nbEntreeAlerteDepot":nbEntreeAlerteDepot_2,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    //     e.preventDefault();
        ...
        $("#listeDesAlertesCmdes").load( "ajax/alerteCommandeAjax.php",{"operation":1,"nbEntreeAlerteCmd":nbEntreeAlerteCmd,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesCmdes").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesCmdes" ).load( "ajax/alerteCommandeAjax.php",{"page":page,"operation":1,"nbEntreeAlerteCmd":nbEntreeAlerteCmd,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesCmdes" ).load( "ajax/alerteCommandeAjax.php",{"page":page,"operation":1,"nbEntreeAlerteCmd":nbEntreeAlerteCmd,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteCmd').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesCmdes" ).load( "ajax/alerteCommandeAjax.php",{"operation":3,"nbEntreeAlerteCmd":nbEntreeAlerteCmd,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesCmdes" ).load( "ajax/alerteCommandeAjax.php",{"operation":3,"nbEntreeAlerteCmd":nbEntreeAlerteCmd,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteCmd').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesCmdes" ).load( "ajax/alerteCommandeAjax.php",{"operation":4,"nbEntreeAlerteCmd":nbEntreeAlerteCmd,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesCmdes" ).load( "ajax/alerteCommandeAjax.php",{"operation":4,"nbEntreeAlerteCmd":nbEntreeAlerteCmd,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#toggleEXPIRATION").on( "click", function (e){
        ...
        $("#listeDesAlertesExpirations" ).load( "ajax/alerteExpirationAjax.php",{"operation":1,"nbEntreeAlerteExp":nbEntreeAlerteExp,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesAlertesExpirations").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesExpirations" ).load( "ajax/alerteExpirationAjax.php",{"page":page,"operation":1,"nbEntreeAlerteExp":nbEntreeAlerteExp,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesAlertesExpirations" ).load( "ajax/alerteExpirationAjax.php",{"page":page,"operation":1,"nbEntreeAlerteExp":nbEntreeAlerteExp,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputAlerteExp').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesAlertesExpirations" ).load( "ajax/alerteExpirationAjax.php",{"operation":3,"nbEntreeAlerteExp":nbEntreeAlerteExp,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesAlertesExpirations" ).load( "ajax/alerteExpirationAjax.php",{"operation":3,"nbEntreeAlerteExp":nbEntreeAlerteExp,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeAlerteExp').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesAlertesExpirations" ).load( "ajax/alerteExpirationAjax.php",{"operation":4,"nbEntreeAlerteExp":nbEntreeAlerteExp,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesAlertesExpirations" ).load( "ajax/alerteExpirationAjax.php",{"operation":4,"nbEntreeAlerteExp":nbEntreeAlerteExp,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#toggleECHEANCE").on( "click", function (e){
        ...
        $("#listeDesEcheancesFournisseurs" ).load( "ajax/alerteEcheance_FournisseurAjax.php",{"operation":1,"nbEntreeEcheanceFnr":nbEntreeEcheanceFnr,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    $("#listeDesEcheancesFournisseurs").on( "click", ".pagination a", function (e){
    ...
    // $("#listeDesEcheancesFournisseurs").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesEcheancesFournisseurs" ).load( "ajax/alerteEcheance_FournisseurAjax.php",{"page":page,"operation":1,"nbEntreeEcheanceFnr":nbEntreeEcheanceFnr,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesEcheancesFournisseurs" ).load( "ajax/alerteEcheance_FournisseurAjax.php",{"page":page,"operation":1,"nbEntreeEcheanceFnr":nbEntreeEcheanceFnr,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputEcheanceFnr').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesEcheancesFournisseurs" ).load( "ajax/alerteEcheance_FournisseurAjax.php",{"operation":3,"nbEntreeEcheanceFnr":nbEntreeEcheanceFnr,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesEcheancesFournisseurs" ).load( "ajax/alerteEcheance_FournisseurAjax.php",{"operation":3,"nbEntreeEcheanceFnr":nbEntreeEcheanceFnr,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeEcheanceFnr').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesEcheancesFournisseurs" ).load( "ajax/alerteEcheance_FournisseurAjax.php",{"operation":4,"nbEntreeEcheanceFnr":nbEntreeEcheanceFnr,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesEcheancesFournisseurs" ).load( "ajax/alerteEcheance_FournisseurAjax.php",{"operation":4,"nbEntreeEcheanceFnr":nbEntreeEcheanceFnr,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#toggleECHEANCE").on( "click", function (e){
        ...
        $("#listeDesEcheancesClients" ).load( "ajax/alerteEcheance_ClientAjax.php",{"operation":1,"nbEntreeEcheanceCli":nbEntreeEcheanceCli,"query":"","cb":""}, function(){ //get content from PHP page
    ...
    // $("#listeDesEcheancesClients").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesEcheancesClients" ).load( "ajax/alerteEcheance_ClientAjax.php",{"page":page,"operation":1,"nbEntreeEcheanceCli":nbEntreeEcheanceCli,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesEcheancesClients" ).load( "ajax/alerteEcheance_ClientAjax.php",{"page":page,"operation":1,"nbEntreeEcheanceCli":nbEntreeEcheanceCli,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputEcheanceCli').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesEcheancesClients" ).load( "ajax/alerteEcheance_ClientAjax.php",{"operation":3,"nbEntreeEcheanceCli":nbEntreeEcheanceCli,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesEcheancesClients" ).load( "ajax/alerteEcheance_ClientAjax.php",{"operation":3,"nbEntreeEcheanceCli":nbEntreeEcheanceCli,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeEcheanceCli').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesEcheancesClients" ).load( "ajax/alerteEcheance_ClientAjax.php",{"operation":4,"nbEntreeEcheanceCli":nbEntreeEcheanceCli,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesEcheancesClients" ).load( "ajax/alerteEcheance_ClientAjax.php",{"operation":4,"nbEntreeEcheanceCli":nbEntreeEcheanceCli,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#listeDesClients").load( "ajax/listerClientAjax.php",{"operation":1,"nbEntreeCli":nbEntreeCli,"query":"","cb":""}); //load initial records
    ...
    // $("#listeDesClients").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesClients" ).load( "ajax/listerClientAjax.php",{"page":page,"operation":1,"nbEntreeCli":nbEntreeCli,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesClients" ).load( "ajax/listerClientAjax.php",{"page":page,"operation":1,"nbEntreeCli":nbEntreeCli,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputCli').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesClients" ).load( "ajax/listerClientAjax.php",{"operation":3,"nbEntreeCli":nbEntreeCli,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesClients" ).load( "ajax/listerClientAjax.php",{"operation":3,"nbEntreeCli":nbEntreeCli,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeCli').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesClients" ).load( "ajax/listerClientAjax.php",{"operation":4,"nbEntreeCli":nbEntreeCli,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesClients" ).load( "ajax/listerClientAjax.php",{"operation":4,"nbEntreeCli":nbEntreeCli,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#listeDesDepots").load( "ajax/listerClientDepotAjax.php",{"operation":1,"nbEntreeDepot":nbEntreeDepot,"query":"","cb":""}); //load initial records
    ...
    // $("#listeDesDepots").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesDepots" ).load( "ajax/listerClientDepotAjax.php",{"page":page,"operation":1,"nbEntreeDepot":nbEntreeDepot,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesDepots" ).load( "ajax/listerClientDepotAjax.php",{"page":page,"operation":1,"nbEntreeDepot":nbEntreeDepot,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputDepot').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesDepots" ).load( "ajax/listerClientDepotAjax.php",{"operation":3,"nbEntreeDepot":nbEntreeDepot,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesDepots" ).load( "ajax/listerClientDepotAjax.php",{"operation":3,"nbEntreeDepot":nbEntreeDepot,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeDepot').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesDepots" ).load( "ajax/listerClientDepotAjax.php",{"operation":4,"nbEntreeDepot":nbEntreeDepot,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesDepots" ).load( "ajax/listerClientDepotAjax.php",{"operation":4,"nbEntreeDepot":nbEntreeDepot,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#listeDesDettes").load( "ajax/listerClientDetteAjax.php",{"operation":1,"nbEntreeDette":nbEntreeDette,"query":"","cb":""}); //load initial records
    ...
    // $("#listeDesDettes").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeDesDettes" ).load( "ajax/listerClientDetteAjax.php",{"page":page,"operation":1,"nbEntreeDette":nbEntreeDette,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeDesDettes" ).load( "ajax/listerClientDetteAjax.php",{"page":page,"operation":1,"nbEntreeDette":nbEntreeDette,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputDette').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeDesDettes" ).load( "ajax/listerClientDetteAjax.php",{"operation":3,"nbEntreeDette":nbEntreeDette,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeDesDettes" ).load( "ajax/listerClientDetteAjax.php",{"operation":3,"nbEntreeDette":nbEntreeDette,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreeDette').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeDesDettes" ).load( "ajax/listerClientDetteAjax.php",{"operation":4,"nbEntreeDette":nbEntreeDette,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeDesDettes" ).load( "ajax/listerClientDetteAjax.php",{"operation":4,"nbEntreeDette":nbEntreeDette,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#listeClientPersonnels").load( "ajax/listerClientPersonnelAjax.php",{"operation":1,"nbEntreePersonnel":nbEntreePersonnel,"query":"","cb":""}); //load initial records
    ...
    // $("#listeClientPersonnels").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeClientPersonnels" ).load( "ajax/listerClientPersonnelAjax.php",{"page":page,"operation":1,"nbEntreePersonnel":nbEntreePersonnel,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeClientPersonnels" ).load( "ajax/listerClientPersonnelAjax.php",{"page":page,"operation":1,"nbEntreePersonnel":nbEntreePersonnel,"query":query,"cb":""}, function(){ //get content from PHP page
...
$(document).ready(function() {
    ...
    $('#searchInputPersonnel').on("keyup", function(e) {
        ...
        if (keycode == '13') {
            ...
            if (query.length > 0) {
                ...
                $("#listeClientPersonnels" ).load( "ajax/listerClientPersonnelAjax.php",{"operation":3,"nbEntreePersonnel":nbEntreePersonnel,"query":query,"cb":t}); //load initial records

            }else{

                $("#listeClientPersonnels" ).load( "ajax/listerClientPersonnelAjax.php",{"operation":3,"nbEntreePersonnel":nbEntreePersonnel,"query":"","cb":t}); //load initial records
    ...
    $('#nbEntreePersonnel').on("change", function(e) {
        ...
        if (query.length == 0) {
            ...
            $("#listeClientPersonnels" ).load( "ajax/listerClientPersonnelAjax.php",{"operation":4,"nbEntreePersonnel":nbEntreePersonnel,"query":"","cb":""}); //load initial records

                

        }else{

            $("#listeClientPersonnels" ).load( "ajax/listerClientPersonnelAjax.php",{"operation":4,"nbEntreePersonnel":nbEntreePersonnel,"query":query,"cb":""}); //load initial records
...
$(document).ready(function() {
    ...
    $("#listeClientArchives").load( "ajax/listerClientArchiverAjax.php",{"operation":1,"nbEntreeArch":nbEntreeArch,"query":"","cb":""}); //load initial records
    ...
    // $("#listeDesDepots").on( "click", function (e){
        ...
        if (query.length == 0) {
            ...
            $("#listeClientArchives" ).load( "ajax/listerClientArchiverAjax.php",{"page":page,"operation":1,"nbEntreeArch":nbEntreeArch,"query":"","cb":""}, function(){ //get content from PHP page
            ...
            $("#listeClientArchives" ).load( "ajax/listerClientArchiv