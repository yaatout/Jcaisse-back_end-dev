$(document).ready(function() {
    ...
    $('#listeStock').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'datatables/bonLivraison_listeStock.php',
            'data':{
              'id' : id
          }
        },
    ...
    $("#btn_lister_Produit").on( "click", function (e){
      ...
      $('#listeProduits').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'datatables/bonLivraison_listeProduits.php'
        },
        "ordering": true,
        "order": [[0, 'desc']],
        'columns': [
          ...
          ajouter_Stock = function (idProduit)  {
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                $('#spn_montant_Total').text(details[11]);
                $('#spn_montant_Bl').text(details[12]);
                $('#spn_montant_Restant').text(details[13]);
        ...
        transferer_Stock= function (idStock)  {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $('#inpt_trsf_Stock_Reference').val(details[1]);
