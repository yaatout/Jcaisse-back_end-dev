$(document).ready(function() {
    ...
    $('#listeStock').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'datatables/gestionStock_listeStock.php'
        },
        'dom': 'Blfrtip',
        "buttons": ['csv','print', 'excel', 'pdf'],
        "ordering": true,
        "order": [[0, 'desc'],[1, 'desc']],
        "lengthMenu": [10, 25, 50, 100, 250, 500, 1000, 5000, 7500],
        'columns': [
          { data: 'idStock' },
          { data: 'idDesignation' },
          { data: 'designation' },
    ...
    $("#btn_lister_Produit").on( "click", function (e){
      ...
      $('#listeProduits').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'datatables/gestionStock_listeProduits.php'
        },
        "ordering": true,
        "order": [[0, 'desc']],
        'columns': [
          ...
          ajouter_Stock = function (idProduit)  {
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                "<td>"+details[8]+"</td>"+
                "<td>"+
                  "<a href='stock.php?iDS="+details[0]+"'><span style='color:green;'>Details</span></a>"+
                "</td>"+
                "</tr>";
