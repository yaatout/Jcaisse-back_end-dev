$(document).ready(function() {
    ...
    $('#listeStock').DataTable({
      ...
      'serverMethod': 'post',
      'ajax': {
          'url':'datatables/gestionStock_listeStock_PH.php'
      },
      'dom': 'Blfrtip',
    ...
    $.ajax({
        url:"calculs/gestionStock_PH.php",
        method:"POST",
        data:{
            operation:'stock',
        },
    ...
    $("#btn_lister_Produit").on( "click", function (e){
      ...
      $('#listeProduits').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'datatables/gestionStock_listeProduits_PH.php'
        },
        "ordering": true,
        "order": [[0, 'desc']],
        'columns': [
          ...
          ajouter_Stock = function (idProduit)  {
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                "<td>"+details[6]+"</td>"+
                "<td>"+
                  "<a href='stock-Pharmacie.php?iDS="+idProduit+"'><span style='color:green;'>Details</span></a>"+
                "</td>"+
                "</tr>";
