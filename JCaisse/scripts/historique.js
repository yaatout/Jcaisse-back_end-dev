...
/** Debut Details Operation Historique */
  ...
  $("#btn_details_TotalMouvements").on( "click", function (e){
    e.preventDefault();
    $('#listeMouvementEntrees').DataTable({
      'processing': true,
      'serverSide': true,
      'destroy': true,
      'serverMethod': 'post',
      'ajax': {
          'url':'datatables/historique_listeMouvementProduitsEntrees.php',
          'data':{
            'dateJour' : dateJour
          }
      },
    ...
    $("#details_TotalMouvements").modal(); 

  });

  $("#listeProduitsSortiesEvent").on( "click", function (e){
    e.preventDefault();
    $('#listeMouvementSorties').DataTable({
      'processing': true,
      'serverSide': true,
      'destroy': true,
      'serverMethod': 'post',
      'ajax': {
          'url':'datatables/historique_listeMouvementProduitsSorties.php',
          'data':{
            'dateJour' : dateJour
          }
      },
  ...
  $("#listeServicesEvent").on( "click", function (e){
    e.preventDefault();
    $('#listeMouvementServices').DataTable({
      'processing': true,
      'serverSide': true,
      'destroy': true,
      'serverMethod': 'post',
      'ajax': {
          'url':'datatables/historique_listeMouvementServices.php',
          'data':{
            'dateJour' : dateJour
          }
      },
  ...
  $("#listeDepensesEvent").on( "click", function (e){
    e.preventDefault();
    $('#listeMouvementDepenses').DataTable({
      'processing': true,
      'serverSide': true,
      'destroy': true,
      'serverMethod': 'post',
      'ajax': {
          'url':'datatables/historique_listeMouvementDepenses.php',
          'data':{
            'dateJour' : dateJour
          }
      },
