$(document).ready(function () {
  $("#listeProduits").DataTable({
    ...
    serverMethod: "post",
    ajax: {
      url: "datatables/insertionProduit_listeProduits_ET.php",
    },
    dom: "Blfrtip",
  ...
  $("#listeArchivesEvent").on("click", function (e) {
    ...
    $("#listeArchives").DataTable({
      ...
      serverMethod: "post",
      ajax: {
        url: "datatables/insertionProduit_listeArchives_ET.php",
      },
      dom: "Blfrtip",
      buttons: ["csv", "print", "excel", "pdf"],
      ordering: true,
    ...
    if (query.length > 0) {
      $(this).typeahead({
        source: function (query, result) {
          $.ajax({
            url: "calculs/insertionProduit_ET.php",
            method: "POST",
            data: {
            ...
            error: function (err) {
              ...
              $("#message_Produit .modal-body").text(
                "Probleme de connexion, reactualiser la page et si cela persiste verifier votre appareil"
              );
            ...
            if (taille > 3) {
              ...
              $.ajax({
                ...
                success: function (data) {
                  ...
                  $("#slct_ajt_Produit_Categorie").append(
              ...
              $.ajax({
                ...
                success: function (data) {
                  ...
                  $("#slct_ajt_Produit_UniteStock").append(
                    "<option selected value='" +
                      details[3] +
                      "'>" +
                      details[3] +
              ...
              if (taille == 3) {
                ...
                message =
                  "<h4>Ce produit existe deja dans le systeme</h4></br>" +
  ...
  $("#form_ajouter_Produit").on(
    "click",
    ".typeahead li a[class='dropdown-item']",
    function (e) {
      var reference = $("#form_ajouter_Produit .typeahead li.active").text();
      e.preventDefault();
      $("#inpt_ajt_Produit_Reference").val("");
    ...
    ajouter_Produit = function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          for (var i = 0; i < taille; i++) {
            $("#slct_ajt_Produit_Categorie").append(
              "<option value='" + choix[i][1] + "'>" + choix[i][1] + "</option>"
            );
          }
        },
        error: function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        var ligne =
          ...
          "</td>" +
          "<td>" +
          "<a><img src='images/edit.png' align='middle' alt='modifier' onclick='modifier_Produit(" +
          details[0] +
          ")' data-toggle='modal' /></a>&nbsp" +
          "<a><img src='images/drop.png' align='middle' alt='supprimer' onclick='supprimer_Produit(" +
          details[0] +
          ")' data-toggle='modal' /></a>" +
          "</td>" +
          "</tr>";
        ...
        $("#inpt_ajt_Produit_Stock_UniteStock").val(details[3]);
        $("#inpt_ajt_Produit_Stock_UniteStock2").text(details[3]);
        ...
        $.ajax({
          ...
          method: "POST",
          data: {
            operation: "choix_Depot",
          },
          success: function (data) {
            var choix = JSON.parse(data);
            var taille = choix.length;

            $("#inpt_ajt_Produit_Stock_Depot").append(
              "<option selected value='0'>Sans depot</option>"
            );
  ...
  $("#btn_ajouter_Produit_Stock_Ajouter").click(function () {
    ...
    depot = $("#inpt_ajt_Produit_Stock_Depot").val();
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $("#inpt_ajt_Produit_Stock_DateExpiration").val("");
        $("#inpt_ajt_Produit_Stock_Depot").val("");
        ...
        success: function (data) {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $("#slct_mdf_Produit_Categorie").append(
                "<option selected value='" +
                  details[2] +
                  "'>" +
                  details[2] +
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $("#slct_mdf_Produit_UniteStock").append(
                "<option selected value='" +
                  details[3] +
                  "'>" +
                  details[3] +
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $("#listeProduits tbody .produit" + details[0]).each(function () {
          ...
          $(this).find("td:eq(5)").html(details[7]);
