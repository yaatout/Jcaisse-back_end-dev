...
<script type="text/javascript">
  ...
  $(function() {
      ...
      function cb(start, end) {
          ...
          window.location.href = "stock.php?iDS="+id+"&&debut="+debut+"&&fin="+fin;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Emplacement dans les rayons</h5>
        <button type="button" class="close btn-danger" style="background-color:red" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
          <form action="" class="row">
              <input id="totalStock" type="hidden" value="<?= $S_stock[0]?>">
              <input id="stockTemp" type="hidden" value="<?= $stockTemp[0]?>">
              <div class="form-group col-lg-1">
              </div>
              <div class="form-group col-lg-3">
                <label for="">Quantité à placer</label>
              </div>
              <div class="form-group col-lg-6">
                <input type="number" min="1" class="form-control" id="qtyRayon">
              </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnPlacerRayon" onClick="placerRayon(<?= $id?>)" class="btn btn-primary">Terminer</button>
      </div>
    </div>
  </div>
</div>
          ...
          <div class="modal-content">
            ...
            <form class="form" id="form_ajouter_Produit" style="padding:30px 30px;">
              <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="slct_mdf_Stock_UniteStock">Unite Stock (US) </label>
                    <select id="slct_mdf_Stock_UniteStock" class="form-control"></select>
                </div>
                <div class="form-group" id="div_mdf_Stock_PrixUniteStock">
                    <label for="inpt_mdf_Stock_PrixUniteStock">Prix Unite Stock (US)</label>
                    <input type="number" class="form-control" id="inpt_mdf_Stock_PrixUniteStock"  />
                </div>
                <div class="form-group">
                    <label for="inpt_mdf_Stock_PrixUnitaire">Prix Unitaire</label>
                    <input type="number" class="form-control" id="inpt_mdf_Stock_PrixUnitaire"  />
                </div>
                <div class="form-group">
                    <label for="inpt_mdf_Stock_PrixAchat">Prix Achat</label>
                    <input type="number" class="form-control" id="inpt_mdf_Stock_PrixAchat" />
                </div>
                <div class="form-group">
            ...
            <div class="modal-body">
                <form >
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="span_spm_Stock_UniteStock">Unite Stock (US) : </label>
                        <span id="span_spm_Stock_UniteStock" ></span>
                    </div>
                    <div class="form-group">
                        <label for="span_spm_Stock_PrixUniteStock">Prix Unite Stock (US) : </label>
                        <span id="span_spm_Stock_PrixUniteStock" ></span>
                    </div>
                    <div class="form-group">
                        <label for="span_spm_Stock_PrixUnitaire">Prix Unitaire : </label>
                        <span id="span_spm_Stock_PrixUnitaire" ></span>
                    </div>
                    <div class="form-group">
                        <label for="span_spm_Stock_PrixAchat">Prix Achat : </label>
                        <span id="span_spm_Stock_PrixAchat" ></span>
                    </div>
                    <div class="form-group">
