    ...
    if($tab=mysql_fetch_array($res)){
          ...
          if(($_SESSION['profil']=="Admin")||($_SESSION['profil']=="SuperAdmin"))
		    ...
		    if ($_SESSION['activerB']==0){
					...
					<div class="form">
						<div class="thumbnail" style="width: 250px;height: 250px;"><img src="../images/jcaisse.jpeg"/></div>
			...
			if ($_SESSION['activerB']==0 || $_SESSION['activer']==0){
				...
				echo'<script language="JavaScript">document.location="../transfertStock.php"</script>';
		  	...
		  	if ($_SESSION['activerB']==0 || $_SESSION['activer']==0){
				...
				if (($_SESSION['type']=="Pharmacie") && ($_SESSION['categorie']=="Detaillant")) {
					...
					echo'<script language="JavaScript">document.location="../insertionLigneLight.php"</script>';
				...
				echo'<script language="JavaScript">document.location="../vitrine/commande.php"</script>';
