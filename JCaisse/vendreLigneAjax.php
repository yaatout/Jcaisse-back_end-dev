        ...
        while ($data=mysql_fetch_array($resS)) {
              ...
              if($data['uniteStock']!='Transaction' && $data['uniteStock']!='Facture' && $data['uniteStock']!='Credit'){
                  ...
                  if($data['classe']==1){
                    ...
                    $reponse.="<li class='licET'  style='background-color: #abdbb7; '><span class='btn btn-group btnSpan' style='font-size: 18px; '>".$data['designation']."</span></li>";
                        ...
                        if(mysql_num_rows($resP)){
                            ...
                            if($ligneN['classe']==0 || $ligneN['classe']==1){
                                ...
                                if(mysql_num_rows($res2)) {
                                  ...
                                  if ($pagnet['type']==10 || $_SESSION['caissierAccessDepot']==0) {
                                    # code...
