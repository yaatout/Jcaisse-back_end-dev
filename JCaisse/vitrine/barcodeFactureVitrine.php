...
<?php require('../entetehtmlVitrine.php'); ?>
    ...
    echo'CLIENT : '.$client["prenom"].' '.$client["nom"].'<br>';
      ...
      **************************************************	';
             ...
             */
             ...
             $req3 = $bddV->prepare("SELECT * FROM ligne WHERE idPanier =:idPanier AND idBoutique =:idBoutique AND barrer = 0 ORDER BY idArticle DESC");
             $req3->execute(array(
                 'idPanier' =>$idPanier,
